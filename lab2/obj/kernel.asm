...
ffffffffc0201010:	06d70363          	beq	a4,a3,ffffffffc0201076 <best_fit_free_pages+0xd4>
    for (; p != base + n; p ++) {
...
ffffffffc020102c:	ed18                	sd	a4,24(a0)
    if (le != &free_list) {
ffffffffc020102e:	02d70163          	beq	a4,a3,ffffffffc0201050 <best_fit_free_pages+0xae>
        p = le2page(le, page_link);
ffffffffc0201032:	fe870613          	addi	a2,a4,-24
         if ((unsigned int)(base - p) == p->property){
ffffffffc0201036:	40c507b3          	sub	a5,a0,a2
ffffffffc020103a:	00001597          	auipc	a1,0x1
ffffffffc020103e:	7b65b583          	ld	a1,1974(a1) # ffffffffc02027f0 <error_string+0x38>
ffffffffc0201042:	878d                	srai	a5,a5,0x3
ffffffffc0201044:	02b787bb          	mulw	a5,a5,a1
ffffffffc0201048:	ff872583          	lw	a1,-8(a4)
ffffffffc020104c:	02b78f63          	beq	a5,a1,ffffffffc020108a <best_fit_free_pages+0xe8>
    return listelm->next;
ffffffffc0201050:	7118                	ld	a4,32(a0)
    if (le != &free_list) {
ffffffffc0201052:	00d70f63          	beq	a4,a3,ffffffffc0201070 <best_fit_free_pages+0xce>
        if (base + base->property == p) {
ffffffffc0201056:	490c                	lw	a1,16(a0)
        p = le2page(le, page_link);
ffffffffc0201058:	fe870693          	addi	a3,a4,-24
        if (base + base->property == p) {
ffffffffc020105c:	02059613          	slli	a2,a1,0x20
ffffffffc0201060:	9201                	srli	a2,a2,0x20
ffffffffc0201062:	00261793          	slli	a5,a2,0x2
ffffffffc0201066:	97b2                	add	a5,a5,a2
ffffffffc0201068:	078e                	slli	a5,a5,0x3
ffffffffc020106a:	97aa                	add	a5,a5,a0
ffffffffc020106c:	04f68763          	beq	a3,a5,ffffffffc02010ba <best_fit_free_pages+0x118>
}
ffffffffc0201070:	60a2                	ld	ra,8(sp)
ffffffffc0201072:	0141                	addi	sp,sp,16
ffffffffc0201074:	8082                	ret
    prev->next = next->prev = elm;
ffffffffc0201076:	e790                	sd	a2,8(a5)
    elm->next = next;
ffffffffc0201078:	f114                	sd	a3,32(a0)
    return listelm->next;
ffffffffc020107a:	6798                	ld	a4,8(a5)
    elm->prev = prev;
ffffffffc020107c:	ed1c                	sd	a5,24(a0)
        while ((le = list_next(le)) != &free_list) {
ffffffffc020107e:	02d70463          	beq	a4,a3,ffffffffc02010a6 <best_fit_free_pages+0x104>
    prev->next = next->prev = elm;
ffffffffc0201082:	8832                	mv	a6,a2
ffffffffc0201084:	4585                	li	a1,1
    for (; p != base + n; p ++) {
ffffffffc0201086:	87ba                	mv	a5,a4
ffffffffc0201088:	b779                	j	ffffffffc0201016 <best_fit_free_pages+0x74>
         p->property += base->property;
ffffffffc020108a:	490c                	lw	a1,16(a0)
ffffffffc020108c:	9fad                	addw	a5,a5,a1
ffffffffc020108e:	fef72c23          	sw	a5,-8(a4)
    __op_bit(and, __NOT, nr, ((volatile unsigned long *)addr));
ffffffffc0201092:	57f5                	li	a5,-3
ffffffffc0201094:	60f8b02f          	amoand.d	zero,a5,(a7)
    __list_del(listelm->prev, listelm->next);
ffffffffc0201098:	6d0c                	ld	a1,24(a0)
ffffffffc020109a:	711c                	ld	a5,32(a0)
         base = p;
ffffffffc020109c:	8532                	mv	a0,a2
    prev->next = next;
ffffffffc020109e:	e59c                	sd	a5,8(a1)
    return listelm->next;
ffffffffc02010a0:	6718                	ld	a4,8(a4)
    next->prev = prev;
ffffffffc02010a2:	e38c                	sd	a1,0(a5)
ffffffffc02010a4:	b77d                	j	ffffffffc0201052 <best_fit_free_pages+0xb0>
...
ffffffffc020111c:	e406                	sd	ra,8(sp)
    assert(n > 0);
ffffffffc020111e:	c5f1                	beqz	a1,ffffffffc02011ea <best_fit_init_memmap+0xd0>
    for (; p != base + n; p ++) {
...
ffffffffc020112c:	00d50d63          	beq	a0,a3,ffffffffc0201146 <best_fit_init_memmap+0x2c>
    return (((*(volatile unsigned long *)addr) >> nr) & 1);
ffffffffc0201130:	6798                	ld	a4,8(a5)
        assert(PageReserved(p));
ffffffffc0201132:	8b05                	andi	a4,a4,1
ffffffffc0201134:	cb59                	beqz	a4,ffffffffc02011ca <best_fit_init_memmap+0xb0>
        p->flags = 0;  // 重置页的标志
ffffffffc0201136:	0007b423          	sd	zero,8(a5)
ffffffffc020113a:	0007a023          	sw	zero,0(a5)
    for (; p != base + n; p ++) {
ffffffffc020113e:	02878793          	addi	a5,a5,40
ffffffffc0201142:	fed797e3          	bne	a5,a3,ffffffffc0201130 <best_fit_init_memmap+0x16>
    base->property = n;
ffffffffc0201146:	2581                	sext.w	a1,a1
ffffffffc0201148:	c90c                	sw	a1,16(a0)
    __op_bit(or, __NOP, nr, ((volatile unsigned long *)addr));
ffffffffc020114a:	4789                	li	a5,2
ffffffffc020114c:	00850713          	addi	a4,a0,8
ffffffffc0201150:	40f7302f          	amoor.d	zero,a5,(a4)
    nr_free += n;
ffffffffc0201154:	00005697          	auipc	a3,0x5
ffffffffc0201158:	ebc68693          	addi	a3,a3,-324 # ffffffffc0206010 <free_area>
ffffffffc020115c:	4a98                	lw	a4,16(a3)
    return list->next == list;
ffffffffc020115e:	669c                	ld	a5,8(a3)
        list_add(&free_list, &(base->page_link));
ffffffffc0201160:	01850613          	addi	a2,a0,24
    nr_free += n;
ffffffffc0201164:	9db9                	addw	a1,a1,a4
ffffffffc0201166:	ca8c                	sw	a1,16(a3)
    if (list_empty(&free_list)) {
ffffffffc0201168:	04d78a63          	beq	a5,a3,ffffffffc02011bc <best_fit_init_memmap+0xa2>
            struct Page* page = le2page(le, page_link);
ffffffffc020116c:	fe878713          	addi	a4,a5,-24
ffffffffc0201170:	0006b803          	ld	a6,0(a3)
    if (list_empty(&free_list)) {
ffffffffc0201174:	4581                	li	a1,0
            if (base < page) {
ffffffffc0201176:	00e56a63          	bltu	a0,a4,ffffffffc020118a <best_fit_init_memmap+0x70>
    return listelm->next;
ffffffffc020117a:	6798                	ld	a4,8(a5)
            if (list_next(le) == &free_list) {
ffffffffc020117c:	02d70263          	beq	a4,a3,ffffffffc02011a0 <best_fit_init_memmap+0x86>
    for (; p != base + n; p ++) {
ffffffffc0201180:	87ba                	mv	a5,a4
            struct Page* page = le2page(le, page_link);
ffffffffc0201182:	fe878713          	addi	a4,a5,-24
            if (base < page) {
ffffffffc0201186:	fee57ae3          	bgeu	a0,a4,ffffffffc020117a <best_fit_init_memmap+0x60>
ffffffffc020118a:	c199                	beqz	a1,ffffffffc0201190 <best_fit_init_memmap+0x76>
ffffffffc020118c:	0106b023          	sd	a6,0(a3)
    __list_add(elm, listelm->prev, listelm);
ffffffffc0201190:	6398                	ld	a4,0(a5)
}
ffffffffc0201192:	60a2                	ld	ra,8(sp)
    prev->next = next->prev = elm;
ffffffffc0201194:	e390                	sd	a2,0(a5)
ffffffffc0201196:	e710                	sd	a2,8(a4)
    elm->next = next;
ffffffffc0201198:	f11c                	sd	a5,32(a0)
    elm->prev = prev;
ffffffffc020119a:	ed18                	sd	a4,24(a0)
ffffffffc020119c:	0141                	addi	sp,sp,16
ffffffffc020119e:	8082                	ret
    prev->next = next->prev = elm;
ffffffffc02011a0:	e790                	sd	a2,8(a5)
    elm->next = next;
ffffffffc02011a2:	f114                	sd	a3,32(a0)
    return listelm->next;
ffffffffc02011a4:	6798                	ld	a4,8(a5)
    elm->prev = prev;
ffffffffc02011a6:	ed1c                	sd	a5,24(a0)
        while ((le = list_next(le)) != &free_list) {
ffffffffc02011a8:	00d70663          	beq	a4,a3,ffffffffc02011b4 <best_fit_init_memmap+0x9a>
    prev->next = next->prev = elm;
ffffffffc02011ac:	8832                	mv	a6,a2
ffffffffc02011ae:	4585                	li	a1,1
    for (; p != base + n; p ++) {
ffffffffc02011b0:	87ba                	mv	a5,a4
ffffffffc02011b2:	bfc1                	j	ffffffffc0201182 <best_fit_init_memmap+0x68>
}
ffffffffc02011b4:	60a2                	ld	ra,8(sp)
ffffffffc02011b6:	e290                	sd	a2,0(a3)
ffffffffc02011b8:	0141                	addi	sp,sp,16
ffffffffc02011ba:	8082                	ret
ffffffffc02011bc:	60a2                	ld	ra,8(sp)
ffffffffc02011be:	e390                	sd	a2,0(a5)
ffffffffc02011c0:	e790                	sd	a2,8(a5)
    elm->next = next;
ffffffffc02011c2:	f11c                	sd	a5,32(a0)
    elm->prev = prev;
ffffffffc02011c4:	ed1c                	sd	a5,24(a0)
ffffffffc02011c6:	0141                	addi	sp,sp,16
ffffffffc02011c8:	8082                	ret
        assert(PageReserved(p));
ffffffffc02011ca:	00001697          	auipc	a3,0x1
ffffffffc02011ce:	25668693          	addi	a3,a3,598 # ffffffffc0202420 <commands+0x818>
ffffffffc02011d2:	00001617          	auipc	a2,0x1
ffffffffc02011d6:	f3660613          	addi	a2,a2,-202 # ffffffffc0202108 <commands+0x500>
ffffffffc02011da:	04a00593          	li	a1,74
ffffffffc02011de:	00001517          	auipc	a0,0x1
ffffffffc02011e2:	f4250513          	addi	a0,a0,-190 # ffffffffc0202120 <commands+0x518>
ffffffffc02011e6:	9c6ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(n > 0);
ffffffffc02011ea:	00001697          	auipc	a3,0x1
ffffffffc02011ee:	f1668693          	addi	a3,a3,-234 # ffffffffc0202100 <commands+0x4f8>
ffffffffc02011f2:	00001617          	auipc	a2,0x1
ffffffffc02011f6:	f1660613          	addi	a2,a2,-234 # ffffffffc0202108 <commands+0x500>
ffffffffc02011fa:	04700593          	li	a1,71
