...
ffffffffc0200036:	2de50513          	addi	a0,a0,734 # ffffffffc02a7310 <buf>
ffffffffc020003a:	000b3617          	auipc	a2,0xb3
ffffffffc020003e:	83260613          	addi	a2,a2,-1998 # ffffffffc02b286c <end>
kern_init(void) {
...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	51a060ef          	jal	ra,ffffffffc0206564 <memset>
...
ffffffffc0200056:	53e58593          	addi	a1,a1,1342 # ffffffffc0206590 <etext+0x2>
ffffffffc020005a:	00006517          	auipc	a0,0x6
ffffffffc020005e:	55650513          	addi	a0,a0,1366 # ffffffffc02065b0 <etext+0x22>
...
ffffffffc020007a:	463050ef          	jal	ra,ffffffffc0205cdc <proc_init>
...
ffffffffc020008e:	5e7050ef          	jal	ra,ffffffffc0205e74 <cpu_idle>
...
ffffffffc02000ac:	51050513          	addi	a0,a0,1296 # ffffffffc02065b8 <etext+0x2a>
...
ffffffffc02000c2:	252b8b93          	addi	s7,s7,594 # ffffffffc02a7310 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
...
ffffffffc020011e:	1f650513          	addi	a0,a0,502 # ffffffffc02a7310 <buf>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	7f3050ef          	jal	ra,ffffffffc0206166 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	7bd050ef          	jal	ra,ffffffffc0206166 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc020020e:	3b650513          	addi	a0,a0,950 # ffffffffc02065c0 <etext+0x32>
void print_kerninfo(void) {
...
ffffffffc0200224:	3c050513          	addi	a0,a0,960 # ffffffffc02065e0 <etext+0x52>
ffffffffc0200228:	f59ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc020022c:	00006597          	auipc	a1,0x6
ffffffffc0200230:	36258593          	addi	a1,a1,866 # ffffffffc020658e <etext>
ffffffffc0200234:	00006517          	auipc	a0,0x6
ffffffffc0200238:	3cc50513          	addi	a0,a0,972 # ffffffffc0206600 <etext+0x72>
ffffffffc020023c:	f45ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  edata  0x%08x (virtual)\n", edata);
ffffffffc0200240:	000a7597          	auipc	a1,0xa7
ffffffffc0200244:	0d058593          	addi	a1,a1,208 # ffffffffc02a7310 <buf>
ffffffffc0200248:	00006517          	auipc	a0,0x6
ffffffffc020024c:	3d850513          	addi	a0,a0,984 # ffffffffc0206620 <etext+0x92>
ffffffffc0200250:	f31ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  end    0x%08x (virtual)\n", end);
ffffffffc0200254:	000b2597          	auipc	a1,0xb2
ffffffffc0200258:	61858593          	addi	a1,a1,1560 # ffffffffc02b286c <end>
ffffffffc020025c:	00006517          	auipc	a0,0x6
ffffffffc0200260:	3e450513          	addi	a0,a0,996 # ffffffffc0206640 <etext+0xb2>
ffffffffc0200264:	f1dff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("Kernel executable memory footprint: %dKB\n",
            (end - kern_init + 1023) / 1024);
ffffffffc0200268:	000b3597          	auipc	a1,0xb3
ffffffffc020026c:	a0358593          	addi	a1,a1,-1533 # ffffffffc02b2c6b <end+0x3ff>
...
ffffffffc020028e:	3d650513          	addi	a0,a0,982 # ffffffffc0206660 <etext+0xd2>
}
...
ffffffffc020029c:	3f860613          	addi	a2,a2,1016 # ffffffffc0206690 <etext+0x102>
ffffffffc02002a0:	04d00593          	li	a1,77
ffffffffc02002a4:	00006517          	auipc	a0,0x6
ffffffffc02002a8:	40450513          	addi	a0,a0,1028 # ffffffffc02066a8 <etext+0x11a>
void print_stackframe(void) {
...
ffffffffc02002b8:	40c60613          	addi	a2,a2,1036 # ffffffffc02066c0 <etext+0x132>
ffffffffc02002bc:	00006597          	auipc	a1,0x6
ffffffffc02002c0:	42458593          	addi	a1,a1,1060 # ffffffffc02066e0 <etext+0x152>
ffffffffc02002c4:	00006517          	auipc	a0,0x6
ffffffffc02002c8:	42450513          	addi	a0,a0,1060 # ffffffffc02066e8 <etext+0x15a>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002d6:	42660613          	addi	a2,a2,1062 # ffffffffc02066f8 <etext+0x16a>
ffffffffc02002da:	00006597          	auipc	a1,0x6
ffffffffc02002de:	44658593          	addi	a1,a1,1094 # ffffffffc0206720 <etext+0x192>
ffffffffc02002e2:	00006517          	auipc	a0,0x6
ffffffffc02002e6:	40650513          	addi	a0,a0,1030 # ffffffffc02066e8 <etext+0x15a>
ffffffffc02002ea:	e97ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ee:	00006617          	auipc	a2,0x6
ffffffffc02002f2:	44260613          	addi	a2,a2,1090 # ffffffffc0206730 <etext+0x1a2>
ffffffffc02002f6:	00006597          	auipc	a1,0x6
ffffffffc02002fa:	45a58593          	addi	a1,a1,1114 # ffffffffc0206750 <etext+0x1c2>
ffffffffc02002fe:	00006517          	auipc	a0,0x6
ffffffffc0200302:	3ea50513          	addi	a0,a0,1002 # ffffffffc02066e8 <etext+0x15a>
...
ffffffffc020033c:	42850513          	addi	a0,a0,1064 # ffffffffc0206760 <etext+0x1d2>
kmonitor(struct trapframe *tf) {
...
ffffffffc020035e:	42e50513          	addi	a0,a0,1070 # ffffffffc0206788 <etext+0x1fa>
...
ffffffffc020037c:	43890913          	addi	s2,s2,1080 # ffffffffc02067b0 <etext+0x222>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200380:	00006497          	auipc	s1,0x6
ffffffffc0200384:	43848493          	addi	s1,s1,1080 # ffffffffc02067b8 <etext+0x22a>
        if (argc == MAXARGS - 1) {
ffffffffc0200388:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020038a:	00006b17          	auipc	s6,0x6
ffffffffc020038e:	436b0b13          	addi	s6,s6,1078 # ffffffffc02067c0 <etext+0x232>
        argv[argc ++] = buf;
ffffffffc0200392:	00006a17          	auipc	s4,0x6
ffffffffc0200396:	34ea0a13          	addi	s4,s4,846 # ffffffffc02066e0 <etext+0x152>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003c0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003c2:	16e060ef          	jal	ra,ffffffffc0206530 <strcmp>
...
ffffffffc02003d4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003d6:	15a060ef          	jal	ra,ffffffffc0206530 <strcmp>
...
ffffffffc0200414:	13a060ef          	jal	ra,ffffffffc020654e <strchr>
...
ffffffffc0200452:	0fc060ef          	jal	ra,ffffffffc020654e <strchr>
...
ffffffffc0200470:	37450513          	addi	a0,a0,884 # ffffffffc02067e0 <etext+0x252>
...
ffffffffc020047e:	35e30313          	addi	t1,t1,862 # ffffffffc02b27d8 <is_panic>
...
ffffffffc0200530:	2af73e23          	sd	a5,700(a4) # ffffffffc02b27e8 <timebase>
...
ffffffffc0200558:	2807b623          	sd	zero,652(a5) # ffffffffc02b27e0 <ticks>
    cprintf("++ setup timer interrupts\n");
...
ffffffffc0200566:	2867b783          	ld	a5,646(a5) # ffffffffc02b27e8 <timebase>
...
ffffffffc02005fc:	11878793          	addi	a5,a5,280 # ffffffffc02a7710 <ide>
    int iobase = secno * SECTSIZE;
...
ffffffffc020060e:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc0200610:	767050ef          	jal	ra,ffffffffc0206576 <memcpy>
    return 0;
}
...
ffffffffc0200624:	0f050513          	addi	a0,a0,240 # ffffffffc02a7710 <ide>
                   size_t nsecs) {
...
ffffffffc0200632:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc0200634:	743050ef          	jal	ra,ffffffffc0206576 <memcpy>
    return 0;
}
...
ffffffffc020089e:	fa648493          	addi	s1,s1,-90 # ffffffffc02b2840 <check_mm_struct>
...
ffffffffc02008e4:	f7073703          	ld	a4,-144(a4) # ffffffffc02b2850 <current>
ffffffffc02008e8:	000b2797          	auipc	a5,0xb2
ffffffffc02008ec:	f707b783          	ld	a5,-144(a5) # ffffffffc02b2858 <idleproc>
...
ffffffffc0200920:	f347b783          	ld	a5,-204(a5) # ffffffffc02b2850 <current>
...
ffffffffc0200a0c:	dd868693          	addi	a3,a3,-552 # ffffffffc02b27e0 <ticks>
...
ffffffffc0200a24:	e307b783          	ld	a5,-464(a5) # ffffffffc02b2850 <current>
...
ffffffffc0200a84:	6105                	addi	sp,sp,32
            syscall();
ffffffffc0200a86:	5de0506f          	j	ffffffffc0206064 <syscall>
...
ffffffffc0200b42:	10f43423          	sd	a5,264(s0)
                syscall();
ffffffffc0200b46:	51e050ef          	jal	ra,ffffffffc0206064 <syscall>
                kernel_execve_ret(tf,current->kstack+KSTACKSIZE);
ffffffffc0200b4a:	000b2797          	auipc	a5,0xb2
ffffffffc0200b4e:	d067b783          	ld	a5,-762(a5) # ffffffffc02b2850 <current>
...
ffffffffc0200c28:	c2c40413          	addi	s0,s0,-980 # ffffffffc02b2850 <current>
...
ffffffffc0200c9a:	6105                	addi	sp,sp,32
                schedule();
ffffffffc0200c9c:	2dc0506f          	j	ffffffffc0205f78 <schedule>
                do_exit(-E_KILLED);
ffffffffc0200ca0:	555d                	li	a0,-9
ffffffffc0200ca2:	61c040ef          	jal	ra,ffffffffc02052be <do_exit>
            if (current->need_resched) {
...
ffffffffc0200e26:	8ee78793          	addi	a5,a5,-1810 # ffffffffc02ae710 <free_area>
...
ffffffffc0200e38:	8ec56503          	lwu	a0,-1812(a0) # ffffffffc02ae720 <free_area+0x10>
...
ffffffffc0200e46:	8ce40413          	addi	s0,s0,-1842 # ffffffffc02ae710 <free_area>
...
ffffffffc0200ed2:	9427b783          	ld	a5,-1726(a5) # ffffffffc02b2810 <pages>
...
ffffffffc0200eea:	9226b683          	ld	a3,-1758(a3) # ffffffffc02b2808 <npage>
...
ffffffffc0200f28:	7e07ae23          	sw	zero,2044(a5) # ffffffffc02ae720 <free_area+0x10>
    assert(alloc_page() == NULL);
...
ffffffffc020100a:	7007ad23          	sw	zero,1818(a5) # ffffffffc02ae720 <free_area+0x10>
    free_pages(p0 + 2, 3);
...
ffffffffc0201606:	10e68693          	addi	a3,a3,270 # ffffffffc02ae710 <free_area>
...
ffffffffc0201732:	fe258593          	addi	a1,a1,-30 # ffffffffc02ae710 <free_area>
...
ffffffffc020181e:	ef668693          	addi	a3,a3,-266 # ffffffffc02ae710 <free_area>
...
ffffffffc02018ea:	a1a60613          	addi	a2,a2,-1510 # ffffffffc02a7300 <slobfree>
...
ffffffffc0201998:	e7c6b683          	ld	a3,-388(a3) # ffffffffc02b2810 <pages>
...
ffffffffc02019b4:	e5873703          	ld	a4,-424(a4) # ffffffffc02b2808 <npage>
    return page2ppn(page) << PGSHIFT;
...
ffffffffc02019c2:	e626b683          	ld	a3,-414(a3) # ffffffffc02b2820 <va_pa_offset>
...
ffffffffc0201a10:	8f490913          	addi	s2,s2,-1804 # ffffffffc02a7300 <slobfree>
...
ffffffffc0201b4e:	ca678793          	addi	a5,a5,-858 # ffffffffc02b27f0 <bigblocks>
...
ffffffffc0201b8a:	c6a78793          	addi	a5,a5,-918 # ffffffffc02b27f0 <bigblocks>
...
ffffffffc0201bd0:	c247b783          	ld	a5,-988(a5) # ffffffffc02b27f0 <bigblocks>
    return 0;
...
ffffffffc0201bdc:	c1868693          	addi	a3,a3,-1000 # ffffffffc02b27f0 <bigblocks>
...
ffffffffc0201c04:	c206b683          	ld	a3,-992(a3) # ffffffffc02b2820 <va_pa_offset>
ffffffffc0201c08:	8c15                	sub	s0,s0,a3
    if (PPN(pa) >= npage) {
ffffffffc0201c0a:	8031                	srli	s0,s0,0xc
ffffffffc0201c0c:	000b1797          	auipc	a5,0xb1
ffffffffc0201c10:	bfc7b783          	ld	a5,-1028(a5) # ffffffffc02b2808 <npage>
...
ffffffffc0201c28:	bec53503          	ld	a0,-1044(a0) # ffffffffc02b2810 <pages>
...
ffffffffc0201c60:	b947b783          	ld	a5,-1132(a5) # ffffffffc02b27f0 <bigblocks>
        return 1;
...
ffffffffc0201cf8:	b2490913          	addi	s2,s2,-1244 # ffffffffc02b2818 <pmm_manager>
        {
...
ffffffffc0201d02:	b3aa8a93          	addi	s5,s5,-1222 # ffffffffc02b2838 <swap_init_ok>
...
ffffffffc0201d0e:	b36b0b13          	addi	s6,s6,-1226 # ffffffffc02b2840 <check_mm_struct>
...
ffffffffc0201d7e:	a9e7b783          	ld	a5,-1378(a5) # ffffffffc02b2818 <pmm_manager>
...
ffffffffc0201d9a:	a827b783          	ld	a5,-1406(a5) # ffffffffc02b2818 <pmm_manager>
...
ffffffffc0201dbe:	a5e7b783          	ld	a5,-1442(a5) # ffffffffc02b2818 <pmm_manager>
...
ffffffffc0201dd4:	a487b783          	ld	a5,-1464(a5) # ffffffffc02b2818 <pmm_manager>
...
ffffffffc0201e1a:	9f2a0a13          	addi	s4,s4,-1550 # ffffffffc02b2808 <npage>
    if (!(*pdep1 & PTE_V)) {
...
ffffffffc0201e34:	9e0b0b13          	addi	s6,s6,-1568 # ffffffffc02b2810 <pages>
...
ffffffffc0201e44:	9c8a0a13          	addi	s4,s4,-1592 # ffffffffc02b2808 <npage>
...
ffffffffc0201e68:	9bc7b783          	ld	a5,-1604(a5) # ffffffffc02b2820 <va_pa_offset>
ffffffffc0201e6c:	6605                	lui	a2,0x1
ffffffffc0201e6e:	4581                	li	a1,0
ffffffffc0201e70:	953e                	add	a0,a0,a5
ffffffffc0201e72:	6f2040ef          	jal	ra,ffffffffc0206564 <memset>
    return page - pages + nbase;
...
ffffffffc0201ea0:	984a8a93          	addi	s5,s5,-1660 # ffffffffc02b2820 <va_pa_offset>
...
ffffffffc0201ed2:	942b0b13          	addi	s6,s6,-1726 # ffffffffc02b2810 <pages>
...
ffffffffc0201f04:	660040ef          	jal	ra,ffffffffc0206564 <memset>
    return page - pages + nbase;
...
ffffffffc0201fec:	82073703          	ld	a4,-2016(a4) # ffffffffc02b2808 <npage>
...
ffffffffc0202004:	81053503          	ld	a0,-2032(a0) # ffffffffc02b2810 <pages>
...
ffffffffc0202054:	7b8c8c93          	addi	s9,s9,1976 # ffffffffc02b2808 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc0202058:	000b0c17          	auipc	s8,0xb0
ffffffffc020205c:	7b8c0c13          	addi	s8,s8,1976 # ffffffffc02b2810 <pages>
ffffffffc0202060:	fff80bb7          	lui	s7,0xfff80
        pmm_manager->free_pages(base, n);
ffffffffc0202064:	000b0d17          	auipc	s10,0xb0
ffffffffc0202068:	7b4d0d13          	addi	s10,s10,1972 # ffffffffc02b2818 <pmm_manager>
...
ffffffffc02021b2:	65ad0d13          	addi	s10,s10,1626 # ffffffffc02b2808 <npage>
    return KADDR(page2pa(page));
ffffffffc02021b6:	00ccdc93          	srli	s9,s9,0xc
    return &pages[PPN(pa) - nbase];
ffffffffc02021ba:	000b0717          	auipc	a4,0xb0
ffffffffc02021be:	65670713          	addi	a4,a4,1622 # ffffffffc02b2810 <pages>
        pmm_manager->free_pages(base, n);
ffffffffc02021c2:	000b0d97          	auipc	s11,0xb0
ffffffffc02021c6:	656d8d93          	addi	s11,s11,1622 # ffffffffc02b2818 <pmm_manager>
...
ffffffffc0202222:	60280813          	addi	a6,a6,1538 # ffffffffc02b2820 <va_pa_offset>
...
ffffffffc02022b6:	56e80813          	addi	a6,a6,1390 # ffffffffc02b2820 <va_pa_offset>
...
ffffffffc02022c8:	54c70713          	addi	a4,a4,1356 # ffffffffc02b2810 <pages>
                        pd0[PDX0(d0start)] = 0;
...
ffffffffc0202300:	51470713          	addi	a4,a4,1300 # ffffffffc02b2810 <pages>
...
ffffffffc020234e:	4c670713          	addi	a4,a4,1222 # ffffffffc02b2810 <pages>
...
ffffffffc0202360:	4c480813          	addi	a6,a6,1220 # ffffffffc02b2820 <va_pa_offset>
                        pd0[PDX0(d0start)] = 0;
...
ffffffffc0202384:	49070713          	addi	a4,a4,1168 # ffffffffc02b2810 <pages>
                pgdir[PDX1(d1start)] = 0;
...
ffffffffc0202418:	3f473703          	ld	a4,1012(a4) # ffffffffc02b2808 <npage>
...
ffffffffc020242c:	3e853503          	ld	a0,1000(a0) # ffffffffc02b2810 <pages>
...
ffffffffc020245a:	3c27b783          	ld	a5,962(a5) # ffffffffc02b2818 <pmm_manager>
...
ffffffffc0202470:	3ac7b783          	ld	a5,940(a5) # ffffffffc02b2818 <pmm_manager>
...
ffffffffc02024bc:	35873703          	ld	a4,856(a4) # ffffffffc02b2810 <pages>
...
ffffffffc02024f6:	31673703          	ld	a4,790(a4) # ffffffffc02b2808 <npage>
ffffffffc02024fa:	06e7ff63          	bgeu	a5,a4,ffffffffc0202578 <page_insert+0xf2>
    return &pages[PPN(pa) - nbase];
ffffffffc02024fe:	000b0a97          	auipc	s5,0xb0
ffffffffc0202502:	312a8a93          	addi	s5,s5,786 # ffffffffc02b2810 <pages>
...
ffffffffc0202514:	01240c63          	beq	s0,s2,ffffffffc020252c <page_insert+0xa6>
    page->ref -= 1;
ffffffffc0202518:	00092783          	lw	a5,0(s2) # fffffffffff80000 <end+0x3fccd794>
...
ffffffffc020253c:	2e07b783          	ld	a5,736(a5) # ffffffffc02b2818 <pmm_manager>
...
ffffffffc020255a:	2c27b783          	ld	a5,706(a5) # ffffffffc02b2818 <pmm_manager>
...
ffffffffc0202596:	286b8b93          	addi	s7,s7,646 # ffffffffc02b2818 <pmm_manager>
void pmm_init(void) {
...
ffffffffc02025bc:	26898993          	addi	s3,s3,616 # ffffffffc02b2820 <va_pa_offset>
    npage = maxpa / PGSIZE;
ffffffffc02025c0:	000b0497          	auipc	s1,0xb0
ffffffffc02025c4:	24848493          	addi	s1,s1,584 # ffffffffc02b2808 <npage>
    pmm_manager->init();
ffffffffc02025c8:	679c                	ld	a5,8(a5)
    pages = (struct Page *)ROUNDUP((void *)end, PGSIZE);
ffffffffc02025ca:	000b0b17          	auipc	s6,0xb0
ffffffffc02025ce:	246b0b13          	addi	s6,s6,582 # ffffffffc02b2810 <pages>
    pmm_manager->init();
...
ffffffffc020260a:	26578793          	addi	a5,a5,613 # ffffffffc02b386b <end+0xfff>
...
ffffffffc0202674:	19090913          	addi	s2,s2,400 # ffffffffc02b2800 <boot_pgdir>
    pmm_manager->check();
...
ffffffffc02026a6:	14d7bb23          	sd	a3,342(a5) # ffffffffc02b27f8 <boot_cr3>
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc02028fc:	0007b023          	sd	zero,0(a5) # fffffffffff80000 <end+0x3fccd794>
  asm volatile("sfence.vma");
...
ffffffffc02029a4:	62051d63          	bnez	a0,ffffffffc0202fde <pmm_init+0xa62>
    assert(page_ref(p) == 1);
ffffffffc02029a8:	000aa703          	lw	a4,0(s5) # fffffffffffff000 <end+0x3fd4c794>
...
ffffffffc02029de:	341030ef          	jal	ra,ffffffffc020651e <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02029e2:	10040593          	addi	a1,s0,256
ffffffffc02029e6:	10000513          	li	a0,256
ffffffffc02029ea:	347030ef          	jal	ra,ffffffffc0206530 <strcmp>
...
ffffffffc0202a1c:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a20:	2c9030ef          	jal	ra,ffffffffc02064e8 <strlen>
...
ffffffffc0203160:	6acc8c93          	addi	s9,s9,1708 # ffffffffc02b2808 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc0203164:	000afc17          	auipc	s8,0xaf
ffffffffc0203168:	6acc0c13          	addi	s8,s8,1708 # ffffffffc02b2810 <pages>
    return page - pages + nbase;
...
ffffffffc0203216:	60e70713          	addi	a4,a4,1550 # ffffffffc02b2820 <va_pa_offset>
...
ffffffffc0203232:	344030ef          	jal	ra,ffffffffc0206576 <memcpy>
...
ffffffffc020337a:	4c27a783          	lw	a5,1218(a5) # ffffffffc02b2838 <swap_init_ok>
ffffffffc020337e:	c385                	beqz	a5,ffffffffc020339e <pgdir_alloc_page+0x52>
            if (check_mm_struct != NULL) {
ffffffffc0203380:	000af517          	auipc	a0,0xaf
ffffffffc0203384:	4c053503          	ld	a0,1216(a0) # ffffffffc02b2840 <check_mm_struct>
...
ffffffffc02033ba:	4627b783          	ld	a5,1122(a5) # ffffffffc02b2818 <pmm_manager>
...
ffffffffc02033d2:	44a7b783          	ld	a5,1098(a5) # ffffffffc02b2818 <pmm_manager>
...
ffffffffc0203446:	3e66b683          	ld	a3,998(a3) # ffffffffc02b2828 <max_swap_offset>
...
ffffffffc020345c:	e6878793          	addi	a5,a5,-408 # ffffffffc02a72c0 <swap_manager_fifo>
     int r = sm->init();
ffffffffc0203460:	6798                	ld	a4,8(a5)
     sm = &swap_manager_fifo;
ffffffffc0203462:	000afb97          	auipc	s7,0xaf
ffffffffc0203466:	3ceb8b93          	addi	s7,s7,974 # ffffffffc02b2830 <sm>
...
ffffffffc02034a4:	27040413          	addi	s0,s0,624 # ffffffffc02ae710 <free_area>
ffffffffc02034a8:	638c                	ld	a1,0(a5)
          swap_init_ok = 1;
ffffffffc02034aa:	4785                	li	a5,1
ffffffffc02034ac:	000af717          	auipc	a4,0xaf
ffffffffc02034b0:	38f72623          	sw	a5,908(a4) # ffffffffc02b2838 <swap_init_ok>
          cprintf("SWAP: manager = %s\n", sm->name);
...
ffffffffc0203504:	34078793          	addi	a5,a5,832 # ffffffffc02b2840 <check_mm_struct>
...
ffffffffc0203512:	2f270713          	addi	a4,a4,754 # ffffffffc02b2800 <boot_pgdir>
...
ffffffffc0203566:	1e648493          	addi	s1,s1,486 # ffffffffc02ae748 <check_rp>
ffffffffc020356a:	c17fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
     
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc020356e:	000ab997          	auipc	s3,0xab
ffffffffc0203572:	1fa98993          	addi	s3,s3,506 # ffffffffc02ae768 <swap_in_seq_no>
     cprintf("setup Page Table vaddr 0~4MB OVER!\n");
...
ffffffffc020359a:	1b2a0a13          	addi	s4,s4,434 # ffffffffc02ae748 <check_rp>
    elm->prev = elm->next = elm;
...
ffffffffc02035b0:	1607aa23          	sw	zero,372(a5) # ffffffffc02ae720 <free_area+0x10>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
...
ffffffffc02035e0:	2607a623          	sw	zero,620(a5) # ffffffffc02b2848 <pgfault_num>
     *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02035ee:	25e6a683          	lw	a3,606(a3) # ffffffffc02b2848 <pgfault_num>
ffffffffc02035f2:	4585                	li	a1,1
ffffffffc02035f4:	000af797          	auipc	a5,0xaf
ffffffffc02035f8:	25478793          	addi	a5,a5,596 # ffffffffc02b2848 <pgfault_num>
...
ffffffffc020366e:	0fe78793          	addi	a5,a5,254 # ffffffffc02ae768 <swap_in_seq_no>
ffffffffc0203672:	000ab717          	auipc	a4,0xab
ffffffffc0203676:	11e70713          	addi	a4,a4,286 # ffffffffc02ae790 <swap_out_seq_no>
ffffffffc020367a:	000ab617          	auipc	a2,0xab
ffffffffc020367e:	11660613          	addi	a2,a2,278 # ffffffffc02ae790 <swap_out_seq_no>
...
ffffffffc0203694:	09870713          	addi	a4,a4,152 # ffffffffc02ae728 <check_ptep>
ffffffffc0203698:	000ab697          	auipc	a3,0xab
ffffffffc020369c:	0b068693          	addi	a3,a3,176 # ffffffffc02ae748 <check_rp>
ffffffffc02036a0:	6585                	lui	a1,0x1
    if (PPN(pa) >= npage) {
ffffffffc02036a2:	000afc17          	auipc	s8,0xaf
ffffffffc02036a6:	166c0c13          	addi	s8,s8,358 # ffffffffc02b2808 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc02036aa:	000afc97          	auipc	s9,0xaf
ffffffffc02036ae:	166c8c93          	addi	s9,s9,358 # ffffffffc02b2810 <pages>
...
ffffffffc0203752:	0b278793          	addi	a5,a5,178 # ffffffffc02b2800 <boot_pgdir>
ffffffffc0203756:	639c                	ld	a5,0(a5)
    if (PPN(pa) >= npage) {
ffffffffc0203758:	000c3703          	ld	a4,0(s8)
     check_mm_struct = NULL;
ffffffffc020375c:	000af697          	auipc	a3,0xaf
ffffffffc0203760:	0e06b223          	sd	zero,228(a3) # ffffffffc02b2840 <check_mm_struct>
    return pa2page(PDE_ADDR(pde));
...
ffffffffc020378c:	0987b783          	ld	a5,152(a5) # ffffffffc02b2820 <va_pa_offset>
...
ffffffffc0203b6c:	cc87b783          	ld	a5,-824(a5) # ffffffffc02b2830 <sm>
...
ffffffffc0203b78:	cbc7b783          	ld	a5,-836(a5) # ffffffffc02b2830 <sm>
...
ffffffffc0203ba4:	c9098993          	addi	s3,s3,-880 # ffffffffc02b2830 <sm>
...
ffffffffc0203d12:	aaa78793          	addi	a5,a5,-1366 # ffffffffc02ae7b8 <pra_list_head>
 */
static int
...
ffffffffc0203d5e:	aee92903          	lw	s2,-1298(s2) # ffffffffc02b2848 <pgfault_num>
...
ffffffffc0203d7c:	ad040413          	addi	s0,s0,-1328 # ffffffffc02b2848 <pgfault_num>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc0204146:	6f67a783          	lw	a5,1782(a5) # ffffffffc02b2838 <swap_init_ok>
...
ffffffffc0204572:	fe87b683          	ld	a3,-24(a5) # ffffffffffffefe8 <end+0x3fd4c77c>
...
ffffffffc020466c:	1ca7bc23          	sd	a0,472(a5) # ffffffffc02b2840 <check_mm_struct>
...
ffffffffc020467a:	18a4b483          	ld	s1,394(s1) # ffffffffc02b2800 <boot_pgdir>
    assert(pgdir[0] == 0);
...
ffffffffc02046f2:	11aa8a93          	addi	s5,s5,282 # ffffffffc02b2808 <npage>
...
ffffffffc0204726:	0fe9b983          	ld	s3,254(s3) # ffffffffc02b2820 <va_pa_offset>
...
ffffffffc0204748:	0cc98993          	addi	s3,s3,204 # ffffffffc02b2810 <pages>
...
ffffffffc0204794:	0a07b823          	sd	zero,176(a5) # ffffffffc02b2840 <check_mm_struct>
...
ffffffffc0204a10:	e3c7a783          	lw	a5,-452(a5) # ffffffffc02b2848 <pgfault_num>
ffffffffc0204a14:	2785                	addiw	a5,a5,1
ffffffffc0204a16:	000ae717          	auipc	a4,0xae
ffffffffc0204a1a:	e2f72923          	sw	a5,-462(a4) # ffffffffc02b2848 <pgfault_num>
...
ffffffffc0204a46:	df67a783          	lw	a5,-522(a5) # ffffffffc02b2838 <swap_init_ok>
...
ffffffffc0204a9e:	80650513          	addi	a0,a0,-2042 # ffffffffc02082a0 <default_pmm_manager+0xfc0>
...
ffffffffc0204ab0:	7a450513          	addi	a0,a0,1956 # ffffffffc0208250 <default_pmm_manager+0xf70>
...
ffffffffc0204ac0:	83450513          	addi	a0,a0,-1996 # ffffffffc02082f0 <default_pmm_manager+0x1010>
...
ffffffffc0204ad0:	7fc50513          	addi	a0,a0,2044 # ffffffffc02082c8 <default_pmm_manager+0xfe8>
...
ffffffffc0204ae0:	7fc50513          	addi	a0,a0,2044 # ffffffffc02082d8 <default_pmm_manager+0xff8>
...
ffffffffc0204af0:	79450513          	addi	a0,a0,1940 # ffffffffc0208280 <default_pmm_manager+0xfa0>
...
ffffffffc0204baa:	c8a7b123          	sd	a0,-894(a5) # ffffffffc02b2828 <max_swap_offset>
}
ffffffffc0204bae:	0141                	addi	sp,sp,16
ffffffffc0204bb0:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0204bb2:	00003617          	auipc	a2,0x3
ffffffffc0204bb6:	76660613          	addi	a2,a2,1894 # ffffffffc0208318 <default_pmm_manager+0x1038>
ffffffffc0204bba:	45b5                	li	a1,13
ffffffffc0204bbc:	00003517          	auipc	a0,0x3
ffffffffc0204bc0:	77c50513          	addi	a0,a0,1916 # ffffffffc0208338 <default_pmm_manager+0x1058>
...
ffffffffc0204c00:	c0c6b683          	ld	a3,-1012(a3) # ffffffffc02b2808 <npage>
...
ffffffffc0204c14:	c107b783          	ld	a5,-1008(a5) # ffffffffc02b2820 <va_pa_offset>
...
ffffffffc0204c2a:	72a60613          	addi	a2,a2,1834 # ffffffffc0208350 <default_pmm_manager+0x1070>
ffffffffc0204c2e:	45d1                	li	a1,20
ffffffffc0204c30:	00003517          	auipc	a0,0x3
ffffffffc0204c34:	70850513          	addi	a0,a0,1800 # ffffffffc0208338 <default_pmm_manager+0x1058>
...
ffffffffc0204c46:	6d660613          	addi	a2,a2,1750 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc0204c4a:	00002517          	auipc	a0,0x2
ffffffffc0204c4e:	6f650513          	addi	a0,a0,1782 # ffffffffc0207340 <default_pmm_manager+0x60>
...
ffffffffc0204c8e:	b7e6b683          	ld	a3,-1154(a3) # ffffffffc02b2808 <npage>
...
ffffffffc0204ca2:	b827b783          	ld	a5,-1150(a5) # ffffffffc02b2820 <va_pa_offset>
...
ffffffffc0204cb8:	69c60613          	addi	a2,a2,1692 # ffffffffc0208350 <default_pmm_manager+0x1070>
ffffffffc0204cbc:	45e5                	li	a1,25
ffffffffc0204cbe:	00003517          	auipc	a0,0x3
ffffffffc0204cc2:	67a50513          	addi	a0,a0,1658 # ffffffffc0208338 <default_pmm_manager+0x1058>
...
ffffffffc0204cd4:	64860613          	addi	a2,a2,1608 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc0204cd8:	00002517          	auipc	a0,0x2
ffffffffc0204cdc:	66850513          	addi	a0,a0,1640 # ffffffffc0207340 <default_pmm_manager+0x60>
...
ffffffffc0204ce6:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204ce8:	5d6000ef          	jal	ra,ffffffffc02052be <do_exit>
...
ffffffffc0204d22:	043010ef          	jal	ra,ffffffffc0206564 <memset>
    proc->tf = NULL;                         // Trap frame初始化为NULL
    proc->cr3 = boot_cr3;                           // 页目录基地址初始化为0
ffffffffc0204d26:	000ae797          	auipc	a5,0xae
ffffffffc0204d2a:	ad27b783          	ld	a5,-1326(a5) # ffffffffc02b27f8 <boot_cr3>
    proc->tf = NULL;                         // Trap frame初始化为NULL
...
ffffffffc0204d40:	025010ef          	jal	ra,ffffffffc0206564 <memset>
     /*
...
ffffffffc0204d62:	af27b783          	ld	a5,-1294(a5) # ffffffffc02b2850 <current>
...
ffffffffc0204d70:	ae47b783          	ld	a5,-1308(a5) # ffffffffc02b2850 <current>
ffffffffc0204d74:	43cc                	lw	a1,4(a5)
user_main(void *arg) {
ffffffffc0204d76:	7139                	addi	sp,sp,-64
    KERNEL_EXECVE2(TEST, TESTSTART, TESTSIZE);
ffffffffc0204d78:	00003617          	auipc	a2,0x3
ffffffffc0204d7c:	5f860613          	addi	a2,a2,1528 # ffffffffc0208370 <default_pmm_manager+0x1090>
ffffffffc0204d80:	00003517          	auipc	a0,0x3
ffffffffc0204d84:	60050513          	addi	a0,a0,1536 # ffffffffc0208380 <default_pmm_manager+0x10a0>
user_main(void *arg) {
...
ffffffffc0204d92:	bda78793          	addi	a5,a5,-1062 # a968 <_binary_obj___user_forktest_out_size>
ffffffffc0204d96:	e43e                	sd	a5,8(sp)
ffffffffc0204d98:	00003517          	auipc	a0,0x3
ffffffffc0204d9c:	5d850513          	addi	a0,a0,1496 # ffffffffc0208370 <default_pmm_manager+0x1090>
ffffffffc0204da0:	00046797          	auipc	a5,0x46
ffffffffc0204da4:	97078793          	addi	a5,a5,-1680 # ffffffffc024a710 <_binary_obj___user_forktest_out_start>
ffffffffc0204da8:	f03e                	sd	a5,32(sp)
ffffffffc0204daa:	f42a                	sd	a0,40(sp)
    int64_t ret=0, len = strlen(name);
ffffffffc0204dac:	e802                	sd	zero,16(sp)
ffffffffc0204dae:	73a010ef          	jal	ra,ffffffffc02064e8 <strlen>
...
ffffffffc0204dca:	5e250513          	addi	a0,a0,1506 # ffffffffc02083a8 <default_pmm_manager+0x10c8>
...
ffffffffc0204dd6:	5e660613          	addi	a2,a2,1510 # ffffffffc02083b8 <default_pmm_manager+0x10d8>
ffffffffc0204dda:	35700593          	li	a1,855
ffffffffc0204dde:	00003517          	auipc	a0,0x3
ffffffffc0204de2:	5fa50513          	addi	a0,a0,1530 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
...
ffffffffc0204e22:	9f253503          	ld	a0,-1550(a0) # ffffffffc02b2810 <pages>
...
ffffffffc0204e34:	59060613          	addi	a2,a2,1424 # ffffffffc02073c0 <default_pmm_manager+0xe0>
ffffffffc0204e38:	06e00593          	li	a1,110
ffffffffc0204e3c:	00002517          	auipc	a0,0x2
ffffffffc0204e40:	50450513          	addi	a0,a0,1284 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc0204e44:	e36fb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204e48:	00002617          	auipc	a2,0x2
ffffffffc0204e4c:	5a060613          	addi	a2,a2,1440 # ffffffffc02073e8 <default_pmm_manager+0x108>
ffffffffc0204e50:	06200593          	li	a1,98
ffffffffc0204e54:	00002517          	auipc	a0,0x2
ffffffffc0204e58:	4ec50513          	addi	a0,a0,1260 # ffffffffc0207340 <default_pmm_manager+0x60>
...
ffffffffc0204e68:	9ec90913          	addi	s2,s2,-1556 # ffffffffc02b2850 <current>
proc_run(struct proc_struct *proc) {
...
ffffffffc0204e9e:	7f1000ef          	jal	ra,ffffffffc0205e8e <switch_to>
    if (flag) {
...
ffffffffc0204ed4:	99890913          	addi	s2,s2,-1640 # ffffffffc02b2868 <nr_process>
...
ffffffffc0204ef6:	2ef75a63          	bge	a4,a5,ffffffffc02051ea <do_fork+0x31e>
...
ffffffffc0204f04:	84aa                	mv	s1,a0
    if (proc == NULL) {
ffffffffc0204f06:	2c050363          	beqz	a0,ffffffffc02051cc <do_fork+0x300>
    proc->parent = current;
ffffffffc0204f0a:	000aec17          	auipc	s8,0xae
ffffffffc0204f0e:	946c0c13          	addi	s8,s8,-1722 # ffffffffc02b2850 <current>
ffffffffc0204f12:	000c3783          	ld	a5,0(s8)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204f16:	4509                	li	a0,2
    proc->parent = current;
ffffffffc0204f18:	f09c                	sd	a5,32(s1)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204f1a:	dc7fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
    if (page != NULL) {
ffffffffc0204f1e:	2a050763          	beqz	a0,ffffffffc02051cc <do_fork+0x300>
    return page - pages + nbase;
ffffffffc0204f22:	000aea97          	auipc	s5,0xae
ffffffffc0204f26:	8eea8a93          	addi	s5,s5,-1810 # ffffffffc02b2810 <pages>
ffffffffc0204f2a:	000ab683          	ld	a3,0(s5)
ffffffffc0204f2e:	00004b17          	auipc	s6,0x4
ffffffffc0204f32:	d42b0b13          	addi	s6,s6,-702 # ffffffffc0208c70 <nbase>
ffffffffc0204f36:	000b3783          	ld	a5,0(s6)
ffffffffc0204f3a:	40d506b3          	sub	a3,a0,a3
    return KADDR(page2pa(page));
ffffffffc0204f3e:	000aeb97          	auipc	s7,0xae
ffffffffc0204f42:	8cab8b93          	addi	s7,s7,-1846 # ffffffffc02b2808 <npage>
    return page - pages + nbase;
ffffffffc0204f46:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0204f48:	5dfd                	li	s11,-1
ffffffffc0204f4a:	000bb703          	ld	a4,0(s7)
    return page - pages + nbase;
ffffffffc0204f4e:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0204f50:	00cddd93          	srli	s11,s11,0xc
ffffffffc0204f54:	01b6f633          	and	a2,a3,s11
    return page2ppn(page) << PGSHIFT;
ffffffffc0204f58:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204f5a:	2ee67263          	bgeu	a2,a4,ffffffffc020523e <do_fork+0x372>
    struct mm_struct *mm, *oldmm = current->mm;
ffffffffc0204f5e:	000c3603          	ld	a2,0(s8)
ffffffffc0204f62:	000aec17          	auipc	s8,0xae
ffffffffc0204f66:	8bec0c13          	addi	s8,s8,-1858 # ffffffffc02b2820 <va_pa_offset>
ffffffffc0204f6a:	000c3703          	ld	a4,0(s8)
ffffffffc0204f6e:	02863d03          	ld	s10,40(a2)
ffffffffc0204f72:	e43e                	sd	a5,8(sp)
ffffffffc0204f74:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc0204f76:	e894                	sd	a3,16(s1)
    if (oldmm == NULL) {
ffffffffc0204f78:	020d0863          	beqz	s10,ffffffffc0204fa8 <do_fork+0xdc>
    if (clone_flags & CLONE_VM) {
ffffffffc0204f7c:	100a7a13          	andi	s4,s4,256
ffffffffc0204f80:	180a0863          	beqz	s4,ffffffffc0205110 <do_fork+0x244>
}

static inline int
mm_count_inc(struct mm_struct *mm) {
    mm->mm_count += 1;
ffffffffc0204f84:	030d2703          	lw	a4,48(s10)
...
ffffffffc0204f92:	02ed2823          	sw	a4,48(s10)
    proc->mm = mm;
ffffffffc0204f96:	03a4b423          	sd	s10,40(s1)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204f9a:	26d7e963          	bltu	a5,a3,ffffffffc020520c <do_fork+0x340>
ffffffffc0204f9e:	000c3703          	ld	a4,0(s8)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204fa2:	6894                	ld	a3,16(s1)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204fa4:	8f99                	sub	a5,a5,a4
ffffffffc0204fa6:	f4dc                	sd	a5,168(s1)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204fa8:	6789                	lui	a5,0x2
ffffffffc0204faa:	ee078793          	addi	a5,a5,-288 # 1ee0 <_binary_obj___user_faultread_out_size-0x7cd0>
ffffffffc0204fae:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc0204fb0:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204fb2:	f0d4                	sd	a3,160(s1)
    *(proc->tf) = *tf;
ffffffffc0204fb4:	87b6                	mv	a5,a3
ffffffffc0204fb6:	12040893          	addi	a7,s0,288
ffffffffc0204fba:	00063803          	ld	a6,0(a2)
ffffffffc0204fbe:	6608                	ld	a0,8(a2)
ffffffffc0204fc0:	6a0c                	ld	a1,16(a2)
ffffffffc0204fc2:	6e18                	ld	a4,24(a2)
ffffffffc0204fc4:	0107b023          	sd	a6,0(a5)
ffffffffc0204fc8:	e788                	sd	a0,8(a5)
ffffffffc0204fca:	eb8c                	sd	a1,16(a5)
ffffffffc0204fcc:	ef98                	sd	a4,24(a5)
ffffffffc0204fce:	02060613          	addi	a2,a2,32
ffffffffc0204fd2:	02078793          	addi	a5,a5,32
ffffffffc0204fd6:	ff1612e3          	bne	a2,a7,ffffffffc0204fba <do_fork+0xee>
    proc->tf->gpr.a0 = 0;
ffffffffc0204fda:	0406b823          	sd	zero,80(a3) # ffffffffc0200050 <kern_init+0x1e>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204fde:	12098763          	beqz	s3,ffffffffc020510c <do_fork+0x240>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204fe2:	000a2817          	auipc	a6,0xa2
ffffffffc0204fe6:	32680813          	addi	a6,a6,806 # ffffffffc02a7308 <last_pid.1>
ffffffffc0204fea:	00082783          	lw	a5,0(a6)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204fee:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204ff2:	00000717          	auipc	a4,0x0
ffffffffc0204ff6:	d6c70713          	addi	a4,a4,-660 # ffffffffc0204d5e <forkret>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204ffa:	0017851b          	addiw	a0,a5,1
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204ffe:	f898                	sd	a4,48(s1)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0205000:	fc94                	sd	a3,56(s1)
    if (++ last_pid >= MAX_PID) {
ffffffffc0205002:	00a82023          	sw	a0,0(a6)
ffffffffc0205006:	6789                	lui	a5,0x2
ffffffffc0205008:	08f55b63          	bge	a0,a5,ffffffffc020509e <do_fork+0x1d2>
    if (last_pid >= next_safe) {
ffffffffc020500c:	000a2317          	auipc	t1,0xa2
ffffffffc0205010:	30030313          	addi	t1,t1,768 # ffffffffc02a730c <next_safe.0>
ffffffffc0205014:	00032783          	lw	a5,0(t1)
ffffffffc0205018:	000ad417          	auipc	s0,0xad
ffffffffc020501c:	7b040413          	addi	s0,s0,1968 # ffffffffc02b27c8 <proc_list>
ffffffffc0205020:	08f55763          	bge	a0,a5,ffffffffc02050ae <do_fork+0x1e2>
    proc->pid = get_pid();
ffffffffc0205024:	c0c8                	sw	a0,4(s1)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0205026:	45a9                	li	a1,10
ffffffffc0205028:	2501                	sext.w	a0,a0
ffffffffc020502a:	0ba010ef          	jal	ra,ffffffffc02060e4 <hash32>
...
ffffffffc020503a:	79278793          	addi	a5,a5,1938 # ffffffffc02ae7c8 <hash_list>
...
ffffffffc0205068:	c311                	beqz	a4,ffffffffc020506c <do_fork+0x1a0>
        proc->optr->yptr = proc;
ffffffffc020506a:	ff64                	sd	s1,248(a4)
    nr_process ++;
ffffffffc020506c:	00092783          	lw	a5,0(s2)
    wakeup_proc(proc);
ffffffffc0205070:	8526                	mv	a0,s1
    proc->parent->cptr = proc;
ffffffffc0205072:	fae4                	sd	s1,240(a3)
    nr_process ++;
ffffffffc0205074:	2785                	addiw	a5,a5,1
ffffffffc0205076:	00f92023          	sw	a5,0(s2)
    wakeup_proc(proc);
ffffffffc020507a:	67f000ef          	jal	ra,ffffffffc0205ef8 <wakeup_proc>
    ret = proc->pid;
ffffffffc020507e:	40c8                	lw	a0,4(s1)
}
ffffffffc0205080:	70e6                	ld	ra,120(sp)
ffffffffc0205082:	7446                	ld	s0,112(sp)
ffffffffc0205084:	74a6                	ld	s1,104(sp)
ffffffffc0205086:	7906                	ld	s2,96(sp)
ffffffffc0205088:	69e6                	ld	s3,88(sp)
ffffffffc020508a:	6a46                	ld	s4,80(sp)
ffffffffc020508c:	6aa6                	ld	s5,72(sp)
ffffffffc020508e:	6b06                	ld	s6,64(sp)
ffffffffc0205090:	7be2                	ld	s7,56(sp)
ffffffffc0205092:	7c42                	ld	s8,48(sp)
ffffffffc0205094:	7ca2                	ld	s9,40(sp)
ffffffffc0205096:	7d02                	ld	s10,32(sp)
ffffffffc0205098:	6de2                	ld	s11,24(sp)
ffffffffc020509a:	6109                	addi	sp,sp,128
ffffffffc020509c:	8082                	ret
        last_pid = 1;
ffffffffc020509e:	4785                	li	a5,1
ffffffffc02050a0:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02050a4:	4505                	li	a0,1
ffffffffc02050a6:	000a2317          	auipc	t1,0xa2
ffffffffc02050aa:	26630313          	addi	t1,t1,614 # ffffffffc02a730c <next_safe.0>
    return listelm->next;
ffffffffc02050ae:	000ad417          	auipc	s0,0xad
ffffffffc02050b2:	71a40413          	addi	s0,s0,1818 # ffffffffc02b27c8 <proc_list>
ffffffffc02050b6:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc02050ba:	6789                	lui	a5,0x2
ffffffffc02050bc:	00f32023          	sw	a5,0(t1)
ffffffffc02050c0:	86aa                	mv	a3,a0
ffffffffc02050c2:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc02050c4:	6e89                	lui	t4,0x2
ffffffffc02050c6:	108e0d63          	beq	t3,s0,ffffffffc02051e0 <do_fork+0x314>
ffffffffc02050ca:	88ae                	mv	a7,a1
ffffffffc02050cc:	87f2                	mv	a5,t3
ffffffffc02050ce:	6609                	lui	a2,0x2
ffffffffc02050d0:	a811                	j	ffffffffc02050e4 <do_fork+0x218>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc02050d2:	00e6d663          	bge	a3,a4,ffffffffc02050de <do_fork+0x212>
ffffffffc02050d6:	00c75463          	bge	a4,a2,ffffffffc02050de <do_fork+0x212>
ffffffffc02050da:	863a                	mv	a2,a4
ffffffffc02050dc:	4885                	li	a7,1
ffffffffc02050de:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02050e0:	00878d63          	beq	a5,s0,ffffffffc02050fa <do_fork+0x22e>
            if (proc->pid == last_pid) {
ffffffffc02050e4:	f3c7a703          	lw	a4,-196(a5) # 1f3c <_binary_obj___user_faultread_out_size-0x7c74>
ffffffffc02050e8:	fed715e3          	bne	a4,a3,ffffffffc02050d2 <do_fork+0x206>
                if (++ last_pid >= next_safe) {
ffffffffc02050ec:	2685                	addiw	a3,a3,1
ffffffffc02050ee:	0ec6d463          	bge	a3,a2,ffffffffc02051d6 <do_fork+0x30a>
ffffffffc02050f2:	679c                	ld	a5,8(a5)
ffffffffc02050f4:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc02050f6:	fe8797e3          	bne	a5,s0,ffffffffc02050e4 <do_fork+0x218>
ffffffffc02050fa:	c581                	beqz	a1,ffffffffc0205102 <do_fork+0x236>
ffffffffc02050fc:	00d82023          	sw	a3,0(a6)
ffffffffc0205100:	8536                	mv	a0,a3
ffffffffc0205102:	f20881e3          	beqz	a7,ffffffffc0205024 <do_fork+0x158>
ffffffffc0205106:	00c32023          	sw	a2,0(t1)
ffffffffc020510a:	bf29                	j	ffffffffc0205024 <do_fork+0x158>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020510c:	89b6                	mv	s3,a3
ffffffffc020510e:	bdd1                	j	ffffffffc0204fe2 <do_fork+0x116>
    if ((mm = mm_create()) == NULL) {
ffffffffc0205110:	810ff0ef          	jal	ra,ffffffffc0204120 <mm_create>
ffffffffc0205114:	8caa                	mv	s9,a0
ffffffffc0205116:	c159                	beqz	a0,ffffffffc020519c <do_fork+0x2d0>
    if ((page = alloc_page()) == NULL) {
ffffffffc0205118:	4505                	li	a0,1
ffffffffc020511a:	bc7fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc020511e:	cd25                	beqz	a0,ffffffffc0205196 <do_fork+0x2ca>
    return page - pages + nbase;
ffffffffc0205120:	000ab683          	ld	a3,0(s5)
ffffffffc0205124:	67a2                	ld	a5,8(sp)
    return KADDR(page2pa(page));
ffffffffc0205126:	000bb703          	ld	a4,0(s7)
    return page - pages + nbase;
ffffffffc020512a:	40d506b3          	sub	a3,a0,a3
ffffffffc020512e:	8699                	srai	a3,a3,0x6
ffffffffc0205130:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205132:	01b6fdb3          	and	s11,a3,s11
    return page2ppn(page) << PGSHIFT;
ffffffffc0205136:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205138:	10edf363          	bgeu	s11,a4,ffffffffc020523e <do_fork+0x372>
ffffffffc020513c:	000c3a03          	ld	s4,0(s8)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc0205140:	6605                	lui	a2,0x1
ffffffffc0205142:	000ad597          	auipc	a1,0xad
ffffffffc0205146:	6be5b583          	ld	a1,1726(a1) # ffffffffc02b2800 <boot_pgdir>
ffffffffc020514a:	9a36                	add	s4,s4,a3
ffffffffc020514c:	8552                	mv	a0,s4
ffffffffc020514e:	428010ef          	jal	ra,ffffffffc0206576 <memcpy>
}
...
lock_mm(struct mm_struct *mm) {
    if (mm != NULL) {
        lock(&(mm->mm_lock));
ffffffffc0205152:	038d0d93          	addi	s11,s10,56
    mm->pgdir = pgdir;
ffffffffc0205156:	014cbc23          	sd	s4,24(s9)
...
ffffffffc020515c:	40fdb7af          	amoor.d	a5,a5,(s11)
...
ffffffffc0205162:	4a05                	li	s4,1
ffffffffc0205164:	c799                	beqz	a5,ffffffffc0205172 <do_fork+0x2a6>
        schedule();
ffffffffc0205166:	613000ef          	jal	ra,ffffffffc0205f78 <schedule>
ffffffffc020516a:	414db7af          	amoor.d	a5,s4,(s11)
    while (!try_lock(lock)) {
ffffffffc020516e:	8b85                	andi	a5,a5,1
ffffffffc0205170:	fbfd                	bnez	a5,ffffffffc0205166 <do_fork+0x29a>
        ret = dup_mmap(mm, oldmm);
ffffffffc0205172:	85ea                	mv	a1,s10
ffffffffc0205174:	8566                	mv	a0,s9
ffffffffc0205176:	a32ff0ef          	jal	ra,ffffffffc02043a8 <dup_mmap>
...
ffffffffc020517a:	57f9                	li	a5,-2
ffffffffc020517c:	60fdb7af          	amoand.d	a5,a5,(s11)
...
ffffffffc0205182:	cbf1                	beqz	a5,ffffffffc0205256 <do_fork+0x38a>
good_mm:
ffffffffc0205184:	8d66                	mv	s10,s9
    if (ret != 0) {
ffffffffc0205186:	de050fe3          	beqz	a0,ffffffffc0204f84 <do_fork+0xb8>
    exit_mmap(mm);
ffffffffc020518a:	8566                	mv	a0,s9
ffffffffc020518c:	ab6ff0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
    put_pgdir(mm);
ffffffffc0205190:	8566                	mv	a0,s9
ffffffffc0205192:	c59ff0ef          	jal	ra,ffffffffc0204dea <put_pgdir>
    mm_destroy(mm);
ffffffffc0205196:	8566                	mv	a0,s9
ffffffffc0205198:	90eff0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc020519c:	6894                	ld	a3,16(s1)
    return pa2page(PADDR(kva));
ffffffffc020519e:	c02007b7          	lui	a5,0xc0200
ffffffffc02051a2:	08f6e263          	bltu	a3,a5,ffffffffc0205226 <do_fork+0x35a>
ffffffffc02051a6:	000c3783          	ld	a5,0(s8)
    if (PPN(pa) >= npage) {
...
ffffffffc02051b4:	04e7f063          	bgeu	a5,a4,ffffffffc02051f4 <do_fork+0x328>
    return &pages[PPN(pa) - nbase];
ffffffffc02051b8:	000b3703          	ld	a4,0(s6)
ffffffffc02051bc:	000ab503          	ld	a0,0(s5)
ffffffffc02051c0:	4589                	li	a1,2
ffffffffc02051c2:	8f99                	sub	a5,a5,a4
ffffffffc02051c4:	079a                	slli	a5,a5,0x6
ffffffffc02051c6:	953e                	add	a0,a0,a5
ffffffffc02051c8:	babfc0ef          	jal	ra,ffffffffc0201d72 <free_pages>
    kfree(proc);
ffffffffc02051cc:	8526                	mv	a0,s1
ffffffffc02051ce:	9e5fc0ef          	jal	ra,ffffffffc0201bb2 <kfree>
    ret = -E_NO_MEM;
ffffffffc02051d2:	5571                	li	a0,-4
    return ret;
ffffffffc02051d4:	b575                	j	ffffffffc0205080 <do_fork+0x1b4>
                    if (last_pid >= MAX_PID) {
ffffffffc02051d6:	01d6c363          	blt	a3,t4,ffffffffc02051dc <do_fork+0x310>
                        last_pid = 1;
ffffffffc02051da:	4685                	li	a3,1
                    goto repeat;
ffffffffc02051dc:	4585                	li	a1,1
ffffffffc02051de:	b5e5                	j	ffffffffc02050c6 <do_fork+0x1fa>
ffffffffc02051e0:	c599                	beqz	a1,ffffffffc02051ee <do_fork+0x322>
ffffffffc02051e2:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc02051e6:	8536                	mv	a0,a3
ffffffffc02051e8:	bd35                	j	ffffffffc0205024 <do_fork+0x158>
    int ret = -E_NO_FREE_PROC;
ffffffffc02051ea:	556d                	li	a0,-5
ffffffffc02051ec:	bd51                	j	ffffffffc0205080 <do_fork+0x1b4>
    return last_pid;
ffffffffc02051ee:	00082503          	lw	a0,0(a6)
ffffffffc02051f2:	bd0d                	j	ffffffffc0205024 <do_fork+0x158>
        panic("pa2page called with invalid pa");
ffffffffc02051f4:	00002617          	auipc	a2,0x2
ffffffffc02051f8:	1f460613          	addi	a2,a2,500 # ffffffffc02073e8 <default_pmm_manager+0x108>
ffffffffc02051fc:	06200593          	li	a1,98
ffffffffc0205200:	00002517          	auipc	a0,0x2
ffffffffc0205204:	14050513          	addi	a0,a0,320 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc0205208:	a72fb0ef          	jal	ra,ffffffffc020047a <__panic>
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc020520c:	86be                	mv	a3,a5
ffffffffc020520e:	00002617          	auipc	a2,0x2
ffffffffc0205212:	1b260613          	addi	a2,a2,434 # ffffffffc02073c0 <default_pmm_manager+0xe0>
ffffffffc0205216:	16700593          	li	a1,359
ffffffffc020521a:	00003517          	auipc	a0,0x3
ffffffffc020521e:	1be50513          	addi	a0,a0,446 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc0205222:	a58fb0ef          	jal	ra,ffffffffc020047a <__panic>
    return pa2page(PADDR(kva));
ffffffffc0205226:	00002617          	auipc	a2,0x2
ffffffffc020522a:	19a60613          	addi	a2,a2,410 # ffffffffc02073c0 <default_pmm_manager+0xe0>
ffffffffc020522e:	06e00593          	li	a1,110
ffffffffc0205232:	00002517          	auipc	a0,0x2
ffffffffc0205236:	10e50513          	addi	a0,a0,270 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc020523a:	a40fb0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc020523e:	00002617          	auipc	a2,0x2
ffffffffc0205242:	0da60613          	addi	a2,a2,218 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc0205246:	06900593          	li	a1,105
ffffffffc020524a:	00002517          	auipc	a0,0x2
ffffffffc020524e:	0f650513          	addi	a0,a0,246 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc0205252:	a28fb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("Unlock failed.\n");
ffffffffc0205256:	00003617          	auipc	a2,0x3
ffffffffc020525a:	19a60613          	addi	a2,a2,410 # ffffffffc02083f0 <default_pmm_manager+0x1110>
ffffffffc020525e:	03100593          	li	a1,49
ffffffffc0205262:	00003517          	auipc	a0,0x3
ffffffffc0205266:	19e50513          	addi	a0,a0,414 # ffffffffc0208400 <default_pmm_manager+0x1120>
ffffffffc020526a:	a10fb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc020526e <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc020526e:	7129                	addi	sp,sp,-320
ffffffffc0205270:	fa22                	sd	s0,304(sp)
ffffffffc0205272:	f626                	sd	s1,296(sp)
ffffffffc0205274:	f24a                	sd	s2,288(sp)
ffffffffc0205276:	84ae                	mv	s1,a1
ffffffffc0205278:	892a                	mv	s2,a0
ffffffffc020527a:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020527c:	4581                	li	a1,0
ffffffffc020527e:	12000613          	li	a2,288
ffffffffc0205282:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0205284:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0205286:	2de010ef          	jal	ra,ffffffffc0206564 <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc020528a:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc020528c:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc020528e:	100027f3          	csrr	a5,sstatus
ffffffffc0205292:	edd7f793          	andi	a5,a5,-291
ffffffffc0205296:	1207e793          	ori	a5,a5,288
ffffffffc020529a:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020529c:	860a                	mv	a2,sp
ffffffffc020529e:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02052a2:	00000797          	auipc	a5,0x0
ffffffffc02052a6:	a4278793          	addi	a5,a5,-1470 # ffffffffc0204ce4 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02052aa:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02052ac:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02052ae:	c1fff0ef          	jal	ra,ffffffffc0204ecc <do_fork>
}
ffffffffc02052b2:	70f2                	ld	ra,312(sp)
ffffffffc02052b4:	7452                	ld	s0,304(sp)
ffffffffc02052b6:	74b2                	ld	s1,296(sp)
ffffffffc02052b8:	7912                	ld	s2,288(sp)
ffffffffc02052ba:	6131                	addi	sp,sp,320
ffffffffc02052bc:	8082                	ret

ffffffffc02052be <do_exit>:
do_exit(int error_code) {
ffffffffc02052be:	7179                	addi	sp,sp,-48
ffffffffc02052c0:	f022                	sd	s0,32(sp)
    if (current == idleproc) {
ffffffffc02052c2:	000ad417          	auipc	s0,0xad
ffffffffc02052c6:	58e40413          	addi	s0,s0,1422 # ffffffffc02b2850 <current>
ffffffffc02052ca:	601c                	ld	a5,0(s0)
do_exit(int error_code) {
ffffffffc02052cc:	f406                	sd	ra,40(sp)
ffffffffc02052ce:	ec26                	sd	s1,24(sp)
ffffffffc02052d0:	e84a                	sd	s2,16(sp)
ffffffffc02052d2:	e44e                	sd	s3,8(sp)
ffffffffc02052d4:	e052                	sd	s4,0(sp)
    if (current == idleproc) {
ffffffffc02052d6:	000ad717          	auipc	a4,0xad
ffffffffc02052da:	58273703          	ld	a4,1410(a4) # ffffffffc02b2858 <idleproc>
ffffffffc02052de:	0ce78c63          	beq	a5,a4,ffffffffc02053b6 <do_exit+0xf8>
    if (current == initproc) {
ffffffffc02052e2:	000ad497          	auipc	s1,0xad
ffffffffc02052e6:	57e48493          	addi	s1,s1,1406 # ffffffffc02b2860 <initproc>
ffffffffc02052ea:	6098                	ld	a4,0(s1)
ffffffffc02052ec:	0ee78b63          	beq	a5,a4,ffffffffc02053e2 <do_exit+0x124>
    struct mm_struct *mm = current->mm;
ffffffffc02052f0:	0287b983          	ld	s3,40(a5)
ffffffffc02052f4:	892a                	mv	s2,a0
    if (mm != NULL) {
ffffffffc02052f6:	02098663          	beqz	s3,ffffffffc0205322 <do_exit+0x64>
ffffffffc02052fa:	000ad797          	auipc	a5,0xad
ffffffffc02052fe:	4fe7b783          	ld	a5,1278(a5) # ffffffffc02b27f8 <boot_cr3>
ffffffffc0205302:	577d                	li	a4,-1
ffffffffc0205304:	177e                	slli	a4,a4,0x3f
ffffffffc0205306:	83b1                	srli	a5,a5,0xc
ffffffffc0205308:	8fd9                	or	a5,a5,a4
ffffffffc020530a:	18079073          	csrw	satp,a5
    mm->mm_count -= 1;
ffffffffc020530e:	0309a783          	lw	a5,48(s3)
ffffffffc0205312:	fff7871b          	addiw	a4,a5,-1
ffffffffc0205316:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0) {
ffffffffc020531a:	cb55                	beqz	a4,ffffffffc02053ce <do_exit+0x110>
        current->mm = NULL;
ffffffffc020531c:	601c                	ld	a5,0(s0)
ffffffffc020531e:	0207b423          	sd	zero,40(a5)
    current->state = PROC_ZOMBIE;
ffffffffc0205322:	601c                	ld	a5,0(s0)
ffffffffc0205324:	470d                	li	a4,3
ffffffffc0205326:	c398                	sw	a4,0(a5)
    current->exit_code = error_code;
ffffffffc0205328:	0f27a423          	sw	s2,232(a5)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020532c:	100027f3          	csrr	a5,sstatus
ffffffffc0205330:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205332:	4a01                	li	s4,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205334:	e3f9                	bnez	a5,ffffffffc02053fa <do_exit+0x13c>
        proc = current->parent;
ffffffffc0205336:	6018                	ld	a4,0(s0)
        if (proc->wait_state == WT_CHILD) {
ffffffffc0205338:	800007b7          	lui	a5,0x80000
ffffffffc020533c:	0785                	addi	a5,a5,1
        proc = current->parent;
ffffffffc020533e:	7308                	ld	a0,32(a4)
        if (proc->wait_state == WT_CHILD) {
ffffffffc0205340:	0ec52703          	lw	a4,236(a0)
ffffffffc0205344:	0af70f63          	beq	a4,a5,ffffffffc0205402 <do_exit+0x144>
        while (current->cptr != NULL) {
ffffffffc0205348:	6018                	ld	a4,0(s0)
ffffffffc020534a:	7b7c                	ld	a5,240(a4)
ffffffffc020534c:	c3a1                	beqz	a5,ffffffffc020538c <do_exit+0xce>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc020534e:	800009b7          	lui	s3,0x80000
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205352:	490d                	li	s2,3
                if (initproc->wait_state == WT_CHILD) {
ffffffffc0205354:	0985                	addi	s3,s3,1
ffffffffc0205356:	a021                	j	ffffffffc020535e <do_exit+0xa0>
        while (current->cptr != NULL) {
ffffffffc0205358:	6018                	ld	a4,0(s0)
ffffffffc020535a:	7b7c                	ld	a5,240(a4)
ffffffffc020535c:	cb85                	beqz	a5,ffffffffc020538c <do_exit+0xce>
            current->cptr = proc->optr;
ffffffffc020535e:	1007b683          	ld	a3,256(a5) # ffffffff80000100 <_binary_obj___user_exit_out_size+0xffffffff7fff4fd8>
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc0205362:	6088                	ld	a0,0(s1)
            current->cptr = proc->optr;
ffffffffc0205364:	fb74                	sd	a3,240(a4)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc0205366:	7978                	ld	a4,240(a0)
            proc->yptr = NULL;
ffffffffc0205368:	0e07bc23          	sd	zero,248(a5)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc020536c:	10e7b023          	sd	a4,256(a5)
ffffffffc0205370:	c311                	beqz	a4,ffffffffc0205374 <do_exit+0xb6>
                initproc->cptr->yptr = proc;
ffffffffc0205372:	ff7c                	sd	a5,248(a4)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205374:	4398                	lw	a4,0(a5)
            proc->parent = initproc;
ffffffffc0205376:	f388                	sd	a0,32(a5)
            initproc->cptr = proc;
ffffffffc0205378:	f97c                	sd	a5,240(a0)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc020537a:	fd271fe3          	bne	a4,s2,ffffffffc0205358 <do_exit+0x9a>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc020537e:	0ec52783          	lw	a5,236(a0)
ffffffffc0205382:	fd379be3          	bne	a5,s3,ffffffffc0205358 <do_exit+0x9a>
                    wakeup_proc(initproc);
ffffffffc0205386:	373000ef          	jal	ra,ffffffffc0205ef8 <wakeup_proc>
ffffffffc020538a:	b7f9                	j	ffffffffc0205358 <do_exit+0x9a>
    if (flag) {
ffffffffc020538c:	020a1263          	bnez	s4,ffffffffc02053b0 <do_exit+0xf2>
    schedule();
ffffffffc0205390:	3e9000ef          	jal	ra,ffffffffc0205f78 <schedule>
    panic("do_exit will not return!! %d.\n", current->pid);
ffffffffc0205394:	601c                	ld	a5,0(s0)
ffffffffc0205396:	00003617          	auipc	a2,0x3
ffffffffc020539a:	0a260613          	addi	a2,a2,162 # ffffffffc0208438 <default_pmm_manager+0x1158>
ffffffffc020539e:	20d00593          	li	a1,525
ffffffffc02053a2:	43d4                	lw	a3,4(a5)
ffffffffc02053a4:	00003517          	auipc	a0,0x3
ffffffffc02053a8:	03450513          	addi	a0,a0,52 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc02053ac:	8cefb0ef          	jal	ra,ffffffffc020047a <__panic>
        intr_enable();
ffffffffc02053b0:	a90fb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc02053b4:	bff1                	j	ffffffffc0205390 <do_exit+0xd2>
        panic("idleproc exit.\n");
ffffffffc02053b6:	00003617          	auipc	a2,0x3
ffffffffc02053ba:	06260613          	addi	a2,a2,98 # ffffffffc0208418 <default_pmm_manager+0x1138>
ffffffffc02053be:	1e100593          	li	a1,481
ffffffffc02053c2:	00003517          	auipc	a0,0x3
ffffffffc02053c6:	01650513          	addi	a0,a0,22 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc02053ca:	8b0fb0ef          	jal	ra,ffffffffc020047a <__panic>
            exit_mmap(mm);
ffffffffc02053ce:	854e                	mv	a0,s3
ffffffffc02053d0:	872ff0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
            put_pgdir(mm);
ffffffffc02053d4:	854e                	mv	a0,s3
ffffffffc02053d6:	a15ff0ef          	jal	ra,ffffffffc0204dea <put_pgdir>
            mm_destroy(mm);
ffffffffc02053da:	854e                	mv	a0,s3
ffffffffc02053dc:	ecbfe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
ffffffffc02053e0:	bf35                	j	ffffffffc020531c <do_exit+0x5e>
        panic("initproc exit.\n");
ffffffffc02053e2:	00003617          	auipc	a2,0x3
ffffffffc02053e6:	04660613          	addi	a2,a2,70 # ffffffffc0208428 <default_pmm_manager+0x1148>
ffffffffc02053ea:	1e400593          	li	a1,484
ffffffffc02053ee:	00003517          	auipc	a0,0x3
ffffffffc02053f2:	fea50513          	addi	a0,a0,-22 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc02053f6:	884fb0ef          	jal	ra,ffffffffc020047a <__panic>
        intr_disable();
ffffffffc02053fa:	a4cfb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc02053fe:	4a05                	li	s4,1
ffffffffc0205400:	bf1d                	j	ffffffffc0205336 <do_exit+0x78>
            wakeup_proc(proc);
ffffffffc0205402:	2f7000ef          	jal	ra,ffffffffc0205ef8 <wakeup_proc>
ffffffffc0205406:	b789                	j	ffffffffc0205348 <do_exit+0x8a>

ffffffffc0205408 <do_wait.part.0>:
do_wait(int pid, int *code_store) {
ffffffffc0205408:	715d                	addi	sp,sp,-80
ffffffffc020540a:	f84a                	sd	s2,48(sp)
ffffffffc020540c:	f44e                	sd	s3,40(sp)
        current->wait_state = WT_CHILD;
ffffffffc020540e:	80000937          	lui	s2,0x80000
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205412:	6989                	lui	s3,0x2
do_wait(int pid, int *code_store) {
ffffffffc0205414:	fc26                	sd	s1,56(sp)
ffffffffc0205416:	f052                	sd	s4,32(sp)
ffffffffc0205418:	ec56                	sd	s5,24(sp)
ffffffffc020541a:	e85a                	sd	s6,16(sp)
ffffffffc020541c:	e45e                	sd	s7,8(sp)
ffffffffc020541e:	e486                	sd	ra,72(sp)
ffffffffc0205420:	e0a2                	sd	s0,64(sp)
ffffffffc0205422:	84aa                	mv	s1,a0
ffffffffc0205424:	8a2e                	mv	s4,a1
        proc = current->cptr;
ffffffffc0205426:	000adb97          	auipc	s7,0xad
ffffffffc020542a:	42ab8b93          	addi	s7,s7,1066 # ffffffffc02b2850 <current>
    if (0 < pid && pid < MAX_PID) {
ffffffffc020542e:	00050b1b          	sext.w	s6,a0
ffffffffc0205432:	fff50a9b          	addiw	s5,a0,-1
ffffffffc0205436:	19f9                	addi	s3,s3,-2
        current->wait_state = WT_CHILD;
ffffffffc0205438:	0905                	addi	s2,s2,1
    if (pid != 0) {
ffffffffc020543a:	ccbd                	beqz	s1,ffffffffc02054b8 <do_wait.part.0+0xb0>
    if (0 < pid && pid < MAX_PID) {
ffffffffc020543c:	0359e863          	bltu	s3,s5,ffffffffc020546c <do_wait.part.0+0x64>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205440:	45a9                	li	a1,10
ffffffffc0205442:	855a                	mv	a0,s6
ffffffffc0205444:	4a1000ef          	jal	ra,ffffffffc02060e4 <hash32>
ffffffffc0205448:	02051793          	slli	a5,a0,0x20
ffffffffc020544c:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0205450:	000a9797          	auipc	a5,0xa9
ffffffffc0205454:	37878793          	addi	a5,a5,888 # ffffffffc02ae7c8 <hash_list>
ffffffffc0205458:	953e                	add	a0,a0,a5
ffffffffc020545a:	842a                	mv	s0,a0
        while ((le = list_next(le)) != list) {
ffffffffc020545c:	a029                	j	ffffffffc0205466 <do_wait.part.0+0x5e>
            if (proc->pid == pid) {
ffffffffc020545e:	f2c42783          	lw	a5,-212(s0)
ffffffffc0205462:	02978163          	beq	a5,s1,ffffffffc0205484 <do_wait.part.0+0x7c>
ffffffffc0205466:	6400                	ld	s0,8(s0)
        while ((le = list_next(le)) != list) {
ffffffffc0205468:	fe851be3          	bne	a0,s0,ffffffffc020545e <do_wait.part.0+0x56>
    return -E_BAD_PROC;
ffffffffc020546c:	5579                	li	a0,-2
}
ffffffffc020546e:	60a6                	ld	ra,72(sp)
ffffffffc0205470:	6406                	ld	s0,64(sp)
ffffffffc0205472:	74e2                	ld	s1,56(sp)
ffffffffc0205474:	7942                	ld	s2,48(sp)
ffffffffc0205476:	79a2                	ld	s3,40(sp)
ffffffffc0205478:	7a02                	ld	s4,32(sp)
ffffffffc020547a:	6ae2                	ld	s5,24(sp)
ffffffffc020547c:	6b42                	ld	s6,16(sp)
ffffffffc020547e:	6ba2                	ld	s7,8(sp)
ffffffffc0205480:	6161                	addi	sp,sp,80
ffffffffc0205482:	8082                	ret
        if (proc != NULL && proc->parent == current) {
ffffffffc0205484:	000bb683          	ld	a3,0(s7)
ffffffffc0205488:	f4843783          	ld	a5,-184(s0)
ffffffffc020548c:	fed790e3          	bne	a5,a3,ffffffffc020546c <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205490:	f2842703          	lw	a4,-216(s0)
ffffffffc0205494:	478d                	li	a5,3
ffffffffc0205496:	0ef70b63          	beq	a4,a5,ffffffffc020558c <do_wait.part.0+0x184>
        current->state = PROC_SLEEPING;
ffffffffc020549a:	4785                	li	a5,1
ffffffffc020549c:	c29c                	sw	a5,0(a3)
        current->wait_state = WT_CHILD;
ffffffffc020549e:	0f26a623          	sw	s2,236(a3)
        schedule();
ffffffffc02054a2:	2d7000ef          	jal	ra,ffffffffc0205f78 <schedule>
        if (current->flags & PF_EXITING) {
ffffffffc02054a6:	000bb783          	ld	a5,0(s7)
ffffffffc02054aa:	0b07a783          	lw	a5,176(a5)
ffffffffc02054ae:	8b85                	andi	a5,a5,1
ffffffffc02054b0:	d7c9                	beqz	a5,ffffffffc020543a <do_wait.part.0+0x32>
            do_exit(-E_KILLED);
ffffffffc02054b2:	555d                	li	a0,-9
ffffffffc02054b4:	e0bff0ef          	jal	ra,ffffffffc02052be <do_exit>
        proc = current->cptr;
ffffffffc02054b8:	000bb683          	ld	a3,0(s7)
ffffffffc02054bc:	7ae0                	ld	s0,240(a3)
        for (; proc != NULL; proc = proc->optr) {
ffffffffc02054be:	d45d                	beqz	s0,ffffffffc020546c <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02054c0:	470d                	li	a4,3
ffffffffc02054c2:	a021                	j	ffffffffc02054ca <do_wait.part.0+0xc2>
        for (; proc != NULL; proc = proc->optr) {
ffffffffc02054c4:	10043403          	ld	s0,256(s0)
ffffffffc02054c8:	d869                	beqz	s0,ffffffffc020549a <do_wait.part.0+0x92>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02054ca:	401c                	lw	a5,0(s0)
ffffffffc02054cc:	fee79ce3          	bne	a5,a4,ffffffffc02054c4 <do_wait.part.0+0xbc>
    if (proc == idleproc || proc == initproc) {
ffffffffc02054d0:	000ad797          	auipc	a5,0xad
ffffffffc02054d4:	3887b783          	ld	a5,904(a5) # ffffffffc02b2858 <idleproc>
ffffffffc02054d8:	0c878963          	beq	a5,s0,ffffffffc02055aa <do_wait.part.0+0x1a2>
ffffffffc02054dc:	000ad797          	auipc	a5,0xad
ffffffffc02054e0:	3847b783          	ld	a5,900(a5) # ffffffffc02b2860 <initproc>
ffffffffc02054e4:	0cf40363          	beq	s0,a5,ffffffffc02055aa <do_wait.part.0+0x1a2>
    if (code_store != NULL) {
ffffffffc02054e8:	000a0663          	beqz	s4,ffffffffc02054f4 <do_wait.part.0+0xec>
        *code_store = proc->exit_code;
ffffffffc02054ec:	0e842783          	lw	a5,232(s0)
ffffffffc02054f0:	00fa2023          	sw	a5,0(s4) # 1000 <_binary_obj___user_faultread_out_size-0x8bb0>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02054f4:	100027f3          	csrr	a5,sstatus
ffffffffc02054f8:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc02054fa:	4581                	li	a1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02054fc:	e7c1                	bnez	a5,ffffffffc0205584 <do_wait.part.0+0x17c>
    __list_del(listelm->prev, listelm->next);
ffffffffc02054fe:	6c70                	ld	a2,216(s0)
ffffffffc0205500:	7074                	ld	a3,224(s0)
    if (proc->optr != NULL) {
ffffffffc0205502:	10043703          	ld	a4,256(s0)
        proc->optr->yptr = proc->yptr;
ffffffffc0205506:	7c7c                	ld	a5,248(s0)
    prev->next = next;
ffffffffc0205508:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc020550a:	e290                	sd	a2,0(a3)
    __list_del(listelm->prev, listelm->next);
ffffffffc020550c:	6470                	ld	a2,200(s0)
ffffffffc020550e:	6874                	ld	a3,208(s0)
    prev->next = next;
ffffffffc0205510:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc0205512:	e290                	sd	a2,0(a3)
    if (proc->optr != NULL) {
ffffffffc0205514:	c319                	beqz	a4,ffffffffc020551a <do_wait.part.0+0x112>
        proc->optr->yptr = proc->yptr;
ffffffffc0205516:	ff7c                	sd	a5,248(a4)
    if (proc->yptr != NULL) {
ffffffffc0205518:	7c7c                	ld	a5,248(s0)
ffffffffc020551a:	c3b5                	beqz	a5,ffffffffc020557e <do_wait.part.0+0x176>
        proc->yptr->optr = proc->optr;
ffffffffc020551c:	10e7b023          	sd	a4,256(a5)
    nr_process --;
ffffffffc0205520:	000ad717          	auipc	a4,0xad
ffffffffc0205524:	34870713          	addi	a4,a4,840 # ffffffffc02b2868 <nr_process>
ffffffffc0205528:	431c                	lw	a5,0(a4)
ffffffffc020552a:	37fd                	addiw	a5,a5,-1
ffffffffc020552c:	c31c                	sw	a5,0(a4)
    if (flag) {
ffffffffc020552e:	e5a9                	bnez	a1,ffffffffc0205578 <do_wait.part.0+0x170>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc0205530:	6814                	ld	a3,16(s0)
    return pa2page(PADDR(kva));
ffffffffc0205532:	c02007b7          	lui	a5,0xc0200
ffffffffc0205536:	04f6ee63          	bltu	a3,a5,ffffffffc0205592 <do_wait.part.0+0x18a>
ffffffffc020553a:	000ad797          	auipc	a5,0xad
ffffffffc020553e:	2e67b783          	ld	a5,742(a5) # ffffffffc02b2820 <va_pa_offset>
ffffffffc0205542:	8e9d                	sub	a3,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc0205544:	82b1                	srli	a3,a3,0xc
ffffffffc0205546:	000ad797          	auipc	a5,0xad
ffffffffc020554a:	2c27b783          	ld	a5,706(a5) # ffffffffc02b2808 <npage>
ffffffffc020554e:	06f6fa63          	bgeu	a3,a5,ffffffffc02055c2 <do_wait.part.0+0x1ba>
    return &pages[PPN(pa) - nbase];
ffffffffc0205552:	00003517          	auipc	a0,0x3
ffffffffc0205556:	71e53503          	ld	a0,1822(a0) # ffffffffc0208c70 <nbase>
ffffffffc020555a:	8e89                	sub	a3,a3,a0
ffffffffc020555c:	069a                	slli	a3,a3,0x6
ffffffffc020555e:	000ad517          	auipc	a0,0xad
ffffffffc0205562:	2b253503          	ld	a0,690(a0) # ffffffffc02b2810 <pages>
ffffffffc0205566:	9536                	add	a0,a0,a3
ffffffffc0205568:	4589                	li	a1,2
ffffffffc020556a:	809fc0ef          	jal	ra,ffffffffc0201d72 <free_pages>
    kfree(proc);
ffffffffc020556e:	8522                	mv	a0,s0
ffffffffc0205570:	e42fc0ef          	jal	ra,ffffffffc0201bb2 <kfree>
    return 0;
ffffffffc0205574:	4501                	li	a0,0
ffffffffc0205576:	bde5                	j	ffffffffc020546e <do_wait.part.0+0x66>
        intr_enable();
ffffffffc0205578:	8c8fb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc020557c:	bf55                	j	ffffffffc0205530 <do_wait.part.0+0x128>
       proc->parent->cptr = proc->optr;
ffffffffc020557e:	701c                	ld	a5,32(s0)
ffffffffc0205580:	fbf8                	sd	a4,240(a5)
ffffffffc0205582:	bf79                	j	ffffffffc0205520 <do_wait.part.0+0x118>
        intr_disable();
ffffffffc0205584:	8c2fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0205588:	4585                	li	a1,1
ffffffffc020558a:	bf95                	j	ffffffffc02054fe <do_wait.part.0+0xf6>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc020558c:	f2840413          	addi	s0,s0,-216
ffffffffc0205590:	b781                	j	ffffffffc02054d0 <do_wait.part.0+0xc8>
    return pa2page(PADDR(kva));
ffffffffc0205592:	00002617          	auipc	a2,0x2
ffffffffc0205596:	e2e60613          	addi	a2,a2,-466 # ffffffffc02073c0 <default_pmm_manager+0xe0>
ffffffffc020559a:	06e00593          	li	a1,110
ffffffffc020559e:	00002517          	auipc	a0,0x2
ffffffffc02055a2:	da250513          	addi	a0,a0,-606 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc02055a6:	ed5fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("wait idleproc or initproc.\n");
ffffffffc02055aa:	00003617          	auipc	a2,0x3
ffffffffc02055ae:	eae60613          	addi	a2,a2,-338 # ffffffffc0208458 <default_pmm_manager+0x1178>
ffffffffc02055b2:	30500593          	li	a1,773
ffffffffc02055b6:	00003517          	auipc	a0,0x3
ffffffffc02055ba:	e2250513          	addi	a0,a0,-478 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc02055be:	ebdfa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02055c2:	00002617          	auipc	a2,0x2
ffffffffc02055c6:	e2660613          	addi	a2,a2,-474 # ffffffffc02073e8 <default_pmm_manager+0x108>
ffffffffc02055ca:	06200593          	li	a1,98
ffffffffc02055ce:	00002517          	auipc	a0,0x2
ffffffffc02055d2:	d7250513          	addi	a0,a0,-654 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc02055d6:	ea5fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc02055da <init_main>:
}

// init_main - the second kernel thread used to create user_main kernel threads
static int
init_main(void *arg) {
ffffffffc02055da:	1141                	addi	sp,sp,-16
ffffffffc02055dc:	e406                	sd	ra,8(sp)
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc02055de:	fd4fc0ef          	jal	ra,ffffffffc0201db2 <nr_free_pages>
    size_t kernel_allocated_store = kallocated();
ffffffffc02055e2:	d1cfc0ef          	jal	ra,ffffffffc0201afe <kallocated>

    int pid = kernel_thread(user_main, NULL, 0);
ffffffffc02055e6:	4601                	li	a2,0
ffffffffc02055e8:	4581                	li	a1,0
ffffffffc02055ea:	fffff517          	auipc	a0,0xfffff
ffffffffc02055ee:	78250513          	addi	a0,a0,1922 # ffffffffc0204d6c <user_main>
ffffffffc02055f2:	c7dff0ef          	jal	ra,ffffffffc020526e <kernel_thread>
    if (pid <= 0) {
ffffffffc02055f6:	00a04563          	bgtz	a0,ffffffffc0205600 <init_main+0x26>
ffffffffc02055fa:	a071                	j	ffffffffc0205686 <init_main+0xac>
        panic("create user_main failed.\n");
    }

    while (do_wait(0, NULL) == 0) {
        schedule();
ffffffffc02055fc:	17d000ef          	jal	ra,ffffffffc0205f78 <schedule>
    if (code_store != NULL) {
ffffffffc0205600:	4581                	li	a1,0
ffffffffc0205602:	4501                	li	a0,0
ffffffffc0205604:	e05ff0ef          	jal	ra,ffffffffc0205408 <do_wait.part.0>
    while (do_wait(0, NULL) == 0) {
ffffffffc0205608:	d975                	beqz	a0,ffffffffc02055fc <init_main+0x22>
    }

    cprintf("all user-mode processes have quit.\n");
ffffffffc020560a:	00003517          	auipc	a0,0x3
ffffffffc020560e:	e8e50513          	addi	a0,a0,-370 # ffffffffc0208498 <default_pmm_manager+0x11b8>
ffffffffc0205612:	b6ffa0ef          	jal	ra,ffffffffc0200180 <cprintf>
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc0205616:	000ad797          	auipc	a5,0xad
ffffffffc020561a:	24a7b783          	ld	a5,586(a5) # ffffffffc02b2860 <initproc>
ffffffffc020561e:	7bf8                	ld	a4,240(a5)
ffffffffc0205620:	e339                	bnez	a4,ffffffffc0205666 <init_main+0x8c>
ffffffffc0205622:	7ff8                	ld	a4,248(a5)
ffffffffc0205624:	e329                	bnez	a4,ffffffffc0205666 <init_main+0x8c>
ffffffffc0205626:	1007b703          	ld	a4,256(a5)
ffffffffc020562a:	ef15                	bnez	a4,ffffffffc0205666 <init_main+0x8c>
    assert(nr_process == 2);
ffffffffc020562c:	000ad697          	auipc	a3,0xad
ffffffffc0205630:	23c6a683          	lw	a3,572(a3) # ffffffffc02b2868 <nr_process>
ffffffffc0205634:	4709                	li	a4,2
ffffffffc0205636:	0ae69463          	bne	a3,a4,ffffffffc02056de <init_main+0x104>
    return listelm->next;
ffffffffc020563a:	000ad697          	auipc	a3,0xad
ffffffffc020563e:	18e68693          	addi	a3,a3,398 # ffffffffc02b27c8 <proc_list>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc0205642:	6698                	ld	a4,8(a3)
ffffffffc0205644:	0c878793          	addi	a5,a5,200
ffffffffc0205648:	06f71b63          	bne	a4,a5,ffffffffc02056be <init_main+0xe4>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc020564c:	629c                	ld	a5,0(a3)
ffffffffc020564e:	04f71863          	bne	a4,a5,ffffffffc020569e <init_main+0xc4>

    cprintf("init check memory pass.\n");
ffffffffc0205652:	00003517          	auipc	a0,0x3
ffffffffc0205656:	f2e50513          	addi	a0,a0,-210 # ffffffffc0208580 <default_pmm_manager+0x12a0>
ffffffffc020565a:	b27fa0ef          	jal	ra,ffffffffc0200180 <cprintf>
    return 0;
}
ffffffffc020565e:	60a2                	ld	ra,8(sp)
ffffffffc0205660:	4501                	li	a0,0
ffffffffc0205662:	0141                	addi	sp,sp,16
ffffffffc0205664:	8082                	ret
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc0205666:	00003697          	auipc	a3,0x3
ffffffffc020566a:	e5a68693          	addi	a3,a3,-422 # ffffffffc02084c0 <default_pmm_manager+0x11e0>
ffffffffc020566e:	00001617          	auipc	a2,0x1
ffffffffc0205672:	5da60613          	addi	a2,a2,1498 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205676:	36a00593          	li	a1,874
ffffffffc020567a:	00003517          	auipc	a0,0x3
ffffffffc020567e:	d5e50513          	addi	a0,a0,-674 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc0205682:	df9fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("create user_main failed.\n");
ffffffffc0205686:	00003617          	auipc	a2,0x3
ffffffffc020568a:	df260613          	addi	a2,a2,-526 # ffffffffc0208478 <default_pmm_manager+0x1198>
ffffffffc020568e:	36200593          	li	a1,866
ffffffffc0205692:	00003517          	auipc	a0,0x3
ffffffffc0205696:	d4650513          	addi	a0,a0,-698 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc020569a:	de1fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc020569e:	00003697          	auipc	a3,0x3
ffffffffc02056a2:	eb268693          	addi	a3,a3,-334 # ffffffffc0208550 <default_pmm_manager+0x1270>
ffffffffc02056a6:	00001617          	auipc	a2,0x1
ffffffffc02056aa:	5a260613          	addi	a2,a2,1442 # ffffffffc0206c48 <commands+0x450>
ffffffffc02056ae:	36d00593          	li	a1,877
ffffffffc02056b2:	00003517          	auipc	a0,0x3
ffffffffc02056b6:	d2650513          	addi	a0,a0,-730 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc02056ba:	dc1fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc02056be:	00003697          	auipc	a3,0x3
ffffffffc02056c2:	e6268693          	addi	a3,a3,-414 # ffffffffc0208520 <default_pmm_manager+0x1240>
ffffffffc02056c6:	00001617          	auipc	a2,0x1
ffffffffc02056ca:	58260613          	addi	a2,a2,1410 # ffffffffc0206c48 <commands+0x450>
ffffffffc02056ce:	36c00593          	li	a1,876
ffffffffc02056d2:	00003517          	auipc	a0,0x3
ffffffffc02056d6:	d0650513          	addi	a0,a0,-762 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc02056da:	da1fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_process == 2);
ffffffffc02056de:	00003697          	auipc	a3,0x3
ffffffffc02056e2:	e3268693          	addi	a3,a3,-462 # ffffffffc0208510 <default_pmm_manager+0x1230>
ffffffffc02056e6:	00001617          	auipc	a2,0x1
ffffffffc02056ea:	56260613          	addi	a2,a2,1378 # ffffffffc0206c48 <commands+0x450>
ffffffffc02056ee:	36b00593          	li	a1,875
ffffffffc02056f2:	00003517          	auipc	a0,0x3
ffffffffc02056f6:	ce650513          	addi	a0,a0,-794 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc02056fa:	d81fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc02056fe <do_execve>:
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc02056fe:	7171                	addi	sp,sp,-176
ffffffffc0205700:	e4ee                	sd	s11,72(sp)
    struct mm_struct *mm = current->mm;
ffffffffc0205702:	000add97          	auipc	s11,0xad
ffffffffc0205706:	14ed8d93          	addi	s11,s11,334 # ffffffffc02b2850 <current>
ffffffffc020570a:	000db783          	ld	a5,0(s11)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc020570e:	e54e                	sd	s3,136(sp)
ffffffffc0205710:	ed26                	sd	s1,152(sp)
    struct mm_struct *mm = current->mm;
ffffffffc0205712:	0287b983          	ld	s3,40(a5)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205716:	e94a                	sd	s2,144(sp)
ffffffffc0205718:	f4de                	sd	s7,104(sp)
ffffffffc020571a:	892a                	mv	s2,a0
ffffffffc020571c:	8bb2                	mv	s7,a2
ffffffffc020571e:	84ae                	mv	s1,a1
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc0205720:	862e                	mv	a2,a1
ffffffffc0205722:	4681                	li	a3,0
ffffffffc0205724:	85aa                	mv	a1,a0
ffffffffc0205726:	854e                	mv	a0,s3
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205728:	f506                	sd	ra,168(sp)
ffffffffc020572a:	f122                	sd	s0,160(sp)
ffffffffc020572c:	e152                	sd	s4,128(sp)
ffffffffc020572e:	fcd6                	sd	s5,120(sp)
ffffffffc0205730:	f8da                	sd	s6,112(sp)
ffffffffc0205732:	f0e2                	sd	s8,96(sp)
ffffffffc0205734:	ece6                	sd	s9,88(sp)
ffffffffc0205736:	e8ea                	sd	s10,80(sp)
ffffffffc0205738:	f05e                	sd	s7,32(sp)
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc020573a:	bc2ff0ef          	jal	ra,ffffffffc0204afc <user_mem_check>
ffffffffc020573e:	40050a63          	beqz	a0,ffffffffc0205b52 <do_execve+0x454>
    memset(local_name, 0, sizeof(local_name));
ffffffffc0205742:	4641                	li	a2,16
ffffffffc0205744:	4581                	li	a1,0
ffffffffc0205746:	1808                	addi	a0,sp,48
ffffffffc0205748:	61d000ef          	jal	ra,ffffffffc0206564 <memset>
    memcpy(local_name, name, len);
ffffffffc020574c:	47bd                	li	a5,15
ffffffffc020574e:	8626                	mv	a2,s1
ffffffffc0205750:	1e97e263          	bltu	a5,s1,ffffffffc0205934 <do_execve+0x236>
ffffffffc0205754:	85ca                	mv	a1,s2
ffffffffc0205756:	1808                	addi	a0,sp,48
ffffffffc0205758:	61f000ef          	jal	ra,ffffffffc0206576 <memcpy>
    if (mm != NULL) {
ffffffffc020575c:	1e098363          	beqz	s3,ffffffffc0205942 <do_execve+0x244>
        cputs("mm != NULL");
ffffffffc0205760:	00002517          	auipc	a0,0x2
ffffffffc0205764:	30850513          	addi	a0,a0,776 # ffffffffc0207a68 <default_pmm_manager+0x788>
ffffffffc0205768:	a51fa0ef          	jal	ra,ffffffffc02001b8 <cputs>
ffffffffc020576c:	000ad797          	auipc	a5,0xad
ffffffffc0205770:	08c7b783          	ld	a5,140(a5) # ffffffffc02b27f8 <boot_cr3>
ffffffffc0205774:	577d                	li	a4,-1
ffffffffc0205776:	177e                	slli	a4,a4,0x3f
ffffffffc0205778:	83b1                	srli	a5,a5,0xc
ffffffffc020577a:	8fd9                	or	a5,a5,a4
ffffffffc020577c:	18079073          	csrw	satp,a5
ffffffffc0205780:	0309a783          	lw	a5,48(s3) # 2030 <_binary_obj___user_faultread_out_size-0x7b80>
ffffffffc0205784:	fff7871b          	addiw	a4,a5,-1
ffffffffc0205788:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0) {
ffffffffc020578c:	2c070463          	beqz	a4,ffffffffc0205a54 <do_execve+0x356>
        current->mm = NULL;
ffffffffc0205790:	000db783          	ld	a5,0(s11)
ffffffffc0205794:	0207b423          	sd	zero,40(a5)
    if ((mm = mm_create()) == NULL) {
ffffffffc0205798:	989fe0ef          	jal	ra,ffffffffc0204120 <mm_create>
ffffffffc020579c:	84aa                	mv	s1,a0
ffffffffc020579e:	1c050d63          	beqz	a0,ffffffffc0205978 <do_execve+0x27a>
    if ((page = alloc_page()) == NULL) {
ffffffffc02057a2:	4505                	li	a0,1
ffffffffc02057a4:	d3cfc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc02057a8:	3a050963          	beqz	a0,ffffffffc0205b5a <do_execve+0x45c>
    return page - pages + nbase;
ffffffffc02057ac:	000adc97          	auipc	s9,0xad
ffffffffc02057b0:	064c8c93          	addi	s9,s9,100 # ffffffffc02b2810 <pages>
ffffffffc02057b4:	000cb683          	ld	a3,0(s9)
    return KADDR(page2pa(page));
ffffffffc02057b8:	000adc17          	auipc	s8,0xad
ffffffffc02057bc:	050c0c13          	addi	s8,s8,80 # ffffffffc02b2808 <npage>
    return page - pages + nbase;
ffffffffc02057c0:	00003717          	auipc	a4,0x3
ffffffffc02057c4:	4b073703          	ld	a4,1200(a4) # ffffffffc0208c70 <nbase>
ffffffffc02057c8:	40d506b3          	sub	a3,a0,a3
ffffffffc02057cc:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc02057ce:	5afd                	li	s5,-1
ffffffffc02057d0:	000c3783          	ld	a5,0(s8)
    return page - pages + nbase;
ffffffffc02057d4:	96ba                	add	a3,a3,a4
ffffffffc02057d6:	e83a                	sd	a4,16(sp)
    return KADDR(page2pa(page));
ffffffffc02057d8:	00cad713          	srli	a4,s5,0xc
ffffffffc02057dc:	ec3a                	sd	a4,24(sp)
ffffffffc02057de:	8f75                	and	a4,a4,a3
    return page2ppn(page) << PGSHIFT;
ffffffffc02057e0:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02057e2:	38f77063          	bgeu	a4,a5,ffffffffc0205b62 <do_execve+0x464>
ffffffffc02057e6:	000adb17          	auipc	s6,0xad
ffffffffc02057ea:	03ab0b13          	addi	s6,s6,58 # ffffffffc02b2820 <va_pa_offset>
ffffffffc02057ee:	000b3903          	ld	s2,0(s6)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc02057f2:	6605                	lui	a2,0x1
ffffffffc02057f4:	000ad597          	auipc	a1,0xad
ffffffffc02057f8:	00c5b583          	ld	a1,12(a1) # ffffffffc02b2800 <boot_pgdir>
ffffffffc02057fc:	9936                	add	s2,s2,a3
ffffffffc02057fe:	854a                	mv	a0,s2
ffffffffc0205800:	577000ef          	jal	ra,ffffffffc0206576 <memcpy>
    if (elf->e_magic != ELF_MAGIC) {
ffffffffc0205804:	7782                	ld	a5,32(sp)
ffffffffc0205806:	4398                	lw	a4,0(a5)
ffffffffc0205808:	464c47b7          	lui	a5,0x464c4
    mm->pgdir = pgdir;
ffffffffc020580c:	0124bc23          	sd	s2,24(s1)
    if (elf->e_magic != ELF_MAGIC) {
ffffffffc0205810:	57f78793          	addi	a5,a5,1407 # 464c457f <_binary_obj___user_exit_out_size+0x464b9457>
ffffffffc0205814:	14f71863          	bne	a4,a5,ffffffffc0205964 <do_execve+0x266>
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0205818:	7682                	ld	a3,32(sp)
ffffffffc020581a:	0386d703          	lhu	a4,56(a3)
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc020581e:	0206b983          	ld	s3,32(a3)
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0205822:	00371793          	slli	a5,a4,0x3
ffffffffc0205826:	8f99                	sub	a5,a5,a4
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc0205828:	99b6                	add	s3,s3,a3
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc020582a:	078e                	slli	a5,a5,0x3
ffffffffc020582c:	97ce                	add	a5,a5,s3
ffffffffc020582e:	f43e                	sd	a5,40(sp)
    for (; ph < ph_end; ph ++) {
ffffffffc0205830:	00f9fc63          	bgeu	s3,a5,ffffffffc0205848 <do_execve+0x14a>
        if (ph->p_type != ELF_PT_LOAD) {
ffffffffc0205834:	0009a783          	lw	a5,0(s3)
ffffffffc0205838:	4705                	li	a4,1
ffffffffc020583a:	14e78163          	beq	a5,a4,ffffffffc020597c <do_execve+0x27e>
    for (; ph < ph_end; ph ++) {
ffffffffc020583e:	77a2                	ld	a5,40(sp)
ffffffffc0205840:	03898993          	addi	s3,s3,56
ffffffffc0205844:	fef9e8e3          	bltu	s3,a5,ffffffffc0205834 <do_execve+0x136>
    if ((ret = mm_map(mm, USTACKTOP - USTACKSIZE, USTACKSIZE, vm_flags, NULL)) != 0) {
ffffffffc0205848:	4701                	li	a4,0
ffffffffc020584a:	46ad                	li	a3,11
ffffffffc020584c:	00100637          	lui	a2,0x100
ffffffffc0205850:	7ff005b7          	lui	a1,0x7ff00
ffffffffc0205854:	8526                	mv	a0,s1
ffffffffc0205856:	aa3fe0ef          	jal	ra,ffffffffc02042f8 <mm_map>
ffffffffc020585a:	892a                	mv	s2,a0
ffffffffc020585c:	1e051263          	bnez	a0,ffffffffc0205a40 <do_execve+0x342>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205860:	6c88                	ld	a0,24(s1)
ffffffffc0205862:	467d                	li	a2,31
ffffffffc0205864:	7ffff5b7          	lui	a1,0x7ffff
ffffffffc0205868:	ae5fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc020586c:	38050363          	beqz	a0,ffffffffc0205bf2 <do_execve+0x4f4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205870:	6c88                	ld	a0,24(s1)
ffffffffc0205872:	467d                	li	a2,31
ffffffffc0205874:	7fffe5b7          	lui	a1,0x7fffe
ffffffffc0205878:	ad5fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc020587c:	34050b63          	beqz	a0,ffffffffc0205bd2 <do_execve+0x4d4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205880:	6c88                	ld	a0,24(s1)
ffffffffc0205882:	467d                	li	a2,31
ffffffffc0205884:	7fffd5b7          	lui	a1,0x7fffd
ffffffffc0205888:	ac5fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc020588c:	32050363          	beqz	a0,ffffffffc0205bb2 <do_execve+0x4b4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc0205890:	6c88                	ld	a0,24(s1)
ffffffffc0205892:	467d                	li	a2,31
ffffffffc0205894:	7fffc5b7          	lui	a1,0x7fffc
ffffffffc0205898:	ab5fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc020589c:	2e050b63          	beqz	a0,ffffffffc0205b92 <do_execve+0x494>
    mm->mm_count += 1;
ffffffffc02058a0:	589c                	lw	a5,48(s1)
    current->mm = mm;
ffffffffc02058a2:	000db603          	ld	a2,0(s11)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc02058a6:	6c94                	ld	a3,24(s1)
ffffffffc02058a8:	2785                	addiw	a5,a5,1
ffffffffc02058aa:	d89c                	sw	a5,48(s1)
    current->mm = mm;
ffffffffc02058ac:	f604                	sd	s1,40(a2)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc02058ae:	c02007b7          	lui	a5,0xc0200
ffffffffc02058b2:	2cf6e463          	bltu	a3,a5,ffffffffc0205b7a <do_execve+0x47c>
ffffffffc02058b6:	000b3783          	ld	a5,0(s6)
ffffffffc02058ba:	577d                	li	a4,-1
ffffffffc02058bc:	177e                	slli	a4,a4,0x3f
ffffffffc02058be:	8e9d                	sub	a3,a3,a5
ffffffffc02058c0:	00c6d793          	srli	a5,a3,0xc
ffffffffc02058c4:	f654                	sd	a3,168(a2)
ffffffffc02058c6:	8fd9                	or	a5,a5,a4
ffffffffc02058c8:	18079073          	csrw	satp,a5
    struct trapframe *tf = current->tf;
ffffffffc02058cc:	7244                	ld	s1,160(a2)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc02058ce:	4581                	li	a1,0
ffffffffc02058d0:	12000613          	li	a2,288
ffffffffc02058d4:	8526                	mv	a0,s1
ffffffffc02058d6:	48f000ef          	jal	ra,ffffffffc0206564 <memset>
    tf->epc = elf->e_entry;
ffffffffc02058da:	7782                	ld	a5,32(sp)
ffffffffc02058dc:	6f98                	ld	a4,24(a5)
    tf->gpr.sp = USTACKTOP;
ffffffffc02058de:	4785                	li	a5,1
ffffffffc02058e0:	07fe                	slli	a5,a5,0x1f
ffffffffc02058e2:	e89c                	sd	a5,16(s1)
    tf->epc = elf->e_entry;
ffffffffc02058e4:	10e4b423          	sd	a4,264(s1)
    tf->status = (read_csr(sstatus) & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc02058e8:	100027f3          	csrr	a5,sstatus
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02058ec:	000db403          	ld	s0,0(s11)
    tf->status = (read_csr(sstatus) & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc02058f0:	edf7f793          	andi	a5,a5,-289
ffffffffc02058f4:	0207e793          	ori	a5,a5,32
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02058f8:	0b440413          	addi	s0,s0,180
ffffffffc02058fc:	4641                	li	a2,16
ffffffffc02058fe:	4581                	li	a1,0
    tf->status = (read_csr(sstatus) & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc0205900:	10f4b023          	sd	a5,256(s1)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205904:	8522                	mv	a0,s0
ffffffffc0205906:	45f000ef          	jal	ra,ffffffffc0206564 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020590a:	463d                	li	a2,15
ffffffffc020590c:	180c                	addi	a1,sp,48
ffffffffc020590e:	8522                	mv	a0,s0
ffffffffc0205910:	467000ef          	jal	ra,ffffffffc0206576 <memcpy>
}
ffffffffc0205914:	70aa                	ld	ra,168(sp)
ffffffffc0205916:	740a                	ld	s0,160(sp)
ffffffffc0205918:	64ea                	ld	s1,152(sp)
ffffffffc020591a:	69aa                	ld	s3,136(sp)
ffffffffc020591c:	6a0a                	ld	s4,128(sp)
ffffffffc020591e:	7ae6                	ld	s5,120(sp)
ffffffffc0205920:	7b46                	ld	s6,112(sp)
ffffffffc0205922:	7ba6                	ld	s7,104(sp)
ffffffffc0205924:	7c06                	ld	s8,96(sp)
ffffffffc0205926:	6ce6                	ld	s9,88(sp)
ffffffffc0205928:	6d46                	ld	s10,80(sp)
ffffffffc020592a:	6da6                	ld	s11,72(sp)
ffffffffc020592c:	854a                	mv	a0,s2
ffffffffc020592e:	694a                	ld	s2,144(sp)
ffffffffc0205930:	614d                	addi	sp,sp,176
ffffffffc0205932:	8082                	ret
    memcpy(local_name, name, len);
ffffffffc0205934:	463d                	li	a2,15
ffffffffc0205936:	85ca                	mv	a1,s2
ffffffffc0205938:	1808                	addi	a0,sp,48
ffffffffc020593a:	43d000ef          	jal	ra,ffffffffc0206576 <memcpy>
    if (mm != NULL) {
ffffffffc020593e:	e20991e3          	bnez	s3,ffffffffc0205760 <do_execve+0x62>
    if (current->mm != NULL) {
ffffffffc0205942:	000db783          	ld	a5,0(s11)
ffffffffc0205946:	779c                	ld	a5,40(a5)
ffffffffc0205948:	e40788e3          	beqz	a5,ffffffffc0205798 <do_execve+0x9a>
        panic("load_icode: current->mm must be empty.\n");
ffffffffc020594c:	00003617          	auipc	a2,0x3
ffffffffc0205950:	c5460613          	addi	a2,a2,-940 # ffffffffc02085a0 <default_pmm_manager+0x12c0>
ffffffffc0205954:	21700593          	li	a1,535
ffffffffc0205958:	00003517          	auipc	a0,0x3
ffffffffc020595c:	a8050513          	addi	a0,a0,-1408 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc0205960:	b1bfa0ef          	jal	ra,ffffffffc020047a <__panic>
    put_pgdir(mm);
ffffffffc0205964:	8526                	mv	a0,s1
ffffffffc0205966:	c84ff0ef          	jal	ra,ffffffffc0204dea <put_pgdir>
    mm_destroy(mm);
ffffffffc020596a:	8526                	mv	a0,s1
ffffffffc020596c:	93bfe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
        ret = -E_INVAL_ELF;
ffffffffc0205970:	5961                	li	s2,-8
    do_exit(ret);
ffffffffc0205972:	854a                	mv	a0,s2
ffffffffc0205974:	94bff0ef          	jal	ra,ffffffffc02052be <do_exit>
    int ret = -E_NO_MEM;
ffffffffc0205978:	5971                	li	s2,-4
ffffffffc020597a:	bfe5                	j	ffffffffc0205972 <do_execve+0x274>
        if (ph->p_filesz > ph->p_memsz) {
ffffffffc020597c:	0289b603          	ld	a2,40(s3)
ffffffffc0205980:	0209b783          	ld	a5,32(s3)
ffffffffc0205984:	1cf66d63          	bltu	a2,a5,ffffffffc0205b5e <do_execve+0x460>
        if (ph->p_flags & ELF_PF_X) vm_flags |= VM_EXEC;
ffffffffc0205988:	0049a783          	lw	a5,4(s3)
ffffffffc020598c:	0017f693          	andi	a3,a5,1
ffffffffc0205990:	c291                	beqz	a3,ffffffffc0205994 <do_execve+0x296>
ffffffffc0205992:	4691                	li	a3,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205994:	0027f713          	andi	a4,a5,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205998:	8b91                	andi	a5,a5,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc020599a:	e779                	bnez	a4,ffffffffc0205a68 <do_execve+0x36a>
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc020599c:	4d45                	li	s10,17
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc020599e:	c781                	beqz	a5,ffffffffc02059a6 <do_execve+0x2a8>
ffffffffc02059a0:	0016e693          	ori	a3,a3,1
        if (vm_flags & VM_READ) perm |= PTE_R;
ffffffffc02059a4:	4d4d                	li	s10,19
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc02059a6:	0026f793          	andi	a5,a3,2
ffffffffc02059aa:	e3f1                	bnez	a5,ffffffffc0205a6e <do_execve+0x370>
        if (vm_flags & VM_EXEC) perm |= PTE_X;
ffffffffc02059ac:	0046f793          	andi	a5,a3,4
ffffffffc02059b0:	c399                	beqz	a5,ffffffffc02059b6 <do_execve+0x2b8>
ffffffffc02059b2:	008d6d13          	ori	s10,s10,8
        if ((ret = mm_map(mm, ph->p_va, ph->p_memsz, vm_flags, NULL)) != 0) {
ffffffffc02059b6:	0109b583          	ld	a1,16(s3)
ffffffffc02059ba:	4701                	li	a4,0
ffffffffc02059bc:	8526                	mv	a0,s1
ffffffffc02059be:	93bfe0ef          	jal	ra,ffffffffc02042f8 <mm_map>
ffffffffc02059c2:	892a                	mv	s2,a0
ffffffffc02059c4:	ed35                	bnez	a0,ffffffffc0205a40 <do_execve+0x342>
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc02059c6:	0109bb83          	ld	s7,16(s3)
ffffffffc02059ca:	77fd                	lui	a5,0xfffff
        end = ph->p_va + ph->p_filesz;
ffffffffc02059cc:	0209ba03          	ld	s4,32(s3)
        unsigned char *from = binary + ph->p_offset;
ffffffffc02059d0:	0089b903          	ld	s2,8(s3)
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc02059d4:	00fbfab3          	and	s5,s7,a5
        unsigned char *from = binary + ph->p_offset;
ffffffffc02059d8:	7782                	ld	a5,32(sp)
        end = ph->p_va + ph->p_filesz;
ffffffffc02059da:	9a5e                	add	s4,s4,s7
        unsigned char *from = binary + ph->p_offset;
ffffffffc02059dc:	993e                	add	s2,s2,a5
        while (start < end) {
ffffffffc02059de:	054be963          	bltu	s7,s4,ffffffffc0205a30 <do_execve+0x332>
ffffffffc02059e2:	aa95                	j	ffffffffc0205b56 <do_execve+0x458>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc02059e4:	6785                	lui	a5,0x1
ffffffffc02059e6:	415b8533          	sub	a0,s7,s5
ffffffffc02059ea:	9abe                	add	s5,s5,a5
ffffffffc02059ec:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc02059f0:	015a7463          	bgeu	s4,s5,ffffffffc02059f8 <do_execve+0x2fa>
                size -= la - end;
ffffffffc02059f4:	417a0633          	sub	a2,s4,s7
    return page - pages + nbase;
ffffffffc02059f8:	000cb683          	ld	a3,0(s9)
ffffffffc02059fc:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc02059fe:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc0205a02:	40d406b3          	sub	a3,s0,a3
ffffffffc0205a06:	8699                	srai	a3,a3,0x6
ffffffffc0205a08:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205a0a:	67e2                	ld	a5,24(sp)
ffffffffc0205a0c:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205a10:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205a12:	14b87863          	bgeu	a6,a1,ffffffffc0205b62 <do_execve+0x464>
ffffffffc0205a16:	000b3803          	ld	a6,0(s6)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a1a:	85ca                	mv	a1,s2
            start += size, from += size;
ffffffffc0205a1c:	9bb2                	add	s7,s7,a2
ffffffffc0205a1e:	96c2                	add	a3,a3,a6
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a20:	9536                	add	a0,a0,a3
            start += size, from += size;
ffffffffc0205a22:	e432                	sd	a2,8(sp)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a24:	353000ef          	jal	ra,ffffffffc0206576 <memcpy>
            start += size, from += size;
ffffffffc0205a28:	6622                	ld	a2,8(sp)
ffffffffc0205a2a:	9932                	add	s2,s2,a2
        while (start < end) {
ffffffffc0205a2c:	054bf363          	bgeu	s7,s4,ffffffffc0205a72 <do_execve+0x374>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205a30:	6c88                	ld	a0,24(s1)
ffffffffc0205a32:	866a                	mv	a2,s10
ffffffffc0205a34:	85d6                	mv	a1,s5
ffffffffc0205a36:	917fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205a3a:	842a                	mv	s0,a0
ffffffffc0205a3c:	f545                	bnez	a0,ffffffffc02059e4 <do_execve+0x2e6>
        ret = -E_NO_MEM;
ffffffffc0205a3e:	5971                	li	s2,-4
    exit_mmap(mm);
ffffffffc0205a40:	8526                	mv	a0,s1
ffffffffc0205a42:	a01fe0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
    put_pgdir(mm);
ffffffffc0205a46:	8526                	mv	a0,s1
ffffffffc0205a48:	ba2ff0ef          	jal	ra,ffffffffc0204dea <put_pgdir>
    mm_destroy(mm);
ffffffffc0205a4c:	8526                	mv	a0,s1
ffffffffc0205a4e:	859fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
    return ret;
ffffffffc0205a52:	b705                	j	ffffffffc0205972 <do_execve+0x274>
            exit_mmap(mm);
ffffffffc0205a54:	854e                	mv	a0,s3
ffffffffc0205a56:	9edfe0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
            put_pgdir(mm);
ffffffffc0205a5a:	854e                	mv	a0,s3
ffffffffc0205a5c:	b8eff0ef          	jal	ra,ffffffffc0204dea <put_pgdir>
            mm_destroy(mm);
ffffffffc0205a60:	854e                	mv	a0,s3
ffffffffc0205a62:	845fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
ffffffffc0205a66:	b32d                	j	ffffffffc0205790 <do_execve+0x92>
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205a68:	0026e693          	ori	a3,a3,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205a6c:	fb95                	bnez	a5,ffffffffc02059a0 <do_execve+0x2a2>
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205a6e:	4d5d                	li	s10,23
ffffffffc0205a70:	bf35                	j	ffffffffc02059ac <do_execve+0x2ae>
        end = ph->p_va + ph->p_memsz;
ffffffffc0205a72:	0109b683          	ld	a3,16(s3)
ffffffffc0205a76:	0289b903          	ld	s2,40(s3)
ffffffffc0205a7a:	9936                	add	s2,s2,a3
        if (start < la) {
ffffffffc0205a7c:	075bfd63          	bgeu	s7,s5,ffffffffc0205af6 <do_execve+0x3f8>
            if (start == end) {
ffffffffc0205a80:	db790fe3          	beq	s2,s7,ffffffffc020583e <do_execve+0x140>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205a84:	6785                	lui	a5,0x1
ffffffffc0205a86:	00fb8533          	add	a0,s7,a5
ffffffffc0205a8a:	41550533          	sub	a0,a0,s5
                size -= la - end;
ffffffffc0205a8e:	41790a33          	sub	s4,s2,s7
            if (end < la) {
ffffffffc0205a92:	0b597d63          	bgeu	s2,s5,ffffffffc0205b4c <do_execve+0x44e>
    return page - pages + nbase;
ffffffffc0205a96:	000cb683          	ld	a3,0(s9)
ffffffffc0205a9a:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205a9c:	000c3603          	ld	a2,0(s8)
    return page - pages + nbase;
ffffffffc0205aa0:	40d406b3          	sub	a3,s0,a3
ffffffffc0205aa4:	8699                	srai	a3,a3,0x6
ffffffffc0205aa6:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205aa8:	67e2                	ld	a5,24(sp)
ffffffffc0205aaa:	00f6f5b3          	and	a1,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205aae:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205ab0:	0ac5f963          	bgeu	a1,a2,ffffffffc0205b62 <do_execve+0x464>
ffffffffc0205ab4:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205ab8:	8652                	mv	a2,s4
ffffffffc0205aba:	4581                	li	a1,0
ffffffffc0205abc:	96c2                	add	a3,a3,a6
ffffffffc0205abe:	9536                	add	a0,a0,a3
ffffffffc0205ac0:	2a5000ef          	jal	ra,ffffffffc0206564 <memset>
            start += size;
ffffffffc0205ac4:	017a0733          	add	a4,s4,s7
            assert((end < la && start == end) || (end >= la && start == la));
ffffffffc0205ac8:	03597463          	bgeu	s2,s5,ffffffffc0205af0 <do_execve+0x3f2>
ffffffffc0205acc:	d6e909e3          	beq	s2,a4,ffffffffc020583e <do_execve+0x140>
ffffffffc0205ad0:	00003697          	auipc	a3,0x3
ffffffffc0205ad4:	af868693          	addi	a3,a3,-1288 # ffffffffc02085c8 <default_pmm_manager+0x12e8>
ffffffffc0205ad8:	00001617          	auipc	a2,0x1
ffffffffc0205adc:	17060613          	addi	a2,a2,368 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205ae0:	26c00593          	li	a1,620
ffffffffc0205ae4:	00003517          	auipc	a0,0x3
ffffffffc0205ae8:	8f450513          	addi	a0,a0,-1804 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc0205aec:	98ffa0ef          	jal	ra,ffffffffc020047a <__panic>
ffffffffc0205af0:	ff5710e3          	bne	a4,s5,ffffffffc0205ad0 <do_execve+0x3d2>
ffffffffc0205af4:	8bd6                	mv	s7,s5
        while (start < end) {
ffffffffc0205af6:	d52bf4e3          	bgeu	s7,s2,ffffffffc020583e <do_execve+0x140>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205afa:	6c88                	ld	a0,24(s1)
ffffffffc0205afc:	866a                	mv	a2,s10
ffffffffc0205afe:	85d6                	mv	a1,s5
ffffffffc0205b00:	84dfd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205b04:	842a                	mv	s0,a0
ffffffffc0205b06:	dd05                	beqz	a0,ffffffffc0205a3e <do_execve+0x340>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205b08:	6785                	lui	a5,0x1
ffffffffc0205b0a:	415b8533          	sub	a0,s7,s5
ffffffffc0205b0e:	9abe                	add	s5,s5,a5
ffffffffc0205b10:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc0205b14:	01597463          	bgeu	s2,s5,ffffffffc0205b1c <do_execve+0x41e>
                size -= la - end;
ffffffffc0205b18:	41790633          	sub	a2,s2,s7
    return page - pages + nbase;
ffffffffc0205b1c:	000cb683          	ld	a3,0(s9)
ffffffffc0205b20:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205b22:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc0205b26:	40d406b3          	sub	a3,s0,a3
ffffffffc0205b2a:	8699                	srai	a3,a3,0x6
ffffffffc0205b2c:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205b2e:	67e2                	ld	a5,24(sp)
ffffffffc0205b30:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205b34:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205b36:	02b87663          	bgeu	a6,a1,ffffffffc0205b62 <do_execve+0x464>
ffffffffc0205b3a:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205b3e:	4581                	li	a1,0
            start += size;
ffffffffc0205b40:	9bb2                	add	s7,s7,a2
ffffffffc0205b42:	96c2                	add	a3,a3,a6
            memset(page2kva(page) + off, 0, size);
ffffffffc0205b44:	9536                	add	a0,a0,a3
ffffffffc0205b46:	21f000ef          	jal	ra,ffffffffc0206564 <memset>
ffffffffc0205b4a:	b775                	j	ffffffffc0205af6 <do_execve+0x3f8>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205b4c:	417a8a33          	sub	s4,s5,s7
ffffffffc0205b50:	b799                	j	ffffffffc0205a96 <do_execve+0x398>
        return -E_INVAL;
ffffffffc0205b52:	5975                	li	s2,-3
ffffffffc0205b54:	b3c1                	j	ffffffffc0205914 <do_execve+0x216>
        while (start < end) {
ffffffffc0205b56:	86de                	mv	a3,s7
ffffffffc0205b58:	bf39                	j	ffffffffc0205a76 <do_execve+0x378>
    int ret = -E_NO_MEM;
ffffffffc0205b5a:	5971                	li	s2,-4
ffffffffc0205b5c:	bdc5                	j	ffffffffc0205a4c <do_execve+0x34e>
            ret = -E_INVAL_ELF;
ffffffffc0205b5e:	5961                	li	s2,-8
ffffffffc0205b60:	b5c5                	j	ffffffffc0205a40 <do_execve+0x342>
ffffffffc0205b62:	00001617          	auipc	a2,0x1
ffffffffc0205b66:	7b660613          	addi	a2,a2,1974 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc0205b6a:	06900593          	li	a1,105
ffffffffc0205b6e:	00001517          	auipc	a0,0x1
ffffffffc0205b72:	7d250513          	addi	a0,a0,2002 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc0205b76:	905fa0ef          	jal	ra,ffffffffc020047a <__panic>
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205b7a:	00002617          	auipc	a2,0x2
ffffffffc0205b7e:	84660613          	addi	a2,a2,-1978 # ffffffffc02073c0 <default_pmm_manager+0xe0>
ffffffffc0205b82:	28700593          	li	a1,647
ffffffffc0205b86:	00003517          	auipc	a0,0x3
ffffffffc0205b8a:	85250513          	addi	a0,a0,-1966 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc0205b8e:	8edfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc0205b92:	00003697          	auipc	a3,0x3
ffffffffc0205b96:	b4e68693          	addi	a3,a3,-1202 # ffffffffc02086e0 <default_pmm_manager+0x1400>
ffffffffc0205b9a:	00001617          	auipc	a2,0x1
ffffffffc0205b9e:	0ae60613          	addi	a2,a2,174 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205ba2:	28200593          	li	a1,642
ffffffffc0205ba6:	00003517          	auipc	a0,0x3
ffffffffc0205baa:	83250513          	addi	a0,a0,-1998 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc0205bae:	8cdfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205bb2:	00003697          	auipc	a3,0x3
ffffffffc0205bb6:	ae668693          	addi	a3,a3,-1306 # ffffffffc0208698 <default_pmm_manager+0x13b8>
ffffffffc0205bba:	00001617          	auipc	a2,0x1
ffffffffc0205bbe:	08e60613          	addi	a2,a2,142 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205bc2:	28100593          	li	a1,641
ffffffffc0205bc6:	00003517          	auipc	a0,0x3
ffffffffc0205bca:	81250513          	addi	a0,a0,-2030 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc0205bce:	8adfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205bd2:	00003697          	auipc	a3,0x3
ffffffffc0205bd6:	a7e68693          	addi	a3,a3,-1410 # ffffffffc0208650 <default_pmm_manager+0x1370>
ffffffffc0205bda:	00001617          	auipc	a2,0x1
ffffffffc0205bde:	06e60613          	addi	a2,a2,110 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205be2:	28000593          	li	a1,640
ffffffffc0205be6:	00002517          	auipc	a0,0x2
ffffffffc0205bea:	7f250513          	addi	a0,a0,2034 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc0205bee:	88dfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205bf2:	00003697          	auipc	a3,0x3
ffffffffc0205bf6:	a1668693          	addi	a3,a3,-1514 # ffffffffc0208608 <default_pmm_manager+0x1328>
ffffffffc0205bfa:	00001617          	auipc	a2,0x1
ffffffffc0205bfe:	04e60613          	addi	a2,a2,78 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205c02:	27f00593          	li	a1,639
ffffffffc0205c06:	00002517          	auipc	a0,0x2
ffffffffc0205c0a:	7d250513          	addi	a0,a0,2002 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc0205c0e:	86dfa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205c12 <do_yield>:
    current->need_resched = 1;
ffffffffc0205c12:	000ad797          	auipc	a5,0xad
ffffffffc0205c16:	c3e7b783          	ld	a5,-962(a5) # ffffffffc02b2850 <current>
ffffffffc0205c1a:	4705                	li	a4,1
ffffffffc0205c1c:	ef98                	sd	a4,24(a5)
}
ffffffffc0205c1e:	4501                	li	a0,0
ffffffffc0205c20:	8082                	ret

ffffffffc0205c22 <do_wait>:
do_wait(int pid, int *code_store) {
ffffffffc0205c22:	1101                	addi	sp,sp,-32
ffffffffc0205c24:	e822                	sd	s0,16(sp)
ffffffffc0205c26:	e426                	sd	s1,8(sp)
ffffffffc0205c28:	ec06                	sd	ra,24(sp)
ffffffffc0205c2a:	842e                	mv	s0,a1
ffffffffc0205c2c:	84aa                	mv	s1,a0
    if (code_store != NULL) {
ffffffffc0205c2e:	c999                	beqz	a1,ffffffffc0205c44 <do_wait+0x22>
    struct mm_struct *mm = current->mm;
ffffffffc0205c30:	000ad797          	auipc	a5,0xad
ffffffffc0205c34:	c207b783          	ld	a5,-992(a5) # ffffffffc02b2850 <current>
        if (!user_mem_check(mm, (uintptr_t)code_store, sizeof(int), 1)) {
ffffffffc0205c38:	7788                	ld	a0,40(a5)
ffffffffc0205c3a:	4685                	li	a3,1
ffffffffc0205c3c:	4611                	li	a2,4
ffffffffc0205c3e:	ebffe0ef          	jal	ra,ffffffffc0204afc <user_mem_check>
ffffffffc0205c42:	c909                	beqz	a0,ffffffffc0205c54 <do_wait+0x32>
ffffffffc0205c44:	85a2                	mv	a1,s0
}
ffffffffc0205c46:	6442                	ld	s0,16(sp)
ffffffffc0205c48:	60e2                	ld	ra,24(sp)
ffffffffc0205c4a:	8526                	mv	a0,s1
ffffffffc0205c4c:	64a2                	ld	s1,8(sp)
ffffffffc0205c4e:	6105                	addi	sp,sp,32
ffffffffc0205c50:	fb8ff06f          	j	ffffffffc0205408 <do_wait.part.0>
ffffffffc0205c54:	60e2                	ld	ra,24(sp)
ffffffffc0205c56:	6442                	ld	s0,16(sp)
ffffffffc0205c58:	64a2                	ld	s1,8(sp)
ffffffffc0205c5a:	5575                	li	a0,-3
ffffffffc0205c5c:	6105                	addi	sp,sp,32
ffffffffc0205c5e:	8082                	ret

ffffffffc0205c60 <do_kill>:
do_kill(int pid) {
ffffffffc0205c60:	1141                	addi	sp,sp,-16
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205c62:	6789                	lui	a5,0x2
do_kill(int pid) {
ffffffffc0205c64:	e406                	sd	ra,8(sp)
ffffffffc0205c66:	e022                	sd	s0,0(sp)
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205c68:	fff5071b          	addiw	a4,a0,-1
ffffffffc0205c6c:	17f9                	addi	a5,a5,-2
ffffffffc0205c6e:	02e7e963          	bltu	a5,a4,ffffffffc0205ca0 <do_kill+0x40>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205c72:	842a                	mv	s0,a0
ffffffffc0205c74:	45a9                	li	a1,10
ffffffffc0205c76:	2501                	sext.w	a0,a0
ffffffffc0205c78:	46c000ef          	jal	ra,ffffffffc02060e4 <hash32>
ffffffffc0205c7c:	02051793          	slli	a5,a0,0x20
ffffffffc0205c80:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0205c84:	000a9797          	auipc	a5,0xa9
ffffffffc0205c88:	b4478793          	addi	a5,a5,-1212 # ffffffffc02ae7c8 <hash_list>
ffffffffc0205c8c:	953e                	add	a0,a0,a5
ffffffffc0205c8e:	87aa                	mv	a5,a0
        while ((le = list_next(le)) != list) {
ffffffffc0205c90:	a029                	j	ffffffffc0205c9a <do_kill+0x3a>
            if (proc->pid == pid) {
ffffffffc0205c92:	f2c7a703          	lw	a4,-212(a5)
ffffffffc0205c96:	00870b63          	beq	a4,s0,ffffffffc0205cac <do_kill+0x4c>
ffffffffc0205c9a:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205c9c:	fef51be3          	bne	a0,a5,ffffffffc0205c92 <do_kill+0x32>
    return -E_INVAL;
ffffffffc0205ca0:	5475                	li	s0,-3
}
ffffffffc0205ca2:	60a2                	ld	ra,8(sp)
ffffffffc0205ca4:	8522                	mv	a0,s0
ffffffffc0205ca6:	6402                	ld	s0,0(sp)
ffffffffc0205ca8:	0141                	addi	sp,sp,16
ffffffffc0205caa:	8082                	ret
        if (!(proc->flags & PF_EXITING)) {
ffffffffc0205cac:	fd87a703          	lw	a4,-40(a5)
ffffffffc0205cb0:	00177693          	andi	a3,a4,1
ffffffffc0205cb4:	e295                	bnez	a3,ffffffffc0205cd8 <do_kill+0x78>
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205cb6:	4bd4                	lw	a3,20(a5)
            proc->flags |= PF_EXITING;
ffffffffc0205cb8:	00176713          	ori	a4,a4,1
ffffffffc0205cbc:	fce7ac23          	sw	a4,-40(a5)
            return 0;
ffffffffc0205cc0:	4401                	li	s0,0
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205cc2:	fe06d0e3          	bgez	a3,ffffffffc0205ca2 <do_kill+0x42>
                wakeup_proc(proc);
ffffffffc0205cc6:	f2878513          	addi	a0,a5,-216
ffffffffc0205cca:	22e000ef          	jal	ra,ffffffffc0205ef8 <wakeup_proc>
}
ffffffffc0205cce:	60a2                	ld	ra,8(sp)
ffffffffc0205cd0:	8522                	mv	a0,s0
ffffffffc0205cd2:	6402                	ld	s0,0(sp)
ffffffffc0205cd4:	0141                	addi	sp,sp,16
ffffffffc0205cd6:	8082                	ret
        return -E_KILLED;
ffffffffc0205cd8:	545d                	li	s0,-9
ffffffffc0205cda:	b7e1                	j	ffffffffc0205ca2 <do_kill+0x42>

ffffffffc0205cdc <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc0205cdc:	1101                	addi	sp,sp,-32
ffffffffc0205cde:	e426                	sd	s1,8(sp)
    elm->prev = elm->next = elm;
ffffffffc0205ce0:	000ad797          	auipc	a5,0xad
ffffffffc0205ce4:	ae878793          	addi	a5,a5,-1304 # ffffffffc02b27c8 <proc_list>
ffffffffc0205ce8:	ec06                	sd	ra,24(sp)
ffffffffc0205cea:	e822                	sd	s0,16(sp)
ffffffffc0205cec:	e04a                	sd	s2,0(sp)
ffffffffc0205cee:	000a9497          	auipc	s1,0xa9
ffffffffc0205cf2:	ada48493          	addi	s1,s1,-1318 # ffffffffc02ae7c8 <hash_list>
ffffffffc0205cf6:	e79c                	sd	a5,8(a5)
ffffffffc0205cf8:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc0205cfa:	000ad717          	auipc	a4,0xad
ffffffffc0205cfe:	ace70713          	addi	a4,a4,-1330 # ffffffffc02b27c8 <proc_list>
ffffffffc0205d02:	87a6                	mv	a5,s1
ffffffffc0205d04:	e79c                	sd	a5,8(a5)
ffffffffc0205d06:	e39c                	sd	a5,0(a5)
ffffffffc0205d08:	07c1                	addi	a5,a5,16
ffffffffc0205d0a:	fef71de3          	bne	a4,a5,ffffffffc0205d04 <proc_init+0x28>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0205d0e:	fdffe0ef          	jal	ra,ffffffffc0204cec <alloc_proc>
ffffffffc0205d12:	000ad917          	auipc	s2,0xad
ffffffffc0205d16:	b4690913          	addi	s2,s2,-1210 # ffffffffc02b2858 <idleproc>
ffffffffc0205d1a:	00a93023          	sd	a0,0(s2)
ffffffffc0205d1e:	0e050f63          	beqz	a0,ffffffffc0205e1c <proc_init+0x140>
        panic("cannot alloc idleproc.\n");
    }

    idleproc->pid = 0;
    idleproc->state = PROC_RUNNABLE;
ffffffffc0205d22:	4789                	li	a5,2
ffffffffc0205d24:	e11c                	sd	a5,0(a0)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205d26:	00003797          	auipc	a5,0x3
ffffffffc0205d2a:	2da78793          	addi	a5,a5,730 # ffffffffc0209000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205d2e:	0b450413          	addi	s0,a0,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205d32:	e91c                	sd	a5,16(a0)
    idleproc->need_resched = 1;
ffffffffc0205d34:	4785                	li	a5,1
ffffffffc0205d36:	ed1c                	sd	a5,24(a0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205d38:	4641                	li	a2,16
ffffffffc0205d3a:	4581                	li	a1,0
ffffffffc0205d3c:	8522                	mv	a0,s0
ffffffffc0205d3e:	027000ef          	jal	ra,ffffffffc0206564 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205d42:	463d                	li	a2,15
ffffffffc0205d44:	00003597          	auipc	a1,0x3
ffffffffc0205d48:	9fc58593          	addi	a1,a1,-1540 # ffffffffc0208740 <default_pmm_manager+0x1460>
ffffffffc0205d4c:	8522                	mv	a0,s0
ffffffffc0205d4e:	029000ef          	jal	ra,ffffffffc0206576 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc0205d52:	000ad717          	auipc	a4,0xad
ffffffffc0205d56:	b1670713          	addi	a4,a4,-1258 # ffffffffc02b2868 <nr_process>
ffffffffc0205d5a:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc0205d5c:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205d60:	4601                	li	a2,0
    nr_process ++;
ffffffffc0205d62:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205d64:	4581                	li	a1,0
ffffffffc0205d66:	00000517          	auipc	a0,0x0
ffffffffc0205d6a:	87450513          	addi	a0,a0,-1932 # ffffffffc02055da <init_main>
    nr_process ++;
ffffffffc0205d6e:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0205d70:	000ad797          	auipc	a5,0xad
ffffffffc0205d74:	aed7b023          	sd	a3,-1312(a5) # ffffffffc02b2850 <current>
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205d78:	cf6ff0ef          	jal	ra,ffffffffc020526e <kernel_thread>
ffffffffc0205d7c:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc0205d7e:	08a05363          	blez	a0,ffffffffc0205e04 <proc_init+0x128>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205d82:	6789                	lui	a5,0x2
ffffffffc0205d84:	fff5071b          	addiw	a4,a0,-1
ffffffffc0205d88:	17f9                	addi	a5,a5,-2
ffffffffc0205d8a:	2501                	sext.w	a0,a0
ffffffffc0205d8c:	02e7e363          	bltu	a5,a4,ffffffffc0205db2 <proc_init+0xd6>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205d90:	45a9                	li	a1,10
ffffffffc0205d92:	352000ef          	jal	ra,ffffffffc02060e4 <hash32>
ffffffffc0205d96:	02051793          	slli	a5,a0,0x20
ffffffffc0205d9a:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0205d9e:	96a6                	add	a3,a3,s1
ffffffffc0205da0:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc0205da2:	a029                	j	ffffffffc0205dac <proc_init+0xd0>
            if (proc->pid == pid) {
ffffffffc0205da4:	f2c7a703          	lw	a4,-212(a5) # 1f2c <_binary_obj___user_faultread_out_size-0x7c84>
ffffffffc0205da8:	04870b63          	beq	a4,s0,ffffffffc0205dfe <proc_init+0x122>
    return listelm->next;
ffffffffc0205dac:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205dae:	fef69be3          	bne	a3,a5,ffffffffc0205da4 <proc_init+0xc8>
    return NULL;
ffffffffc0205db2:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205db4:	0b478493          	addi	s1,a5,180
ffffffffc0205db8:	4641                	li	a2,16
ffffffffc0205dba:	4581                	li	a1,0
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0205dbc:	000ad417          	auipc	s0,0xad
ffffffffc0205dc0:	aa440413          	addi	s0,s0,-1372 # ffffffffc02b2860 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205dc4:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0205dc6:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205dc8:	79c000ef          	jal	ra,ffffffffc0206564 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205dcc:	463d                	li	a2,15
ffffffffc0205dce:	00003597          	auipc	a1,0x3
ffffffffc0205dd2:	99a58593          	addi	a1,a1,-1638 # ffffffffc0208768 <default_pmm_manager+0x1488>
ffffffffc0205dd6:	8526                	mv	a0,s1
ffffffffc0205dd8:	79e000ef          	jal	ra,ffffffffc0206576 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205ddc:	00093783          	ld	a5,0(s2)
ffffffffc0205de0:	cbb5                	beqz	a5,ffffffffc0205e54 <proc_init+0x178>
ffffffffc0205de2:	43dc                	lw	a5,4(a5)
ffffffffc0205de4:	eba5                	bnez	a5,ffffffffc0205e54 <proc_init+0x178>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205de6:	601c                	ld	a5,0(s0)
ffffffffc0205de8:	c7b1                	beqz	a5,ffffffffc0205e34 <proc_init+0x158>
ffffffffc0205dea:	43d8                	lw	a4,4(a5)
ffffffffc0205dec:	4785                	li	a5,1
ffffffffc0205dee:	04f71363          	bne	a4,a5,ffffffffc0205e34 <proc_init+0x158>
}
ffffffffc0205df2:	60e2                	ld	ra,24(sp)
ffffffffc0205df4:	6442                	ld	s0,16(sp)
ffffffffc0205df6:	64a2                	ld	s1,8(sp)
ffffffffc0205df8:	6902                	ld	s2,0(sp)
ffffffffc0205dfa:	6105                	addi	sp,sp,32
ffffffffc0205dfc:	8082                	ret
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0205dfe:	f2878793          	addi	a5,a5,-216
ffffffffc0205e02:	bf4d                	j	ffffffffc0205db4 <proc_init+0xd8>
        panic("create init_main failed.\n");
ffffffffc0205e04:	00003617          	auipc	a2,0x3
ffffffffc0205e08:	94460613          	addi	a2,a2,-1724 # ffffffffc0208748 <default_pmm_manager+0x1468>
ffffffffc0205e0c:	38d00593          	li	a1,909
ffffffffc0205e10:	00002517          	auipc	a0,0x2
ffffffffc0205e14:	5c850513          	addi	a0,a0,1480 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc0205e18:	e62fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("cannot alloc idleproc.\n");
ffffffffc0205e1c:	00003617          	auipc	a2,0x3
ffffffffc0205e20:	90c60613          	addi	a2,a2,-1780 # ffffffffc0208728 <default_pmm_manager+0x1448>
ffffffffc0205e24:	37f00593          	li	a1,895
ffffffffc0205e28:	00002517          	auipc	a0,0x2
ffffffffc0205e2c:	5b050513          	addi	a0,a0,1456 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc0205e30:	e4afa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205e34:	00003697          	auipc	a3,0x3
ffffffffc0205e38:	96468693          	addi	a3,a3,-1692 # ffffffffc0208798 <default_pmm_manager+0x14b8>
ffffffffc0205e3c:	00001617          	auipc	a2,0x1
ffffffffc0205e40:	e0c60613          	addi	a2,a2,-500 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205e44:	39400593          	li	a1,916
ffffffffc0205e48:	00002517          	auipc	a0,0x2
ffffffffc0205e4c:	59050513          	addi	a0,a0,1424 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc0205e50:	e2afa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205e54:	00003697          	auipc	a3,0x3
ffffffffc0205e58:	91c68693          	addi	a3,a3,-1764 # ffffffffc0208770 <default_pmm_manager+0x1490>
ffffffffc0205e5c:	00001617          	auipc	a2,0x1
ffffffffc0205e60:	dec60613          	addi	a2,a2,-532 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205e64:	39300593          	li	a1,915
ffffffffc0205e68:	00002517          	auipc	a0,0x2
ffffffffc0205e6c:	57050513          	addi	a0,a0,1392 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc0205e70:	e0afa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205e74 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0205e74:	1141                	addi	sp,sp,-16
ffffffffc0205e76:	e022                	sd	s0,0(sp)
ffffffffc0205e78:	e406                	sd	ra,8(sp)
ffffffffc0205e7a:	000ad417          	auipc	s0,0xad
ffffffffc0205e7e:	9d640413          	addi	s0,s0,-1578 # ffffffffc02b2850 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0205e82:	6018                	ld	a4,0(s0)
ffffffffc0205e84:	6f1c                	ld	a5,24(a4)
ffffffffc0205e86:	dffd                	beqz	a5,ffffffffc0205e84 <cpu_idle+0x10>
            schedule();
ffffffffc0205e88:	0f0000ef          	jal	ra,ffffffffc0205f78 <schedule>
ffffffffc0205e8c:	bfdd                	j	ffffffffc0205e82 <cpu_idle+0xe>

ffffffffc0205e8e <switch_to>:
.text
...
ffffffffc0205e8e:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0205e92:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0205e96:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0205e98:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0205e9a:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0205e9e:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0205ea2:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0205ea6:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0205eaa:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0205eae:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0205eb2:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0205eb6:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0205eba:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0205ebe:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0205ec2:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0205ec6:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0205eca:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0205ecc:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0205ece:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0205ed2:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0205ed6:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0205eda:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0205ede:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0205ee2:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0205ee6:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0205eea:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0205eee:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0205ef2:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc0205ef6:	8082                	ret

ffffffffc0205ef8 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc0205ef8:	4118                	lw	a4,0(a0)
wakeup_proc(struct proc_struct *proc) {
ffffffffc0205efa:	1101                	addi	sp,sp,-32
ffffffffc0205efc:	ec06                	sd	ra,24(sp)
ffffffffc0205efe:	e822                	sd	s0,16(sp)
ffffffffc0205f00:	e426                	sd	s1,8(sp)
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205f02:	478d                	li	a5,3
ffffffffc0205f04:	04f70b63          	beq	a4,a5,ffffffffc0205f5a <wakeup_proc+0x62>
ffffffffc0205f08:	842a                	mv	s0,a0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205f0a:	100027f3          	csrr	a5,sstatus
ffffffffc0205f0e:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205f10:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205f12:	ef9d                	bnez	a5,ffffffffc0205f50 <wakeup_proc+0x58>
    bool intr_flag;
    local_intr_save(intr_flag);
    {
        if (proc->state != PROC_RUNNABLE) {
ffffffffc0205f14:	4789                	li	a5,2
ffffffffc0205f16:	02f70163          	beq	a4,a5,ffffffffc0205f38 <wakeup_proc+0x40>
            proc->state = PROC_RUNNABLE;
ffffffffc0205f1a:	c01c                	sw	a5,0(s0)
            proc->wait_state = 0;
ffffffffc0205f1c:	0e042623          	sw	zero,236(s0)
    if (flag) {
ffffffffc0205f20:	e491                	bnez	s1,ffffffffc0205f2c <wakeup_proc+0x34>
        else {
...
ffffffffc0205f30:	64a2                	ld	s1,8(sp)
ffffffffc0205f32:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc0205f34:	f0cfa06f          	j	ffffffffc0200640 <intr_enable>
            warn("wakeup runnable process.\n");
ffffffffc0205f38:	00003617          	auipc	a2,0x3
ffffffffc0205f3c:	8c060613          	addi	a2,a2,-1856 # ffffffffc02087f8 <default_pmm_manager+0x1518>
ffffffffc0205f40:	45c9                	li	a1,18
ffffffffc0205f42:	00003517          	auipc	a0,0x3
ffffffffc0205f46:	89e50513          	addi	a0,a0,-1890 # ffffffffc02087e0 <default_pmm_manager+0x1500>
ffffffffc0205f4a:	d98fa0ef          	jal	ra,ffffffffc02004e2 <__warn>
ffffffffc0205f4e:	bfc9                	j	ffffffffc0205f20 <wakeup_proc+0x28>
        intr_disable();
ffffffffc0205f50:	ef6fa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        if (proc->state != PROC_RUNNABLE) {
ffffffffc0205f54:	4018                	lw	a4,0(s0)
        return 1;
ffffffffc0205f56:	4485                	li	s1,1
ffffffffc0205f58:	bf75                	j	ffffffffc0205f14 <wakeup_proc+0x1c>
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205f5a:	00003697          	auipc	a3,0x3
ffffffffc0205f5e:	86668693          	addi	a3,a3,-1946 # ffffffffc02087c0 <default_pmm_manager+0x14e0>
ffffffffc0205f62:	00001617          	auipc	a2,0x1
ffffffffc0205f66:	ce660613          	addi	a2,a2,-794 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205f6a:	45a5                	li	a1,9
ffffffffc0205f6c:	00003517          	auipc	a0,0x3
ffffffffc0205f70:	87450513          	addi	a0,a0,-1932 # ffffffffc02087e0 <default_pmm_manager+0x1500>
ffffffffc0205f74:	d06fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205f78 <schedule>:

void
schedule(void) {
ffffffffc0205f78:	1141                	addi	sp,sp,-16
ffffffffc0205f7a:	e406                	sd	ra,8(sp)
ffffffffc0205f7c:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205f7e:	100027f3          	csrr	a5,sstatus
ffffffffc0205f82:	8b89                	andi	a5,a5,2
ffffffffc0205f84:	4401                	li	s0,0
ffffffffc0205f86:	efbd                	bnez	a5,ffffffffc0206004 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0205f88:	000ad897          	auipc	a7,0xad
ffffffffc0205f8c:	8c88b883          	ld	a7,-1848(a7) # ffffffffc02b2850 <current>
ffffffffc0205f90:	0008bc23          	sd	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0205f94:	000ad517          	auipc	a0,0xad
ffffffffc0205f98:	8c453503          	ld	a0,-1852(a0) # ffffffffc02b2858 <idleproc>
ffffffffc0205f9c:	04a88e63          	beq	a7,a0,ffffffffc0205ff8 <schedule+0x80>
ffffffffc0205fa0:	0c888693          	addi	a3,a7,200
ffffffffc0205fa4:	000ad617          	auipc	a2,0xad
ffffffffc0205fa8:	82460613          	addi	a2,a2,-2012 # ffffffffc02b27c8 <proc_list>
        le = last;
ffffffffc0205fac:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
ffffffffc0205fae:	4581                	li	a1,0
        do {
            if ((le = list_next(le)) != &proc_list) {
                next = le2proc(le, list_link);
                if (next->state == PROC_RUNNABLE) {
ffffffffc0205fb0:	4809                	li	a6,2
ffffffffc0205fb2:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0205fb4:	00c78863          	beq	a5,a2,ffffffffc0205fc4 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0205fb8:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0205fbc:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0205fc0:	03070163          	beq	a4,a6,ffffffffc0205fe2 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc0205fc4:	fef697e3          	bne	a3,a5,ffffffffc0205fb2 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0205fc8:	ed89                	bnez	a1,ffffffffc0205fe2 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0205fca:	451c                	lw	a5,8(a0)
ffffffffc0205fcc:	2785                	addiw	a5,a5,1
ffffffffc0205fce:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0205fd0:	00a88463          	beq	a7,a0,ffffffffc0205fd8 <schedule+0x60>
            proc_run(next);
ffffffffc0205fd4:	e8dfe0ef          	jal	ra,ffffffffc0204e60 <proc_run>
    if (flag) {
ffffffffc0205fd8:	e819                	bnez	s0,ffffffffc0205fee <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc0205fe0:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0205fe2:	4198                	lw	a4,0(a1)
ffffffffc0205fe4:	4789                	li	a5,2
ffffffffc0205fe6:	fef712e3          	bne	a4,a5,ffffffffc0205fca <schedule+0x52>
ffffffffc0205fea:	852e                	mv	a0,a1
ffffffffc0205fec:	bff9                	j	ffffffffc0205fca <schedule+0x52>
}
ffffffffc0205fee:	6402                	ld	s0,0(sp)
ffffffffc0205ff0:	60a2                	ld	ra,8(sp)
ffffffffc0205ff2:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0205ff4:	e4cfa06f          	j	ffffffffc0200640 <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0205ff8:	000ac617          	auipc	a2,0xac
ffffffffc0205ffc:	7d060613          	addi	a2,a2,2000 # ffffffffc02b27c8 <proc_list>
ffffffffc0206000:	86b2                	mv	a3,a2
ffffffffc0206002:	b76d                	j	ffffffffc0205fac <schedule+0x34>
        intr_disable();
ffffffffc0206004:	e42fa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0206008:	4405                	li	s0,1
ffffffffc020600a:	bfbd                	j	ffffffffc0205f88 <schedule+0x10>

ffffffffc020600c <sys_getpid>:
    return do_kill(pid);
}
...
ffffffffc0206010:	8447b783          	ld	a5,-1980(a5) # ffffffffc02b2850 <current>
}
ffffffffc0206014:	43c8                	lw	a0,4(a5)
ffffffffc0206016:	8082                	ret

ffffffffc0206018 <sys_pgdir>:
...
ffffffffc0206018:	4501                	li	a0,0
ffffffffc020601a:	8082                	ret

ffffffffc020601c <sys_putc>:
    cputchar(c);
ffffffffc020601c:	4108                	lw	a0,0(a0)
sys_putc(uint64_t arg[]) {
ffffffffc020601e:	1141                	addi	sp,sp,-16
ffffffffc0206020:	e406                	sd	ra,8(sp)
    cputchar(c);
ffffffffc0206022:	994fa0ef          	jal	ra,ffffffffc02001b6 <cputchar>
}
ffffffffc0206026:	60a2                	ld	ra,8(sp)
ffffffffc0206028:	4501                	li	a0,0
ffffffffc020602a:	0141                	addi	sp,sp,16
ffffffffc020602c:	8082                	ret

ffffffffc020602e <sys_kill>:
    return do_kill(pid);
ffffffffc020602e:	4108                	lw	a0,0(a0)
ffffffffc0206030:	c31ff06f          	j	ffffffffc0205c60 <do_kill>

ffffffffc0206034 <sys_yield>:
    return do_yield();
ffffffffc0206034:	bdfff06f          	j	ffffffffc0205c12 <do_yield>

ffffffffc0206038 <sys_exec>:
    return do_execve(name, len, binary, size);
ffffffffc0206038:	6d14                	ld	a3,24(a0)
ffffffffc020603a:	6910                	ld	a2,16(a0)
ffffffffc020603c:	650c                	ld	a1,8(a0)
ffffffffc020603e:	6108                	ld	a0,0(a0)
ffffffffc0206040:	ebeff06f          	j	ffffffffc02056fe <do_execve>

ffffffffc0206044 <sys_wait>:
    return do_wait(pid, store);
ffffffffc0206044:	650c                	ld	a1,8(a0)
ffffffffc0206046:	4108                	lw	a0,0(a0)
ffffffffc0206048:	bdbff06f          	j	ffffffffc0205c22 <do_wait>

ffffffffc020604c <sys_fork>:
    struct trapframe *tf = current->tf;
ffffffffc020604c:	000ad797          	auipc	a5,0xad
ffffffffc0206050:	8047b783          	ld	a5,-2044(a5) # ffffffffc02b2850 <current>
ffffffffc0206054:	73d0                	ld	a2,160(a5)
    return do_fork(0, stack, tf);
ffffffffc0206056:	4501                	li	a0,0
ffffffffc0206058:	6a0c                	ld	a1,16(a2)
ffffffffc020605a:	e73fe06f          	j	ffffffffc0204ecc <do_fork>

ffffffffc020605e <sys_exit>:
    return do_exit(error_code);
ffffffffc020605e:	4108                	lw	a0,0(a0)
ffffffffc0206060:	a5eff06f          	j	ffffffffc02052be <do_exit>

ffffffffc0206064 <syscall>:
};
...
void
syscall(void) {
ffffffffc0206064:	715d                	addi	sp,sp,-80
ffffffffc0206066:	fc26                	sd	s1,56(sp)
    struct trapframe *tf = current->tf;
ffffffffc0206068:	000ac497          	auipc	s1,0xac
ffffffffc020606c:	7e848493          	addi	s1,s1,2024 # ffffffffc02b2850 <current>
ffffffffc0206070:	6098                	ld	a4,0(s1)
syscall(void) {
ffffffffc0206072:	e0a2                	sd	s0,64(sp)
ffffffffc0206074:	f84a                	sd	s2,48(sp)
    struct trapframe *tf = current->tf;
ffffffffc0206076:	7340                	ld	s0,160(a4)
syscall(void) {
ffffffffc0206078:	e486                	sd	ra,72(sp)
    uint64_t arg[5];
    int num = tf->gpr.a0;
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc020607a:	47fd                	li	a5,31
    int num = tf->gpr.a0;
ffffffffc020607c:	05042903          	lw	s2,80(s0)
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc0206080:	0327ee63          	bltu	a5,s2,ffffffffc02060bc <syscall+0x58>
        if (syscalls[num] != NULL) {
ffffffffc0206084:	00391713          	slli	a4,s2,0x3
ffffffffc0206088:	00002797          	auipc	a5,0x2
ffffffffc020608c:	7d878793          	addi	a5,a5,2008 # ffffffffc0208860 <syscalls>
ffffffffc0206090:	97ba                	add	a5,a5,a4
ffffffffc0206092:	639c                	ld	a5,0(a5)
ffffffffc0206094:	c785                	beqz	a5,ffffffffc02060bc <syscall+0x58>
            arg[0] = tf->gpr.a1;
ffffffffc0206096:	6c28                	ld	a0,88(s0)
            arg[1] = tf->gpr.a2;
ffffffffc0206098:	702c                	ld	a1,96(s0)
            arg[2] = tf->gpr.a3;
ffffffffc020609a:	7430                	ld	a2,104(s0)
            arg[3] = tf->gpr.a4;
ffffffffc020609c:	7834                	ld	a3,112(s0)
            arg[4] = tf->gpr.a5;
ffffffffc020609e:	7c38                	ld	a4,120(s0)
            arg[0] = tf->gpr.a1;
ffffffffc02060a0:	e42a                	sd	a0,8(sp)
            arg[1] = tf->gpr.a2;
ffffffffc02060a2:	e82e                	sd	a1,16(sp)
            arg[2] = tf->gpr.a3;
ffffffffc02060a4:	ec32                	sd	a2,24(sp)
            arg[3] = tf->gpr.a4;
ffffffffc02060a6:	f036                	sd	a3,32(sp)
            arg[4] = tf->gpr.a5;
ffffffffc02060a8:	f43a                	sd	a4,40(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02060aa:	0028                	addi	a0,sp,8
ffffffffc02060ac:	9782                	jalr	a5
        }
    }
    print_trapframe(tf);
...
ffffffffc02060ae:	60a6                	ld	ra,72(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02060b0:	e828                	sd	a0,80(s0)
}
ffffffffc02060b2:	6406                	ld	s0,64(sp)
ffffffffc02060b4:	74e2                	ld	s1,56(sp)
ffffffffc02060b6:	7942                	ld	s2,48(sp)
ffffffffc02060b8:	6161                	addi	sp,sp,80
ffffffffc02060ba:	8082                	ret
    print_trapframe(tf);
ffffffffc02060bc:	8522                	mv	a0,s0
ffffffffc02060be:	f76fa0ef          	jal	ra,ffffffffc0200834 <print_trapframe>
    panic("undefined syscall %d, pid = %d, name = %s.\n",
ffffffffc02060c2:	609c                	ld	a5,0(s1)
ffffffffc02060c4:	86ca                	mv	a3,s2
ffffffffc02060c6:	00002617          	auipc	a2,0x2
ffffffffc02060ca:	75260613          	addi	a2,a2,1874 # ffffffffc0208818 <default_pmm_manager+0x1538>
ffffffffc02060ce:	43d8                	lw	a4,4(a5)
ffffffffc02060d0:	06200593          	li	a1,98
ffffffffc02060d4:	0b478793          	addi	a5,a5,180
ffffffffc02060d8:	00002517          	auipc	a0,0x2
ffffffffc02060dc:	77050513          	addi	a0,a0,1904 # ffffffffc0208848 <default_pmm_manager+0x1568>
ffffffffc02060e0:	b9afa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc02060e4 <hash32>:
 *
...
ffffffffc02060e4:	9e3707b7          	lui	a5,0x9e370
ffffffffc02060e8:	2785                	addiw	a5,a5,1
ffffffffc02060ea:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc02060ee:	02000793          	li	a5,32
ffffffffc02060f2:	9f8d                	subw	a5,a5,a1
}
ffffffffc02060f4:	00f5553b          	srlw	a0,a0,a5
ffffffffc02060f8:	8082                	ret

ffffffffc02060fa <printnum>:
 * */
static void
...
ffffffffc02060fa:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02060fe:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0206100:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0206104:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0206106:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc020610a:	f022                	sd	s0,32(sp)
ffffffffc020610c:	ec26                	sd	s1,24(sp)
ffffffffc020610e:	e84a                	sd	s2,16(sp)
ffffffffc0206110:	f406                	sd	ra,40(sp)
ffffffffc0206112:	e44e                	sd	s3,8(sp)
ffffffffc0206114:	84aa                	mv	s1,a0
ffffffffc0206116:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0206118:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc020611c:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc020611e:	03067e63          	bgeu	a2,a6,ffffffffc020615a <printnum+0x60>
ffffffffc0206122:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0206124:	00805763          	blez	s0,ffffffffc0206132 <printnum+0x38>
ffffffffc0206128:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc020612a:	85ca                	mv	a1,s2
ffffffffc020612c:	854e                	mv	a0,s3
ffffffffc020612e:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0206130:	fc65                	bnez	s0,ffffffffc0206128 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0206132:	1a02                	slli	s4,s4,0x20
ffffffffc0206134:	00003797          	auipc	a5,0x3
ffffffffc0206138:	82c78793          	addi	a5,a5,-2004 # ffffffffc0208960 <syscalls+0x100>
ffffffffc020613c:	020a5a13          	srli	s4,s4,0x20
ffffffffc0206140:	9a3e                	add	s4,s4,a5
...
ffffffffc0206142:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0206144:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0206148:	70a2                	ld	ra,40(sp)
ffffffffc020614a:	69a2                	ld	s3,8(sp)
ffffffffc020614c:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020614e:	85ca                	mv	a1,s2
ffffffffc0206150:	87a6                	mv	a5,s1
}
ffffffffc0206152:	6942                	ld	s2,16(sp)
ffffffffc0206154:	64e2                	ld	s1,24(sp)
ffffffffc0206156:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0206158:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc020615a:	03065633          	divu	a2,a2,a6
ffffffffc020615e:	8722                	mv	a4,s0
ffffffffc0206160:	f9bff0ef          	jal	ra,ffffffffc02060fa <printnum>
ffffffffc0206164:	b7f9                	j	ffffffffc0206132 <printnum+0x38>

ffffffffc0206166 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0206166:	7119                	addi	sp,sp,-128
ffffffffc0206168:	f4a6                	sd	s1,104(sp)
ffffffffc020616a:	f0ca                	sd	s2,96(sp)
ffffffffc020616c:	ecce                	sd	s3,88(sp)
ffffffffc020616e:	e8d2                	sd	s4,80(sp)
ffffffffc0206170:	e4d6                	sd	s5,72(sp)
ffffffffc0206172:	e0da                	sd	s6,64(sp)
ffffffffc0206174:	fc5e                	sd	s7,56(sp)
ffffffffc0206176:	f06a                	sd	s10,32(sp)
ffffffffc0206178:	fc86                	sd	ra,120(sp)
ffffffffc020617a:	f8a2                	sd	s0,112(sp)
ffffffffc020617c:	f862                	sd	s8,48(sp)
ffffffffc020617e:	f466                	sd	s9,40(sp)
ffffffffc0206180:	ec6e                	sd	s11,24(sp)
ffffffffc0206182:	892a                	mv	s2,a0
ffffffffc0206184:	84ae                	mv	s1,a1
ffffffffc0206186:	8d32                	mv	s10,a2
ffffffffc0206188:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc020618a:	02500993          	li	s3,37
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc020618e:	5b7d                	li	s6,-1
ffffffffc0206190:	00002a97          	auipc	s5,0x2
ffffffffc0206194:	7fca8a93          	addi	s5,s5,2044 # ffffffffc020898c <syscalls+0x12c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0206198:	00003b97          	auipc	s7,0x3
ffffffffc020619c:	a10b8b93          	addi	s7,s7,-1520 # ffffffffc0208ba8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02061a0:	000d4503          	lbu	a0,0(s10)
ffffffffc02061a4:	001d0413          	addi	s0,s10,1
ffffffffc02061a8:	01350a63          	beq	a0,s3,ffffffffc02061bc <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc02061ac:	c121                	beqz	a0,ffffffffc02061ec <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc02061ae:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02061b0:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc02061b2:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02061b4:	fff44503          	lbu	a0,-1(s0)
ffffffffc02061b8:	ff351ae3          	bne	a0,s3,ffffffffc02061ac <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02061bc:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc02061c0:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc02061c4:	4c81                	li	s9,0
ffffffffc02061c6:	4881                	li	a7,0
        width = precision = -1;
ffffffffc02061c8:	5c7d                	li	s8,-1
ffffffffc02061ca:	5dfd                	li	s11,-1
ffffffffc02061cc:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc02061d0:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02061d2:	fdd6059b          	addiw	a1,a2,-35
ffffffffc02061d6:	0ff5f593          	zext.b	a1,a1
ffffffffc02061da:	00140d13          	addi	s10,s0,1
ffffffffc02061de:	04b56263          	bltu	a0,a1,ffffffffc0206222 <vprintfmt+0xbc>
ffffffffc02061e2:	058a                	slli	a1,a1,0x2
ffffffffc02061e4:	95d6                	add	a1,a1,s5
ffffffffc02061e6:	4194                	lw	a3,0(a1)
ffffffffc02061e8:	96d6                	add	a3,a3,s5
ffffffffc02061ea:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc02061ec:	70e6                	ld	ra,120(sp)
ffffffffc02061ee:	7446                	ld	s0,112(sp)
ffffffffc02061f0:	74a6                	ld	s1,104(sp)
ffffffffc02061f2:	7906                	ld	s2,96(sp)
ffffffffc02061f4:	69e6                	ld	s3,88(sp)
ffffffffc02061f6:	6a46                	ld	s4,80(sp)
ffffffffc02061f8:	6aa6                	ld	s5,72(sp)
ffffffffc02061fa:	6b06                	ld	s6,64(sp)
ffffffffc02061fc:	7be2                	ld	s7,56(sp)
ffffffffc02061fe:	7c42                	ld	s8,48(sp)
ffffffffc0206200:	7ca2                	ld	s9,40(sp)
ffffffffc0206202:	7d02                	ld	s10,32(sp)
ffffffffc0206204:	6de2                	ld	s11,24(sp)
ffffffffc0206206:	6109                	addi	sp,sp,128
ffffffffc0206208:	8082                	ret
            padc = '0';
ffffffffc020620a:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc020620c:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206210:	846a                	mv	s0,s10
ffffffffc0206212:	00140d13          	addi	s10,s0,1
ffffffffc0206216:	fdd6059b          	addiw	a1,a2,-35
ffffffffc020621a:	0ff5f593          	zext.b	a1,a1
ffffffffc020621e:	fcb572e3          	bgeu	a0,a1,ffffffffc02061e2 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0206222:	85a6                	mv	a1,s1
ffffffffc0206224:	02500513          	li	a0,37
ffffffffc0206228:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc020622a:	fff44783          	lbu	a5,-1(s0)
ffffffffc020622e:	8d22                	mv	s10,s0
ffffffffc0206230:	f73788e3          	beq	a5,s3,ffffffffc02061a0 <vprintfmt+0x3a>
ffffffffc0206234:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0206238:	1d7d                	addi	s10,s10,-1
ffffffffc020623a:	ff379de3          	bne	a5,s3,ffffffffc0206234 <vprintfmt+0xce>
ffffffffc020623e:	b78d                	j	ffffffffc02061a0 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0206240:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0206244:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206248:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc020624a:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc020624e:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0206252:	02d86463          	bltu	a6,a3,ffffffffc020627a <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0206256:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc020625a:	002c169b          	slliw	a3,s8,0x2
ffffffffc020625e:	0186873b          	addw	a4,a3,s8
ffffffffc0206262:	0017171b          	slliw	a4,a4,0x1
ffffffffc0206266:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0206268:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc020626c:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc020626e:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0206272:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0206276:	fed870e3          	bgeu	a6,a3,ffffffffc0206256 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc020627a:	f40ddce3          	bgez	s11,ffffffffc02061d2 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc020627e:	8de2                	mv	s11,s8
ffffffffc0206280:	5c7d                	li	s8,-1
ffffffffc0206282:	bf81                	j	ffffffffc02061d2 <vprintfmt+0x6c>
            if (width < 0)
...
ffffffffc0206294:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0206296:	bf35                	j	ffffffffc02061d2 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0206298:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc02062a4:	bfd9                	j	ffffffffc020627a <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc02062a6:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02062a8:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02062ac:	01174463          	blt	a4,a7,ffffffffc02062b4 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc02062b0:	1a088e63          	beqz	a7,ffffffffc020646c <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc02062b4:	000a3603          	ld	a2,0(s4)
ffffffffc02062b8:	46c1                	li	a3,16
ffffffffc02062ba:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc02062bc:	2781                	sext.w	a5,a5
ffffffffc02062be:	876e                	mv	a4,s11
ffffffffc02062c0:	85a6                	mv	a1,s1
ffffffffc02062c2:	854a                	mv	a0,s2
ffffffffc02062c4:	e37ff0ef          	jal	ra,ffffffffc02060fa <printnum>
            break;
ffffffffc02062c8:	bde1                	j	ffffffffc02061a0 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc02062ca:	000a2503          	lw	a0,0(s4)
ffffffffc02062ce:	85a6                	mv	a1,s1
ffffffffc02062d0:	0a21                	addi	s4,s4,8
ffffffffc02062d2:	9902                	jalr	s2
            break;
ffffffffc02062d4:	b5f1                	j	ffffffffc02061a0 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02062d6:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02062d8:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02062dc:	01174463          	blt	a4,a7,ffffffffc02062e4 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc02062e0:	18088163          	beqz	a7,ffffffffc0206462 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc02062e4:	000a3603          	ld	a2,0(s4)
ffffffffc02062e8:	46a9                	li	a3,10
ffffffffc02062ea:	8a2e                	mv	s4,a1
ffffffffc02062ec:	bfc1                	j	ffffffffc02062bc <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062ee:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc02062f2:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062f4:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02062f6:	bdf1                	j	ffffffffc02061d2 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc02062f8:	85a6                	mv	a1,s1
ffffffffc02062fa:	02500513          	li	a0,37
ffffffffc02062fe:	9902                	jalr	s2
            break;
ffffffffc0206300:	b545                	j	ffffffffc02061a0 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206302:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0206306:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206308:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020630a:	b5e1                	j	ffffffffc02061d2 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc020630c:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020630e:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0206312:	01174463          	blt	a4,a7,ffffffffc020631a <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0206316:	14088163          	beqz	a7,ffffffffc0206458 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc020631a:	000a3603          	ld	a2,0(s4)
ffffffffc020631e:	46a1                	li	a3,8
ffffffffc0206320:	8a2e                	mv	s4,a1
ffffffffc0206322:	bf69                	j	ffffffffc02062bc <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0206324:	03000513          	li	a0,48
ffffffffc0206328:	85a6                	mv	a1,s1
ffffffffc020632a:	e03e                	sd	a5,0(sp)
ffffffffc020632c:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc020632e:	85a6                	mv	a1,s1
ffffffffc0206330:	07800513          	li	a0,120
ffffffffc0206334:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0206336:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0206338:	6782                	ld	a5,0(sp)
ffffffffc020633a:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc020633c:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0206340:	bfb5                	j	ffffffffc02062bc <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0206342:	000a3403          	ld	s0,0(s4)
ffffffffc0206346:	008a0713          	addi	a4,s4,8
ffffffffc020634a:	e03a                	sd	a4,0(sp)
ffffffffc020634c:	14040263          	beqz	s0,ffffffffc0206490 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0206350:	0fb05763          	blez	s11,ffffffffc020643e <vprintfmt+0x2d8>
ffffffffc0206354:	02d00693          	li	a3,45
ffffffffc0206358:	0cd79163          	bne	a5,a3,ffffffffc020641a <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020635c:	00044783          	lbu	a5,0(s0)
ffffffffc0206360:	0007851b          	sext.w	a0,a5
ffffffffc0206364:	cf85                	beqz	a5,ffffffffc020639c <vprintfmt+0x236>
ffffffffc0206366:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020636a:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020636e:	000c4563          	bltz	s8,ffffffffc0206378 <vprintfmt+0x212>
ffffffffc0206372:	3c7d                	addiw	s8,s8,-1
ffffffffc0206374:	036c0263          	beq	s8,s6,ffffffffc0206398 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0206378:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020637a:	0e0c8e63          	beqz	s9,ffffffffc0206476 <vprintfmt+0x310>
ffffffffc020637e:	3781                	addiw	a5,a5,-32
ffffffffc0206380:	0ef47b63          	bgeu	s0,a5,ffffffffc0206476 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0206384:	03f00513          	li	a0,63
ffffffffc0206388:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020638a:	000a4783          	lbu	a5,0(s4)
ffffffffc020638e:	3dfd                	addiw	s11,s11,-1
ffffffffc0206390:	0a05                	addi	s4,s4,1
ffffffffc0206392:	0007851b          	sext.w	a0,a5
ffffffffc0206396:	ffe1                	bnez	a5,ffffffffc020636e <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0206398:	01b05963          	blez	s11,ffffffffc02063aa <vprintfmt+0x244>
...
ffffffffc02063a4:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02063a6:	fe0d9be3          	bnez	s11,ffffffffc020639c <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02063aa:	6a02                	ld	s4,0(sp)
ffffffffc02063ac:	bbd5                	j	ffffffffc02061a0 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02063ae:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02063b0:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc02063b4:	01174463          	blt	a4,a7,ffffffffc02063bc <vprintfmt+0x256>
    else if (lflag) {
ffffffffc02063b8:	08088d63          	beqz	a7,ffffffffc0206452 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc02063bc:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc02063c0:	0a044d63          	bltz	s0,ffffffffc020647a <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc02063c4:	8622                	mv	a2,s0
ffffffffc02063c6:	8a66                	mv	s4,s9
ffffffffc02063c8:	46a9                	li	a3,10
ffffffffc02063ca:	bdcd                	j	ffffffffc02062bc <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc02063cc:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02063d0:	4761                	li	a4,24
            err = va_arg(ap, int);
ffffffffc02063d2:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc02063d4:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc02063d8:	8fb5                	xor	a5,a5,a3
ffffffffc02063da:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02063de:	02d74163          	blt	a4,a3,ffffffffc0206400 <vprintfmt+0x29a>
ffffffffc02063e2:	00369793          	slli	a5,a3,0x3
ffffffffc02063e6:	97de                	add	a5,a5,s7
ffffffffc02063e8:	639c                	ld	a5,0(a5)
ffffffffc02063ea:	cb99                	beqz	a5,ffffffffc0206400 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc02063ec:	86be                	mv	a3,a5
ffffffffc02063ee:	00000617          	auipc	a2,0x0
ffffffffc02063f2:	1ca60613          	addi	a2,a2,458 # ffffffffc02065b8 <etext+0x2a>
ffffffffc02063f6:	85a6                	mv	a1,s1
ffffffffc02063f8:	854a                	mv	a0,s2
ffffffffc02063fa:	0ce000ef          	jal	ra,ffffffffc02064c8 <printfmt>
ffffffffc02063fe:	b34d                	j	ffffffffc02061a0 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0206400:	00002617          	auipc	a2,0x2
ffffffffc0206404:	58060613          	addi	a2,a2,1408 # ffffffffc0208980 <syscalls+0x120>
ffffffffc0206408:	85a6                	mv	a1,s1
ffffffffc020640a:	854a                	mv	a0,s2
ffffffffc020640c:	0bc000ef          	jal	ra,ffffffffc02064c8 <printfmt>
ffffffffc0206410:	bb41                	j	ffffffffc02061a0 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0206412:	00002417          	auipc	s0,0x2
ffffffffc0206416:	56640413          	addi	s0,s0,1382 # ffffffffc0208978 <syscalls+0x118>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020641a:	85e2                	mv	a1,s8
ffffffffc020641c:	8522                	mv	a0,s0
ffffffffc020641e:	e43e                	sd	a5,8(sp)
ffffffffc0206420:	0e2000ef          	jal	ra,ffffffffc0206502 <strnlen>
ffffffffc0206424:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0206428:	01b05b63          	blez	s11,ffffffffc020643e <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc020642c:	67a2                	ld	a5,8(sp)
ffffffffc020642e:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206432:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0206434:	85a6                	mv	a1,s1
ffffffffc0206436:	8552                	mv	a0,s4
ffffffffc0206438:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020643a:	fe0d9ce3          	bnez	s11,ffffffffc0206432 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020643e:	00044783          	lbu	a5,0(s0)
ffffffffc0206442:	00140a13          	addi	s4,s0,1
ffffffffc0206446:	0007851b          	sext.w	a0,a5
ffffffffc020644a:	d3a5                	beqz	a5,ffffffffc02063aa <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020644c:	05e00413          	li	s0,94
ffffffffc0206450:	bf39                	j	ffffffffc020636e <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0206452:	000a2403          	lw	s0,0(s4)
ffffffffc0206456:	b7ad                	j	ffffffffc02063c0 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0206458:	000a6603          	lwu	a2,0(s4)
ffffffffc020645c:	46a1                	li	a3,8
ffffffffc020645e:	8a2e                	mv	s4,a1
ffffffffc0206460:	bdb1                	j	ffffffffc02062bc <vprintfmt+0x156>
ffffffffc0206462:	000a6603          	lwu	a2,0(s4)
ffffffffc0206466:	46a9                	li	a3,10
ffffffffc0206468:	8a2e                	mv	s4,a1
ffffffffc020646a:	bd89                	j	ffffffffc02062bc <vprintfmt+0x156>
ffffffffc020646c:	000a6603          	lwu	a2,0(s4)
ffffffffc0206470:	46c1                	li	a3,16
ffffffffc0206472:	8a2e                	mv	s4,a1
ffffffffc0206474:	b5a1                	j	ffffffffc02062bc <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0206476:	9902                	jalr	s2
ffffffffc0206478:	bf09                	j	ffffffffc020638a <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc020647a:	85a6                	mv	a1,s1
ffffffffc020647c:	02d00513          	li	a0,45
ffffffffc0206480:	e03e                	sd	a5,0(sp)
ffffffffc0206482:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0206484:	6782                	ld	a5,0(sp)
ffffffffc0206486:	8a66                	mv	s4,s9
ffffffffc0206488:	40800633          	neg	a2,s0
ffffffffc020648c:	46a9                	li	a3,10
ffffffffc020648e:	b53d                	j	ffffffffc02062bc <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0206490:	03b05163          	blez	s11,ffffffffc02064b2 <vprintfmt+0x34c>
ffffffffc0206494:	02d00693          	li	a3,45
ffffffffc0206498:	f6d79de3          	bne	a5,a3,ffffffffc0206412 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc020649c:	00002417          	auipc	s0,0x2
ffffffffc02064a0:	4dc40413          	addi	s0,s0,1244 # ffffffffc0208978 <syscalls+0x118>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02064a4:	02800793          	li	a5,40
ffffffffc02064a8:	02800513          	li	a0,40
ffffffffc02064ac:	00140a13          	addi	s4,s0,1
ffffffffc02064b0:	bd6d                	j	ffffffffc020636a <vprintfmt+0x204>
ffffffffc02064b2:	00002a17          	auipc	s4,0x2
ffffffffc02064b6:	4c7a0a13          	addi	s4,s4,1223 # ffffffffc0208979 <syscalls+0x119>
ffffffffc02064ba:	02800513          	li	a0,40
ffffffffc02064be:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02064c2:	05e00413          	li	s0,94
ffffffffc02064c6:	b565                	j	ffffffffc020636e <vprintfmt+0x208>

ffffffffc02064c8 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02064c8:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc02064ca:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02064ce:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02064d0:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02064d2:	ec06                	sd	ra,24(sp)
ffffffffc02064d4:	f83a                	sd	a4,48(sp)
ffffffffc02064d6:	fc3e                	sd	a5,56(sp)
ffffffffc02064d8:	e0c2                	sd	a6,64(sp)
ffffffffc02064da:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc02064dc:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02064de:	c89ff0ef          	jal	ra,ffffffffc0206166 <vprintfmt>
}
ffffffffc02064e2:	60e2                	ld	ra,24(sp)
ffffffffc02064e4:	6161                	addi	sp,sp,80
ffffffffc02064e6:	8082                	ret

ffffffffc02064e8 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc02064e8:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc02064ec:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc02064ee:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc02064f0:	cb81                	beqz	a5,ffffffffc0206500 <strlen+0x18>
        cnt ++;
ffffffffc02064f2:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc02064f4:	00a707b3          	add	a5,a4,a0
ffffffffc02064f8:	0007c783          	lbu	a5,0(a5)
ffffffffc02064fc:	fbfd                	bnez	a5,ffffffffc02064f2 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0206502:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0206504:	e589                	bnez	a1,ffffffffc020650e <strnlen+0xc>
ffffffffc0206506:	a811                	j	ffffffffc020651a <strnlen+0x18>
        cnt ++;
ffffffffc0206508:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc020650a:	00f58863          	beq	a1,a5,ffffffffc020651a <strnlen+0x18>
ffffffffc020650e:	00f50733          	add	a4,a0,a5
ffffffffc0206512:	00074703          	lbu	a4,0(a4)
ffffffffc0206516:	fb6d                	bnez	a4,ffffffffc0206508 <strnlen+0x6>
ffffffffc0206518:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc020651a:	852e                	mv	a0,a1
ffffffffc020651c:	8082                	ret

ffffffffc020651e <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc020651e:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0206520:	0005c703          	lbu	a4,0(a1)
ffffffffc0206524:	0785                	addi	a5,a5,1
ffffffffc0206526:	0585                	addi	a1,a1,1
ffffffffc0206528:	fee78fa3          	sb	a4,-1(a5)
ffffffffc020652c:	fb75                	bnez	a4,ffffffffc0206520 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0206534:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0206538:	cb89                	beqz	a5,ffffffffc020654a <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc020653a:	0505                	addi	a0,a0,1
ffffffffc020653c:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020653e:	fee789e3          	beq	a5,a4,ffffffffc0206530 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
...
ffffffffc020654c:	bfed                	j	ffffffffc0206546 <strcmp+0x16>

ffffffffc020654e <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc020654e:	00054783          	lbu	a5,0(a0)
ffffffffc0206552:	c799                	beqz	a5,ffffffffc0206560 <strchr+0x12>
        if (*s == c) {
ffffffffc0206554:	00f58763          	beq	a1,a5,ffffffffc0206562 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0206558:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc020655c:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc020655e:	fbfd                	bnez	a5,ffffffffc0206554 <strchr+0x6>
    }
    return NULL;
ffffffffc0206560:	4501                	li	a0,0
}
ffffffffc0206562:	8082                	ret

ffffffffc0206564 <memset>:
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0206564:	ca01                	beqz	a2,ffffffffc0206574 <memset+0x10>
ffffffffc0206566:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0206568:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc020656a:	0785                	addi	a5,a5,1
ffffffffc020656c:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0206570:	fec79de3          	bne	a5,a2,ffffffffc020656a <memset+0x6>
    }
    return s;
...
ffffffffc0206576 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0206576:	ca19                	beqz	a2,ffffffffc020658c <memcpy+0x16>
ffffffffc0206578:	962e                	add	a2,a2,a1
    char *d = dst;
...
ffffffffc0206584:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0206588:	fec59ae3          	bne	a1,a2,ffffffffc020657c <memcpy+0x6>
    }
    return dst;
