...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	60b040ef          	jal	ra,ffffffffc0204e54 <memset>
...
ffffffffc0200056:	e5658593          	addi	a1,a1,-426 # ffffffffc0204ea8 <etext+0x6>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	e6e50513          	addi	a0,a0,-402 # ffffffffc0204ec8 <etext+0x26>
...
ffffffffc020007a:	5c0040ef          	jal	ra,ffffffffc020463a <proc_init>
...
ffffffffc020008e:	7fa040ef          	jal	ra,ffffffffc0204888 <cpu_idle>
...
ffffffffc02000ac:	e2850513          	addi	a0,a0,-472 # ffffffffc0204ed0 <etext+0x2e>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	0e3040ef          	jal	ra,ffffffffc0204a56 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	0ad040ef          	jal	ra,ffffffffc0204a56 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	d0e50513          	addi	a0,a0,-754 # ffffffffc0204ed8 <etext+0x36>
void print_kerninfo(void) {
...
ffffffffc02001e4:	d1850513          	addi	a0,a0,-744 # ffffffffc0204ef8 <etext+0x56>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	cb658593          	addi	a1,a1,-842 # ffffffffc0204ea2 <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	d2450513          	addi	a0,a0,-732 # ffffffffc0204f18 <etext+0x76>
...
ffffffffc020020c:	d3050513          	addi	a0,a0,-720 # ffffffffc0204f38 <etext+0x96>
...
ffffffffc0200220:	d3c50513          	addi	a0,a0,-708 # ffffffffc0204f58 <etext+0xb6>
...
ffffffffc020024e:	d2e50513          	addi	a0,a0,-722 # ffffffffc0204f78 <etext+0xd6>
}
...
ffffffffc020025c:	d5060613          	addi	a2,a2,-688 # ffffffffc0204fa8 <etext+0x106>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	d5c50513          	addi	a0,a0,-676 # ffffffffc0204fc0 <etext+0x11e>
void print_stackframe(void) {
...
ffffffffc0200278:	d6460613          	addi	a2,a2,-668 # ffffffffc0204fd8 <etext+0x136>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	d7c58593          	addi	a1,a1,-644 # ffffffffc0204ff8 <etext+0x156>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	d7c50513          	addi	a0,a0,-644 # ffffffffc0205000 <etext+0x15e>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	d7e60613          	addi	a2,a2,-642 # ffffffffc0205010 <etext+0x16e>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	d9e58593          	addi	a1,a1,-610 # ffffffffc0205038 <etext+0x196>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	d5e50513          	addi	a0,a0,-674 # ffffffffc0205000 <etext+0x15e>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	d9a60613          	addi	a2,a2,-614 # ffffffffc0205048 <etext+0x1a6>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	db258593          	addi	a1,a1,-590 # ffffffffc0205068 <etext+0x1c6>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	d4250513          	addi	a0,a0,-702 # ffffffffc0205000 <etext+0x15e>
...
ffffffffc02002fc:	d8050513          	addi	a0,a0,-640 # ffffffffc0205078 <etext+0x1d6>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	d8650513          	addi	a0,a0,-634 # ffffffffc02050a0 <etext+0x1fe>
...
ffffffffc0200340:	dd4c0c13          	addi	s8,s8,-556 # ffffffffc0205110 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200344:	00005917          	auipc	s2,0x5
ffffffffc0200348:	d8490913          	addi	s2,s2,-636 # ffffffffc02050c8 <etext+0x226>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	d8448493          	addi	s1,s1,-636 # ffffffffc02050d0 <etext+0x22e>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	d82b0b13          	addi	s6,s6,-638 # ffffffffc02050d8 <etext+0x236>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	c9aa0a13          	addi	s4,s4,-870 # ffffffffc0204ff8 <etext+0x156>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc0200384:	d90d0d13          	addi	s10,s10,-624 # ffffffffc0205110 <commands>
        argv[argc ++] = buf;
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	293040ef          	jal	ra,ffffffffc0204e20 <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	27f040ef          	jal	ra,ffffffffc0204e20 <strcmp>
...
ffffffffc02003e0:	25f040ef          	jal	ra,ffffffffc0204e3e <strchr>
...
ffffffffc020041e:	221040ef          	jal	ra,ffffffffc0204e3e <strchr>
...
ffffffffc020043c:	cc050513          	addi	a0,a0,-832 # ffffffffc02050f8 <etext+0x256>
...
ffffffffc0200478:	ce450513          	addi	a0,a0,-796 # ffffffffc0205158 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc020048e:	c3e50513          	addi	a0,a0,-962 # ffffffffc02060c8 <default_pmm_manager+0x4d0>
...
ffffffffc02004cc:	cb050513          	addi	a0,a0,-848 # ffffffffc0205178 <commands+0x68>
    ticks = 0;
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	0db040ef          	jal	ra,ffffffffc0204e66 <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	0b7040ef          	jal	ra,ffffffffc0204e66 <memcpy>
    return 0;
}
...
ffffffffc02005fe:	b9e50513          	addi	a0,a0,-1122 # ffffffffc0205198 <commands+0x88>
...
ffffffffc0200626:	b9660613          	addi	a2,a2,-1130 # ffffffffc02051b8 <commands+0xa8>
ffffffffc020062a:	06200593          	li	a1,98
ffffffffc020062e:	00005517          	auipc	a0,0x5
ffffffffc0200632:	ba250513          	addi	a0,a0,-1118 # ffffffffc02051d0 <commands+0xc0>
...
ffffffffc0200660:	b8c50513          	addi	a0,a0,-1140 # ffffffffc02051e8 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200670:	b9450513          	addi	a0,a0,-1132 # ffffffffc0205200 <commands+0xf0>
...
ffffffffc020067e:	b9e50513          	addi	a0,a0,-1122 # ffffffffc0205218 <commands+0x108>
...
ffffffffc020068c:	ba850513          	addi	a0,a0,-1112 # ffffffffc0205230 <commands+0x120>
...
ffffffffc020069a:	bb250513          	addi	a0,a0,-1102 # ffffffffc0205248 <commands+0x138>
...
ffffffffc02006a8:	bbc50513          	addi	a0,a0,-1092 # ffffffffc0205260 <commands+0x150>
...
ffffffffc02006b6:	bc650513          	addi	a0,a0,-1082 # ffffffffc0205278 <commands+0x168>
...
ffffffffc02006c4:	bd050513          	addi	a0,a0,-1072 # ffffffffc0205290 <commands+0x180>
...
ffffffffc02006d2:	bda50513          	addi	a0,a0,-1062 # ffffffffc02052a8 <commands+0x198>
...
ffffffffc02006e0:	be450513          	addi	a0,a0,-1052 # ffffffffc02052c0 <commands+0x1b0>
...
ffffffffc02006ee:	bee50513          	addi	a0,a0,-1042 # ffffffffc02052d8 <commands+0x1c8>
...
ffffffffc02006fc:	bf850513          	addi	a0,a0,-1032 # ffffffffc02052f0 <commands+0x1e0>
...
ffffffffc020070a:	c0250513          	addi	a0,a0,-1022 # ffffffffc0205308 <commands+0x1f8>
...
ffffffffc0200718:	c0c50513          	addi	a0,a0,-1012 # ffffffffc0205320 <commands+0x210>
...
ffffffffc0200726:	c1650513          	addi	a0,a0,-1002 # ffffffffc0205338 <commands+0x228>
...
ffffffffc0200734:	c2050513          	addi	a0,a0,-992 # ffffffffc0205350 <commands+0x240>
...
ffffffffc0200742:	c2a50513          	addi	a0,a0,-982 # ffffffffc0205368 <commands+0x258>
...
ffffffffc0200750:	c3450513          	addi	a0,a0,-972 # ffffffffc0205380 <commands+0x270>
...
ffffffffc020075e:	c3e50513          	addi	a0,a0,-962 # ffffffffc0205398 <commands+0x288>
...
ffffffffc020076c:	c4850513          	addi	a0,a0,-952 # ffffffffc02053b0 <commands+0x2a0>
...
ffffffffc020077a:	c5250513          	addi	a0,a0,-942 # ffffffffc02053c8 <commands+0x2b8>
...
ffffffffc0200788:	c5c50513          	addi	a0,a0,-932 # ffffffffc02053e0 <commands+0x2d0>
...
ffffffffc0200796:	c6650513          	addi	a0,a0,-922 # ffffffffc02053f8 <commands+0x2e8>
...
ffffffffc02007a4:	c7050513          	addi	a0,a0,-912 # ffffffffc0205410 <commands+0x300>
...
ffffffffc02007b2:	c7a50513          	addi	a0,a0,-902 # ffffffffc0205428 <commands+0x318>
ffffffffc02007b6:	9cbff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  s9       0x%08x\n", gpr->s9);
ffffffffc02007ba:	646c                	ld	a1,200(s0)
ffffffffc02007bc:	00005517          	auipc	a0,0x5
ffffffffc02007c0:	c8450513          	addi	a0,a0,-892 # ffffffffc0205440 <commands+0x330>
...
ffffffffc02007ce:	c8e50513          	addi	a0,a0,-882 # ffffffffc0205458 <commands+0x348>
...
ffffffffc02007dc:	c9850513          	addi	a0,a0,-872 # ffffffffc0205470 <commands+0x360>
...
ffffffffc02007ea:	ca250513          	addi	a0,a0,-862 # ffffffffc0205488 <commands+0x378>
...
ffffffffc02007f8:	cac50513          	addi	a0,a0,-852 # ffffffffc02054a0 <commands+0x390>
...
ffffffffc0200806:	cb650513          	addi	a0,a0,-842 # ffffffffc02054b8 <commands+0x3a8>
...
ffffffffc0200818:	cbc50513          	addi	a0,a0,-836 # ffffffffc02054d0 <commands+0x3c0>
}
...
ffffffffc020082c:	cc050513          	addi	a0,a0,-832 # ffffffffc02054e8 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200844:	cc050513          	addi	a0,a0,-832 # ffffffffc0205500 <commands+0x3f0>
...
ffffffffc0200854:	cc850513          	addi	a0,a0,-824 # ffffffffc0205518 <commands+0x408>
...
ffffffffc0200864:	cd050513          	addi	a0,a0,-816 # ffffffffc0205530 <commands+0x420>
...
ffffffffc0200878:	cd450513          	addi	a0,a0,-812 # ffffffffc0205548 <commands+0x438>
}
...
ffffffffc0200894:	d8070713          	addi	a4,a4,-640 # ffffffffc0205610 <commands+0x500>
...
ffffffffc02008a6:	d1e50513          	addi	a0,a0,-738 # ffffffffc02055c0 <commands+0x4b0>
ffffffffc02008aa:	8d7ff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02008ae:	00005517          	auipc	a0,0x5
ffffffffc02008b2:	cf250513          	addi	a0,a0,-782 # ffffffffc02055a0 <commands+0x490>
ffffffffc02008b6:	8cbff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02008ba:	00005517          	auipc	a0,0x5
ffffffffc02008be:	ca650513          	addi	a0,a0,-858 # ffffffffc0205560 <commands+0x450>
ffffffffc02008c2:	8bfff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02008c6:	00005517          	auipc	a0,0x5
ffffffffc02008ca:	cba50513          	addi	a0,a0,-838 # ffffffffc0205580 <commands+0x470>
...
ffffffffc02008fc:	cf850513          	addi	a0,a0,-776 # ffffffffc02055f0 <commands+0x4e0>
...
ffffffffc0200910:	cd450513          	addi	a0,a0,-812 # ffffffffc02055e0 <commands+0x4d0>
}
...
ffffffffc0200932:	eca70713          	addi	a4,a4,-310 # ffffffffc02057f8 <commands+0x6e8>
...
ffffffffc0200944:	ea050513          	addi	a0,a0,-352 # ffffffffc02057e0 <commands+0x6d0>
...
ffffffffc0200966:	cde50513          	addi	a0,a0,-802 # ffffffffc0205640 <commands+0x530>
}
...
ffffffffc02009c0:	d2460613          	addi	a2,a2,-732 # ffffffffc02056e0 <commands+0x5d0>
ffffffffc02009c4:	0b300593          	li	a1,179
ffffffffc02009c8:	00005517          	auipc	a0,0x5
ffffffffc02009cc:	80850513          	addi	a0,a0,-2040 # ffffffffc02051d0 <commands+0xc0>
ffffffffc02009d0:	a77ff0ef          	jal	ra,ffffffffc0200446 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc02009d4:	00005517          	auipc	a0,0x5
ffffffffc02009d8:	d2c50513          	addi	a0,a0,-724 # ffffffffc0205700 <commands+0x5f0>
ffffffffc02009dc:	b779                	j	ffffffffc020096a <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc02009de:	00005517          	auipc	a0,0x5
ffffffffc02009e2:	d3a50513          	addi	a0,a0,-710 # ffffffffc0205718 <commands+0x608>
...
ffffffffc0200a6a:	c7a60613          	addi	a2,a2,-902 # ffffffffc02056e0 <commands+0x5d0>
ffffffffc0200a6e:	0d300593          	li	a1,211
ffffffffc0200a72:	00004517          	auipc	a0,0x4
ffffffffc0200a76:	75e50513          	addi	a0,a0,1886 # ffffffffc02051d0 <commands+0xc0>
...
ffffffffc0200a96:	c4e60613          	addi	a2,a2,-946 # ffffffffc02056e0 <commands+0x5d0>
ffffffffc0200a9a:	0da00593          	li	a1,218
ffffffffc0200a9e:	00004517          	auipc	a0,0x4
ffffffffc0200aa2:	73250513          	addi	a0,a0,1842 # ffffffffc02051d0 <commands+0xc0>
...
ffffffffc0200e74:	9c868693          	addi	a3,a3,-1592 # ffffffffc0205838 <commands+0x728>
ffffffffc0200e78:	00005617          	auipc	a2,0x5
ffffffffc0200e7c:	9d060613          	addi	a2,a2,-1584 # ffffffffc0205848 <commands+0x738>
ffffffffc0200e80:	0f000593          	li	a1,240
ffffffffc0200e84:	00005517          	auipc	a0,0x5
ffffffffc0200e88:	9dc50513          	addi	a0,a0,-1572 # ffffffffc0205860 <commands+0x750>
ffffffffc0200e8c:	dbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200e90:	00005697          	auipc	a3,0x5
ffffffffc0200e94:	a6868693          	addi	a3,a3,-1432 # ffffffffc02058f8 <commands+0x7e8>
ffffffffc0200e98:	00005617          	auipc	a2,0x5
ffffffffc0200e9c:	9b060613          	addi	a2,a2,-1616 # ffffffffc0205848 <commands+0x738>
ffffffffc0200ea0:	0bd00593          	li	a1,189
ffffffffc0200ea4:	00005517          	auipc	a0,0x5
ffffffffc0200ea8:	9bc50513          	addi	a0,a0,-1604 # ffffffffc0205860 <commands+0x750>
ffffffffc0200eac:	d9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200eb0:	00005697          	auipc	a3,0x5
ffffffffc0200eb4:	a7068693          	addi	a3,a3,-1424 # ffffffffc0205920 <commands+0x810>
ffffffffc0200eb8:	00005617          	auipc	a2,0x5
ffffffffc0200ebc:	99060613          	addi	a2,a2,-1648 # ffffffffc0205848 <commands+0x738>
ffffffffc0200ec0:	0be00593          	li	a1,190
ffffffffc0200ec4:	00005517          	auipc	a0,0x5
ffffffffc0200ec8:	99c50513          	addi	a0,a0,-1636 # ffffffffc0205860 <commands+0x750>
ffffffffc0200ecc:	d7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200ed0:	00005697          	auipc	a3,0x5
ffffffffc0200ed4:	a9068693          	addi	a3,a3,-1392 # ffffffffc0205960 <commands+0x850>
ffffffffc0200ed8:	00005617          	auipc	a2,0x5
ffffffffc0200edc:	97060613          	addi	a2,a2,-1680 # ffffffffc0205848 <commands+0x738>
ffffffffc0200ee0:	0c000593          	li	a1,192
ffffffffc0200ee4:	00005517          	auipc	a0,0x5
ffffffffc0200ee8:	97c50513          	addi	a0,a0,-1668 # ffffffffc0205860 <commands+0x750>
ffffffffc0200eec:	d5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200ef0:	00005697          	auipc	a3,0x5
ffffffffc0200ef4:	af868693          	addi	a3,a3,-1288 # ffffffffc02059e8 <commands+0x8d8>
ffffffffc0200ef8:	00005617          	auipc	a2,0x5
ffffffffc0200efc:	95060613          	addi	a2,a2,-1712 # ffffffffc0205848 <commands+0x738>
ffffffffc0200f00:	0d900593          	li	a1,217
ffffffffc0200f04:	00005517          	auipc	a0,0x5
ffffffffc0200f08:	95c50513          	addi	a0,a0,-1700 # ffffffffc0205860 <commands+0x750>
ffffffffc0200f0c:	d3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f10:	00005697          	auipc	a3,0x5
ffffffffc0200f14:	98868693          	addi	a3,a3,-1656 # ffffffffc0205898 <commands+0x788>
ffffffffc0200f18:	00005617          	auipc	a2,0x5
ffffffffc0200f1c:	93060613          	addi	a2,a2,-1744 # ffffffffc0205848 <commands+0x738>
ffffffffc0200f20:	0d200593          	li	a1,210
ffffffffc0200f24:	00005517          	auipc	a0,0x5
ffffffffc0200f28:	93c50513          	addi	a0,a0,-1732 # ffffffffc0205860 <commands+0x750>
ffffffffc0200f2c:	d1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 3);
ffffffffc0200f30:	00005697          	auipc	a3,0x5
ffffffffc0200f34:	aa868693          	addi	a3,a3,-1368 # ffffffffc02059d8 <commands+0x8c8>
ffffffffc0200f38:	00005617          	auipc	a2,0x5
ffffffffc0200f3c:	91060613          	addi	a2,a2,-1776 # ffffffffc0205848 <commands+0x738>
ffffffffc0200f40:	0d000593          	li	a1,208
ffffffffc0200f44:	00005517          	auipc	a0,0x5
ffffffffc0200f48:	91c50513          	addi	a0,a0,-1764 # ffffffffc0205860 <commands+0x750>
ffffffffc0200f4c:	cfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f50:	00005697          	auipc	a3,0x5
ffffffffc0200f54:	a7068693          	addi	a3,a3,-1424 # ffffffffc02059c0 <commands+0x8b0>
ffffffffc0200f58:	00005617          	auipc	a2,0x5
ffffffffc0200f5c:	8f060613          	addi	a2,a2,-1808 # ffffffffc0205848 <commands+0x738>
ffffffffc0200f60:	0cb00593          	li	a1,203
ffffffffc0200f64:	00005517          	auipc	a0,0x5
ffffffffc0200f68:	8fc50513          	addi	a0,a0,-1796 # ffffffffc0205860 <commands+0x750>
ffffffffc0200f6c:	cdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200f70:	00005697          	auipc	a3,0x5
ffffffffc0200f74:	a3068693          	addi	a3,a3,-1488 # ffffffffc02059a0 <commands+0x890>
ffffffffc0200f78:	00005617          	auipc	a2,0x5
ffffffffc0200f7c:	8d060613          	addi	a2,a2,-1840 # ffffffffc0205848 <commands+0x738>
ffffffffc0200f80:	0c200593          	li	a1,194
ffffffffc0200f84:	00005517          	auipc	a0,0x5
ffffffffc0200f88:	8dc50513          	addi	a0,a0,-1828 # ffffffffc0205860 <commands+0x750>
ffffffffc0200f8c:	cbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != NULL);
ffffffffc0200f90:	00005697          	auipc	a3,0x5
ffffffffc0200f94:	aa068693          	addi	a3,a3,-1376 # ffffffffc0205a30 <commands+0x920>
ffffffffc0200f98:	00005617          	auipc	a2,0x5
ffffffffc0200f9c:	8b060613          	addi	a2,a2,-1872 # ffffffffc0205848 <commands+0x738>
ffffffffc0200fa0:	0f800593          	li	a1,248
ffffffffc0200fa4:	00005517          	auipc	a0,0x5
ffffffffc0200fa8:	8bc50513          	addi	a0,a0,-1860 # ffffffffc0205860 <commands+0x750>
ffffffffc0200fac:	c9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc0200fb0:	00005697          	auipc	a3,0x5
ffffffffc0200fb4:	a7068693          	addi	a3,a3,-1424 # ffffffffc0205a20 <commands+0x910>
ffffffffc0200fb8:	00005617          	auipc	a2,0x5
ffffffffc0200fbc:	89060613          	addi	a2,a2,-1904 # ffffffffc0205848 <commands+0x738>
ffffffffc0200fc0:	0df00593          	li	a1,223
ffffffffc0200fc4:	00005517          	auipc	a0,0x5
ffffffffc0200fc8:	89c50513          	addi	a0,a0,-1892 # ffffffffc0205860 <commands+0x750>
ffffffffc0200fcc:	c7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200fd0:	00005697          	auipc	a3,0x5
ffffffffc0200fd4:	9f068693          	addi	a3,a3,-1552 # ffffffffc02059c0 <commands+0x8b0>
ffffffffc0200fd8:	00005617          	auipc	a2,0x5
ffffffffc0200fdc:	87060613          	addi	a2,a2,-1936 # ffffffffc0205848 <commands+0x738>
ffffffffc0200fe0:	0dd00593          	li	a1,221
ffffffffc0200fe4:	00005517          	auipc	a0,0x5
ffffffffc0200fe8:	87c50513          	addi	a0,a0,-1924 # ffffffffc0205860 <commands+0x750>
ffffffffc0200fec:	c5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200ff0:	00005697          	auipc	a3,0x5
ffffffffc0200ff4:	a1068693          	addi	a3,a3,-1520 # ffffffffc0205a00 <commands+0x8f0>
ffffffffc0200ff8:	00005617          	auipc	a2,0x5
ffffffffc0200ffc:	85060613          	addi	a2,a2,-1968 # ffffffffc0205848 <commands+0x738>
ffffffffc0201000:	0dc00593          	li	a1,220
ffffffffc0201004:	00005517          	auipc	a0,0x5
ffffffffc0201008:	85c50513          	addi	a0,a0,-1956 # ffffffffc0205860 <commands+0x750>
ffffffffc020100c:	c3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201010:	00005697          	auipc	a3,0x5
ffffffffc0201014:	88868693          	addi	a3,a3,-1912 # ffffffffc0205898 <commands+0x788>
ffffffffc0201018:	00005617          	auipc	a2,0x5
ffffffffc020101c:	83060613          	addi	a2,a2,-2000 # ffffffffc0205848 <commands+0x738>
ffffffffc0201020:	0b900593          	li	a1,185
ffffffffc0201024:	00005517          	auipc	a0,0x5
ffffffffc0201028:	83c50513          	addi	a0,a0,-1988 # ffffffffc0205860 <commands+0x750>
ffffffffc020102c:	c1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201030:	00005697          	auipc	a3,0x5
ffffffffc0201034:	99068693          	addi	a3,a3,-1648 # ffffffffc02059c0 <commands+0x8b0>
ffffffffc0201038:	00005617          	auipc	a2,0x5
ffffffffc020103c:	81060613          	addi	a2,a2,-2032 # ffffffffc0205848 <commands+0x738>
ffffffffc0201040:	0d600593          	li	a1,214
ffffffffc0201044:	00005517          	auipc	a0,0x5
ffffffffc0201048:	81c50513          	addi	a0,a0,-2020 # ffffffffc0205860 <commands+0x750>
ffffffffc020104c:	bfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201050:	00005697          	auipc	a3,0x5
ffffffffc0201054:	88868693          	addi	a3,a3,-1912 # ffffffffc02058d8 <commands+0x7c8>
ffffffffc0201058:	00004617          	auipc	a2,0x4
ffffffffc020105c:	7f060613          	addi	a2,a2,2032 # ffffffffc0205848 <commands+0x738>
ffffffffc0201060:	0d400593          	li	a1,212
ffffffffc0201064:	00004517          	auipc	a0,0x4
ffffffffc0201068:	7fc50513          	addi	a0,a0,2044 # ffffffffc0205860 <commands+0x750>
ffffffffc020106c:	bdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201070:	00005697          	auipc	a3,0x5
ffffffffc0201074:	84868693          	addi	a3,a3,-1976 # ffffffffc02058b8 <commands+0x7a8>
ffffffffc0201078:	00004617          	auipc	a2,0x4
ffffffffc020107c:	7d060613          	addi	a2,a2,2000 # ffffffffc0205848 <commands+0x738>
ffffffffc0201080:	0d300593          	li	a1,211
ffffffffc0201084:	00004517          	auipc	a0,0x4
ffffffffc0201088:	7dc50513          	addi	a0,a0,2012 # ffffffffc0205860 <commands+0x750>
ffffffffc020108c:	bbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201090:	00005697          	auipc	a3,0x5
ffffffffc0201094:	84868693          	addi	a3,a3,-1976 # ffffffffc02058d8 <commands+0x7c8>
ffffffffc0201098:	00004617          	auipc	a2,0x4
ffffffffc020109c:	7b060613          	addi	a2,a2,1968 # ffffffffc0205848 <commands+0x738>
ffffffffc02010a0:	0bb00593          	li	a1,187
ffffffffc02010a4:	00004517          	auipc	a0,0x4
ffffffffc02010a8:	7bc50513          	addi	a0,a0,1980 # ffffffffc0205860 <commands+0x750>
ffffffffc02010ac:	b9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(count == 0);
ffffffffc02010b0:	00005697          	auipc	a3,0x5
ffffffffc02010b4:	ad068693          	addi	a3,a3,-1328 # ffffffffc0205b80 <commands+0xa70>
ffffffffc02010b8:	00004617          	auipc	a2,0x4
ffffffffc02010bc:	79060613          	addi	a2,a2,1936 # ffffffffc0205848 <commands+0x738>
ffffffffc02010c0:	12500593          	li	a1,293
ffffffffc02010c4:	00004517          	auipc	a0,0x4
ffffffffc02010c8:	79c50513          	addi	a0,a0,1948 # ffffffffc0205860 <commands+0x750>
ffffffffc02010cc:	b7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc02010d0:	00005697          	auipc	a3,0x5
ffffffffc02010d4:	95068693          	addi	a3,a3,-1712 # ffffffffc0205a20 <commands+0x910>
ffffffffc02010d8:	00004617          	auipc	a2,0x4
ffffffffc02010dc:	77060613          	addi	a2,a2,1904 # ffffffffc0205848 <commands+0x738>
ffffffffc02010e0:	11a00593          	li	a1,282
ffffffffc02010e4:	00004517          	auipc	a0,0x4
ffffffffc02010e8:	77c50513          	addi	a0,a0,1916 # ffffffffc0205860 <commands+0x750>
ffffffffc02010ec:	b5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02010f0:	00005697          	auipc	a3,0x5
ffffffffc02010f4:	8d068693          	addi	a3,a3,-1840 # ffffffffc02059c0 <commands+0x8b0>
ffffffffc02010f8:	00004617          	auipc	a2,0x4
ffffffffc02010fc:	75060613          	addi	a2,a2,1872 # ffffffffc0205848 <commands+0x738>
ffffffffc0201100:	11800593          	li	a1,280
ffffffffc0201104:	00004517          	auipc	a0,0x4
ffffffffc0201108:	75c50513          	addi	a0,a0,1884 # ffffffffc0205860 <commands+0x750>
ffffffffc020110c:	b3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201110:	00005697          	auipc	a3,0x5
ffffffffc0201114:	87068693          	addi	a3,a3,-1936 # ffffffffc0205980 <commands+0x870>
ffffffffc0201118:	00004617          	auipc	a2,0x4
ffffffffc020111c:	73060613          	addi	a2,a2,1840 # ffffffffc0205848 <commands+0x738>
ffffffffc0201120:	0c100593          	li	a1,193
ffffffffc0201124:	00004517          	auipc	a0,0x4
ffffffffc0201128:	73c50513          	addi	a0,a0,1852 # ffffffffc0205860 <commands+0x750>
ffffffffc020112c:	b1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201130:	00005697          	auipc	a3,0x5
ffffffffc0201134:	a1068693          	addi	a3,a3,-1520 # ffffffffc0205b40 <commands+0xa30>
ffffffffc0201138:	00004617          	auipc	a2,0x4
ffffffffc020113c:	71060613          	addi	a2,a2,1808 # ffffffffc0205848 <commands+0x738>
ffffffffc0201140:	11200593          	li	a1,274
ffffffffc0201144:	00004517          	auipc	a0,0x4
ffffffffc0201148:	71c50513          	addi	a0,a0,1820 # ffffffffc0205860 <commands+0x750>
ffffffffc020114c:	afaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201150:	00005697          	auipc	a3,0x5
ffffffffc0201154:	9d068693          	addi	a3,a3,-1584 # ffffffffc0205b20 <commands+0xa10>
ffffffffc0201158:	00004617          	auipc	a2,0x4
ffffffffc020115c:	6f060613          	addi	a2,a2,1776 # ffffffffc0205848 <commands+0x738>
ffffffffc0201160:	11000593          	li	a1,272
ffffffffc0201164:	00004517          	auipc	a0,0x4
ffffffffc0201168:	6fc50513          	addi	a0,a0,1788 # ffffffffc0205860 <commands+0x750>
ffffffffc020116c:	adaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201170:	00005697          	auipc	a3,0x5
ffffffffc0201174:	98868693          	addi	a3,a3,-1656 # ffffffffc0205af8 <commands+0x9e8>
ffffffffc0201178:	00004617          	auipc	a2,0x4
ffffffffc020117c:	6d060613          	addi	a2,a2,1744 # ffffffffc0205848 <commands+0x738>
ffffffffc0201180:	10e00593          	li	a1,270
ffffffffc0201184:	00004517          	auipc	a0,0x4
ffffffffc0201188:	6dc50513          	addi	a0,a0,1756 # ffffffffc0205860 <commands+0x750>
ffffffffc020118c:	abaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201190:	00005697          	auipc	a3,0x5
ffffffffc0201194:	94068693          	addi	a3,a3,-1728 # ffffffffc0205ad0 <commands+0x9c0>
ffffffffc0201198:	00004617          	auipc	a2,0x4
ffffffffc020119c:	6b060613          	addi	a2,a2,1712 # ffffffffc0205848 <commands+0x738>
ffffffffc02011a0:	10d00593          	li	a1,269
ffffffffc02011a4:	00004517          	auipc	a0,0x4
ffffffffc02011a8:	6bc50513          	addi	a0,a0,1724 # ffffffffc0205860 <commands+0x750>
ffffffffc02011ac:	a9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 + 2 == p1);
ffffffffc02011b0:	00005697          	auipc	a3,0x5
ffffffffc02011b4:	91068693          	addi	a3,a3,-1776 # ffffffffc0205ac0 <commands+0x9b0>
ffffffffc02011b8:	00004617          	auipc	a2,0x4
ffffffffc02011bc:	69060613          	addi	a2,a2,1680 # ffffffffc0205848 <commands+0x738>
ffffffffc02011c0:	10800593          	li	a1,264
ffffffffc02011c4:	00004517          	auipc	a0,0x4
ffffffffc02011c8:	69c50513          	addi	a0,a0,1692 # ffffffffc0205860 <commands+0x750>
ffffffffc02011cc:	a7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011d0:	00004697          	auipc	a3,0x4
ffffffffc02011d4:	7f068693          	addi	a3,a3,2032 # ffffffffc02059c0 <commands+0x8b0>
ffffffffc02011d8:	00004617          	auipc	a2,0x4
ffffffffc02011dc:	67060613          	addi	a2,a2,1648 # ffffffffc0205848 <commands+0x738>
ffffffffc02011e0:	10700593          	li	a1,263
ffffffffc02011e4:	00004517          	auipc	a0,0x4
ffffffffc02011e8:	67c50513          	addi	a0,a0,1660 # ffffffffc0205860 <commands+0x750>
ffffffffc02011ec:	a5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02011f0:	00005697          	auipc	a3,0x5
ffffffffc02011f4:	8b068693          	addi	a3,a3,-1872 # ffffffffc0205aa0 <commands+0x990>
ffffffffc02011f8:	00004617          	auipc	a2,0x4
ffffffffc02011fc:	65060613          	addi	a2,a2,1616 # ffffffffc0205848 <commands+0x738>
ffffffffc0201200:	10600593          	li	a1,262
ffffffffc0201204:	00004517          	auipc	a0,0x4
ffffffffc0201208:	65c50513          	addi	a0,a0,1628 # ffffffffc0205860 <commands+0x750>
ffffffffc020120c:	a3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201210:	00005697          	auipc	a3,0x5
ffffffffc0201214:	86068693          	addi	a3,a3,-1952 # ffffffffc0205a70 <commands+0x960>
ffffffffc0201218:	00004617          	auipc	a2,0x4
ffffffffc020121c:	63060613          	addi	a2,a2,1584 # ffffffffc0205848 <commands+0x738>
ffffffffc0201220:	10500593          	li	a1,261
ffffffffc0201224:	00004517          	auipc	a0,0x4
ffffffffc0201228:	63c50513          	addi	a0,a0,1596 # ffffffffc0205860 <commands+0x750>
ffffffffc020122c:	a1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201230:	00005697          	auipc	a3,0x5
ffffffffc0201234:	82868693          	addi	a3,a3,-2008 # ffffffffc0205a58 <commands+0x948>
ffffffffc0201238:	00004617          	auipc	a2,0x4
ffffffffc020123c:	61060613          	addi	a2,a2,1552 # ffffffffc0205848 <commands+0x738>
ffffffffc0201240:	10400593          	li	a1,260
ffffffffc0201244:	00004517          	auipc	a0,0x4
ffffffffc0201248:	61c50513          	addi	a0,a0,1564 # ffffffffc0205860 <commands+0x750>
ffffffffc020124c:	9faff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201250:	00004697          	auipc	a3,0x4
ffffffffc0201254:	77068693          	addi	a3,a3,1904 # ffffffffc02059c0 <commands+0x8b0>
ffffffffc0201258:	00004617          	auipc	a2,0x4
ffffffffc020125c:	5f060613          	addi	a2,a2,1520 # ffffffffc0205848 <commands+0x738>
ffffffffc0201260:	0fe00593          	li	a1,254
ffffffffc0201264:	00004517          	auipc	a0,0x4
ffffffffc0201268:	5fc50513          	addi	a0,a0,1532 # ffffffffc0205860 <commands+0x750>
ffffffffc020126c:	9daff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!PageProperty(p0));
ffffffffc0201270:	00004697          	auipc	a3,0x4
ffffffffc0201274:	7d068693          	addi	a3,a3,2000 # ffffffffc0205a40 <commands+0x930>
ffffffffc0201278:	00004617          	auipc	a2,0x4
ffffffffc020127c:	5d060613          	addi	a2,a2,1488 # ffffffffc0205848 <commands+0x738>
ffffffffc0201280:	0f900593          	li	a1,249
ffffffffc0201284:	00004517          	auipc	a0,0x4
ffffffffc0201288:	5dc50513          	addi	a0,a0,1500 # ffffffffc0205860 <commands+0x750>
ffffffffc020128c:	9baff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201290:	00005697          	auipc	a3,0x5
ffffffffc0201294:	8d068693          	addi	a3,a3,-1840 # ffffffffc0205b60 <commands+0xa50>
ffffffffc0201298:	00004617          	auipc	a2,0x4
ffffffffc020129c:	5b060613          	addi	a2,a2,1456 # ffffffffc0205848 <commands+0x738>
ffffffffc02012a0:	11700593          	li	a1,279
ffffffffc02012a4:	00004517          	auipc	a0,0x4
ffffffffc02012a8:	5bc50513          	addi	a0,a0,1468 # ffffffffc0205860 <commands+0x750>
ffffffffc02012ac:	99aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == 0);
ffffffffc02012b0:	00005697          	auipc	a3,0x5
ffffffffc02012b4:	8e068693          	addi	a3,a3,-1824 # ffffffffc0205b90 <commands+0xa80>
ffffffffc02012b8:	00004617          	auipc	a2,0x4
ffffffffc02012bc:	59060613          	addi	a2,a2,1424 # ffffffffc0205848 <commands+0x738>
ffffffffc02012c0:	12600593          	li	a1,294
ffffffffc02012c4:	00004517          	auipc	a0,0x4
ffffffffc02012c8:	59c50513          	addi	a0,a0,1436 # ffffffffc0205860 <commands+0x750>
ffffffffc02012cc:	97aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == nr_free_pages());
ffffffffc02012d0:	00004697          	auipc	a3,0x4
ffffffffc02012d4:	5a868693          	addi	a3,a3,1448 # ffffffffc0205878 <commands+0x768>
ffffffffc02012d8:	00004617          	auipc	a2,0x4
ffffffffc02012dc:	57060613          	addi	a2,a2,1392 # ffffffffc0205848 <commands+0x738>
ffffffffc02012e0:	0f300593          	li	a1,243
ffffffffc02012e4:	00004517          	auipc	a0,0x4
ffffffffc02012e8:	57c50513          	addi	a0,a0,1404 # ffffffffc0205860 <commands+0x750>
ffffffffc02012ec:	95aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02012f0:	00004697          	auipc	a3,0x4
ffffffffc02012f4:	5c868693          	addi	a3,a3,1480 # ffffffffc02058b8 <commands+0x7a8>
ffffffffc02012f8:	00004617          	auipc	a2,0x4
ffffffffc02012fc:	55060613          	addi	a2,a2,1360 # ffffffffc0205848 <commands+0x738>
ffffffffc0201300:	0ba00593          	li	a1,186
ffffffffc0201304:	00004517          	auipc	a0,0x4
ffffffffc0201308:	55c50513          	addi	a0,a0,1372 # ffffffffc0205860 <commands+0x750>
...
ffffffffc0201440:	76c68693          	addi	a3,a3,1900 # ffffffffc0205ba8 <commands+0xa98>
ffffffffc0201444:	00004617          	auipc	a2,0x4
ffffffffc0201448:	40460613          	addi	a2,a2,1028 # ffffffffc0205848 <commands+0x738>
ffffffffc020144c:	08300593          	li	a1,131
ffffffffc0201450:	00004517          	auipc	a0,0x4
ffffffffc0201454:	41050513          	addi	a0,a0,1040 # ffffffffc0205860 <commands+0x750>
ffffffffc0201458:	feffe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc020145c:	00004697          	auipc	a3,0x4
ffffffffc0201460:	74468693          	addi	a3,a3,1860 # ffffffffc0205ba0 <commands+0xa90>
ffffffffc0201464:	00004617          	auipc	a2,0x4
ffffffffc0201468:	3e460613          	addi	a2,a2,996 # ffffffffc0205848 <commands+0x738>
ffffffffc020146c:	08000593          	li	a1,128
ffffffffc0201470:	00004517          	auipc	a0,0x4
ffffffffc0201474:	3f050513          	addi	a0,a0,1008 # ffffffffc0205860 <commands+0x750>
...
ffffffffc0201512:	69268693          	addi	a3,a3,1682 # ffffffffc0205ba0 <commands+0xa90>
ffffffffc0201516:	00004617          	auipc	a2,0x4
ffffffffc020151a:	33260613          	addi	a2,a2,818 # ffffffffc0205848 <commands+0x738>
ffffffffc020151e:	06200593          	li	a1,98
ffffffffc0201522:	00004517          	auipc	a0,0x4
ffffffffc0201526:	33e50513          	addi	a0,a0,830 # ffffffffc0205860 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc02015e4:	5f068693          	addi	a3,a3,1520 # ffffffffc0205bd0 <commands+0xac0>
ffffffffc02015e8:	00004617          	auipc	a2,0x4
ffffffffc02015ec:	26060613          	addi	a2,a2,608 # ffffffffc0205848 <commands+0x738>
ffffffffc02015f0:	04900593          	li	a1,73
ffffffffc02015f4:	00004517          	auipc	a0,0x4
ffffffffc02015f8:	26c50513          	addi	a0,a0,620 # ffffffffc0205860 <commands+0x750>
ffffffffc02015fc:	e4bfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc0201600:	00004697          	auipc	a3,0x4
ffffffffc0201604:	5a068693          	addi	a3,a3,1440 # ffffffffc0205ba0 <commands+0xa90>
ffffffffc0201608:	00004617          	auipc	a2,0x4
ffffffffc020160c:	24060613          	addi	a2,a2,576 # ffffffffc0205848 <commands+0x738>
ffffffffc0201610:	04600593          	li	a1,70
ffffffffc0201614:	00004517          	auipc	a0,0x4
ffffffffc0201618:	24c50513          	addi	a0,a0,588 # ffffffffc0205860 <commands+0x750>
...
ffffffffc0201724:	51060613          	addi	a2,a2,1296 # ffffffffc0205c30 <default_pmm_manager+0x38>
ffffffffc0201728:	06900593          	li	a1,105
ffffffffc020172c:	00004517          	auipc	a0,0x4
ffffffffc0201730:	52c50513          	addi	a0,a0,1324 # ffffffffc0205c58 <default_pmm_manager+0x60>
...
ffffffffc0201812:	45a68693          	addi	a3,a3,1114 # ffffffffc0205c68 <default_pmm_manager+0x70>
ffffffffc0201816:	00004617          	auipc	a2,0x4
ffffffffc020181a:	03260613          	addi	a2,a2,50 # ffffffffc0205848 <commands+0x738>
ffffffffc020181e:	06300593          	li	a1,99
ffffffffc0201822:	00004517          	auipc	a0,0x4
ffffffffc0201826:	46650513          	addi	a0,a0,1126 # ffffffffc0205c88 <default_pmm_manager+0x90>
...
ffffffffc0201834:	47050513          	addi	a0,a0,1136 # ffffffffc0205ca0 <default_pmm_manager+0xa8>
kmalloc_init(void) {
...
ffffffffc0201844:	47850513          	addi	a0,a0,1144 # ffffffffc0205cb8 <default_pmm_manager+0xc0>
}
...
ffffffffc02019c6:	33e60613          	addi	a2,a2,830 # ffffffffc0205d00 <default_pmm_manager+0x108>
ffffffffc02019ca:	06200593          	li	a1,98
ffffffffc02019ce:	00004517          	auipc	a0,0x4
ffffffffc02019d2:	28a50513          	addi	a0,a0,650 # ffffffffc0205c58 <default_pmm_manager+0x60>
...
ffffffffc02019e0:	2fc60613          	addi	a2,a2,764 # ffffffffc0205cd8 <default_pmm_manager+0xe0>
ffffffffc02019e4:	06e00593          	li	a1,110
ffffffffc02019e8:	00004517          	auipc	a0,0x4
ffffffffc02019ec:	27050513          	addi	a0,a0,624 # ffffffffc0205c58 <default_pmm_manager+0x60>
...
ffffffffc02019fa:	30a60613          	addi	a2,a2,778 # ffffffffc0205d00 <default_pmm_manager+0x108>
ffffffffc02019fe:	06200593          	li	a1,98
ffffffffc0201a02:	00004517          	auipc	a0,0x4
ffffffffc0201a06:	25650513          	addi	a0,a0,598 # ffffffffc0205c58 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0201a16:	30e60613          	addi	a2,a2,782 # ffffffffc0205d20 <default_pmm_manager+0x128>
ffffffffc0201a1a:	07400593          	li	a1,116
ffffffffc0201a1e:	00004517          	auipc	a0,0x4
ffffffffc0201a22:	23a50513          	addi	a0,a0,570 # ffffffffc0205c58 <default_pmm_manager+0x60>
pte2page(pte_t pte) {
...
ffffffffc0201bbe:	296030ef          	jal	ra,ffffffffc0204e54 <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	204030ef          	jal	ra,ffffffffc0204e54 <memset>
    return page - pages + nbase;
...
ffffffffc0201caa:	f8a60613          	addi	a2,a2,-118 # ffffffffc0205c30 <default_pmm_manager+0x38>
ffffffffc0201cae:	0e400593          	li	a1,228
ffffffffc0201cb2:	00004517          	auipc	a0,0x4
ffffffffc0201cb6:	09650513          	addi	a0,a0,150 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc0201cba:	f8cfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201cbe:	00004617          	auipc	a2,0x4
ffffffffc0201cc2:	f7260613          	addi	a2,a2,-142 # ffffffffc0205c30 <default_pmm_manager+0x38>
ffffffffc0201cc6:	0ef00593          	li	a1,239
ffffffffc0201cca:	00004517          	auipc	a0,0x4
ffffffffc0201cce:	07e50513          	addi	a0,a0,126 # ffffffffc0205d48 <default_pmm_manager+0x150>
...
ffffffffc0201cdc:	f5860613          	addi	a2,a2,-168 # ffffffffc0205c30 <default_pmm_manager+0x38>
ffffffffc0201ce0:	0ec00593          	li	a1,236
ffffffffc0201ce4:	00004517          	auipc	a0,0x4
ffffffffc0201ce8:	06450513          	addi	a0,a0,100 # ffffffffc0205d48 <default_pmm_manager+0x150>
...
ffffffffc0201cf6:	f3e60613          	addi	a2,a2,-194 # ffffffffc0205c30 <default_pmm_manager+0x38>
ffffffffc0201cfa:	0e100593          	li	a1,225
ffffffffc0201cfe:	00004517          	auipc	a0,0x4
ffffffffc0201d02:	04a50513          	addi	a0,a0,74 # ffffffffc0205d48 <default_pmm_manager+0x150>
...
ffffffffc0201ef4:	d0878793          	addi	a5,a5,-760 # ffffffffc0205bf8 <default_pmm_manager>
...
ffffffffc0201f02:	e5a50513          	addi	a0,a0,-422 # ffffffffc0205d58 <default_pmm_manager+0x160>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201f50:	e2450513          	addi	a0,a0,-476 # ffffffffc0205d70 <default_pmm_manager+0x178>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201f70:	e1c50513          	addi	a0,a0,-484 # ffffffffc0205d88 <default_pmm_manager+0x190>
...
ffffffffc0201fd8:	ddc50513          	addi	a0,a0,-548 # ffffffffc0205db0 <default_pmm_manager+0x1b8>
...
ffffffffc0201ff4:	dd850513          	addi	a0,a0,-552 # ffffffffc0205dc8 <default_pmm_manager+0x1d0>
...
ffffffffc0202294:	e2050513          	addi	a0,a0,-480 # ffffffffc02060b0 <default_pmm_manager+0x4b8>
...
ffffffffc020234a:	ea258593          	addi	a1,a1,-350 # ffffffffc02061e8 <default_pmm_manager+0x5f0>
ffffffffc020234e:	10000513          	li	a0,256
ffffffffc0202352:	2bd020ef          	jal	ra,ffffffffc0204e0e <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	2c3020ef          	jal	ra,ffffffffc0204e20 <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	245020ef          	jal	ra,ffffffffc0204dd8 <strlen>
...
ffffffffc0202458:	e0c50513          	addi	a0,a0,-500 # ffffffffc0206260 <default_pmm_manager+0x668>
...
ffffffffc0202572:	ba268693          	addi	a3,a3,-1118 # ffffffffc0206110 <default_pmm_manager+0x518>
ffffffffc0202576:	00003617          	auipc	a2,0x3
ffffffffc020257a:	2d260613          	addi	a2,a2,722 # ffffffffc0205848 <commands+0x738>
ffffffffc020257e:	19e00593          	li	a1,414
ffffffffc0202582:	00003517          	auipc	a0,0x3
ffffffffc0202586:	7c650513          	addi	a0,a0,1990 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc020258a:	ebdfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc020258e:	00004697          	auipc	a3,0x4
ffffffffc0202592:	b4268693          	addi	a3,a3,-1214 # ffffffffc02060d0 <default_pmm_manager+0x4d8>
ffffffffc0202596:	00003617          	auipc	a2,0x3
ffffffffc020259a:	2b260613          	addi	a2,a2,690 # ffffffffc0205848 <commands+0x738>
ffffffffc020259e:	19d00593          	li	a1,413
ffffffffc02025a2:	00003517          	auipc	a0,0x3
ffffffffc02025a6:	7a650513          	addi	a0,a0,1958 # ffffffffc0205d48 <default_pmm_manager+0x150>
...
ffffffffc02025b4:	68060613          	addi	a2,a2,1664 # ffffffffc0205c30 <default_pmm_manager+0x38>
ffffffffc02025b8:	19d00593          	li	a1,413
ffffffffc02025bc:	00003517          	auipc	a0,0x3
ffffffffc02025c0:	78c50513          	addi	a0,a0,1932 # ffffffffc0205d48 <default_pmm_manager+0x150>
...
ffffffffc02025d0:	70c60613          	addi	a2,a2,1804 # ffffffffc0205cd8 <default_pmm_manager+0xe0>
ffffffffc02025d4:	07f00593          	li	a1,127
ffffffffc02025d8:	00003517          	auipc	a0,0x3
ffffffffc02025dc:	77050513          	addi	a0,a0,1904 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc02025e0:	e67fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc02025e4:	00003617          	auipc	a2,0x3
ffffffffc02025e8:	6f460613          	addi	a2,a2,1780 # ffffffffc0205cd8 <default_pmm_manager+0xe0>
ffffffffc02025ec:	0c300593          	li	a1,195
ffffffffc02025f0:	00003517          	auipc	a0,0x3
ffffffffc02025f4:	75850513          	addi	a0,a0,1880 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc02025f8:	e4ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc02025fc:	00004697          	auipc	a3,0x4
ffffffffc0202600:	80c68693          	addi	a3,a3,-2036 # ffffffffc0205e08 <default_pmm_manager+0x210>
ffffffffc0202604:	00003617          	auipc	a2,0x3
ffffffffc0202608:	24460613          	addi	a2,a2,580 # ffffffffc0205848 <commands+0x738>
ffffffffc020260c:	16100593          	li	a1,353
ffffffffc0202610:	00003517          	auipc	a0,0x3
ffffffffc0202614:	73850513          	addi	a0,a0,1848 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc0202618:	e2ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020261c:	00003697          	auipc	a3,0x3
ffffffffc0202620:	7cc68693          	addi	a3,a3,1996 # ffffffffc0205de8 <default_pmm_manager+0x1f0>
ffffffffc0202624:	00003617          	auipc	a2,0x3
ffffffffc0202628:	22460613          	addi	a2,a2,548 # ffffffffc0205848 <commands+0x738>
ffffffffc020262c:	16000593          	li	a1,352
ffffffffc0202630:	00003517          	auipc	a0,0x3
ffffffffc0202634:	71850513          	addi	a0,a0,1816 # ffffffffc0205d48 <default_pmm_manager+0x150>
...
ffffffffc0202644:	85868693          	addi	a3,a3,-1960 # ffffffffc0205e98 <default_pmm_manager+0x2a0>
ffffffffc0202648:	00003617          	auipc	a2,0x3
ffffffffc020264c:	20060613          	addi	a2,a2,512 # ffffffffc0205848 <commands+0x738>
ffffffffc0202650:	16900593          	li	a1,361
ffffffffc0202654:	00003517          	auipc	a0,0x3
ffffffffc0202658:	6f450513          	addi	a0,a0,1780 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc020265c:	debfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202660:	00004697          	auipc	a3,0x4
ffffffffc0202664:	80868693          	addi	a3,a3,-2040 # ffffffffc0205e68 <default_pmm_manager+0x270>
ffffffffc0202668:	00003617          	auipc	a2,0x3
ffffffffc020266c:	1e060613          	addi	a2,a2,480 # ffffffffc0205848 <commands+0x738>
ffffffffc0202670:	16600593          	li	a1,358
ffffffffc0202674:	00003517          	auipc	a0,0x3
ffffffffc0202678:	6d450513          	addi	a0,a0,1748 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc020267c:	dcbfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0202680:	00003697          	auipc	a3,0x3
ffffffffc0202684:	7c068693          	addi	a3,a3,1984 # ffffffffc0205e40 <default_pmm_manager+0x248>
ffffffffc0202688:	00003617          	auipc	a2,0x3
ffffffffc020268c:	1c060613          	addi	a2,a2,448 # ffffffffc0205848 <commands+0x738>
ffffffffc0202690:	16200593          	li	a1,354
ffffffffc0202694:	00003517          	auipc	a0,0x3
ffffffffc0202698:	6b450513          	addi	a0,a0,1716 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc020269c:	dabfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02026a0:	00004697          	auipc	a3,0x4
ffffffffc02026a4:	88068693          	addi	a3,a3,-1920 # ffffffffc0205f20 <default_pmm_manager+0x328>
ffffffffc02026a8:	00003617          	auipc	a2,0x3
ffffffffc02026ac:	1a060613          	addi	a2,a2,416 # ffffffffc0205848 <commands+0x738>
ffffffffc02026b0:	17200593          	li	a1,370
ffffffffc02026b4:	00003517          	auipc	a0,0x3
ffffffffc02026b8:	69450513          	addi	a0,a0,1684 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc02026bc:	d8bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02026c0:	00004697          	auipc	a3,0x4
ffffffffc02026c4:	90068693          	addi	a3,a3,-1792 # ffffffffc0205fc0 <default_pmm_manager+0x3c8>
ffffffffc02026c8:	00003617          	auipc	a2,0x3
ffffffffc02026cc:	18060613          	addi	a2,a2,384 # ffffffffc0205848 <commands+0x738>
ffffffffc02026d0:	17700593          	li	a1,375
ffffffffc02026d4:	00003517          	auipc	a0,0x3
ffffffffc02026d8:	67450513          	addi	a0,a0,1652 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc02026dc:	d6bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc02026e0:	00004697          	auipc	a3,0x4
ffffffffc02026e4:	81868693          	addi	a3,a3,-2024 # ffffffffc0205ef8 <default_pmm_manager+0x300>
ffffffffc02026e8:	00003617          	auipc	a2,0x3
ffffffffc02026ec:	16060613          	addi	a2,a2,352 # ffffffffc0205848 <commands+0x738>
ffffffffc02026f0:	16f00593          	li	a1,367
ffffffffc02026f4:	00003517          	auipc	a0,0x3
ffffffffc02026f8:	65450513          	addi	a0,a0,1620 # ffffffffc0205d48 <default_pmm_manager+0x150>
...
ffffffffc0202706:	52e60613          	addi	a2,a2,1326 # ffffffffc0205c30 <default_pmm_manager+0x38>
ffffffffc020270a:	16e00593          	li	a1,366
ffffffffc020270e:	00003517          	auipc	a0,0x3
ffffffffc0202712:	63a50513          	addi	a0,a0,1594 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc0202716:	d31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020271a:	00004697          	auipc	a3,0x4
ffffffffc020271e:	83e68693          	addi	a3,a3,-1986 # ffffffffc0205f58 <default_pmm_manager+0x360>
ffffffffc0202722:	00003617          	auipc	a2,0x3
ffffffffc0202726:	12660613          	addi	a2,a2,294 # ffffffffc0205848 <commands+0x738>
ffffffffc020272a:	17c00593          	li	a1,380
ffffffffc020272e:	00003517          	auipc	a0,0x3
ffffffffc0202732:	61a50513          	addi	a0,a0,1562 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc0202736:	d11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020273a:	00004697          	auipc	a3,0x4
ffffffffc020273e:	8e668693          	addi	a3,a3,-1818 # ffffffffc0206020 <default_pmm_manager+0x428>
ffffffffc0202742:	00003617          	auipc	a2,0x3
ffffffffc0202746:	10660613          	addi	a2,a2,262 # ffffffffc0205848 <commands+0x738>
ffffffffc020274a:	17b00593          	li	a1,379
ffffffffc020274e:	00003517          	auipc	a0,0x3
ffffffffc0202752:	5fa50513          	addi	a0,a0,1530 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc0202756:	cf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020275a:	00004697          	auipc	a3,0x4
ffffffffc020275e:	8ae68693          	addi	a3,a3,-1874 # ffffffffc0206008 <default_pmm_manager+0x410>
ffffffffc0202762:	00003617          	auipc	a2,0x3
ffffffffc0202766:	0e660613          	addi	a2,a2,230 # ffffffffc0205848 <commands+0x738>
ffffffffc020276a:	17a00593          	li	a1,378
ffffffffc020276e:	00003517          	auipc	a0,0x3
ffffffffc0202772:	5da50513          	addi	a0,a0,1498 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc0202776:	cd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc020277a:	00004697          	auipc	a3,0x4
ffffffffc020277e:	85e68693          	addi	a3,a3,-1954 # ffffffffc0205fd8 <default_pmm_manager+0x3e0>
ffffffffc0202782:	00003617          	auipc	a2,0x3
ffffffffc0202786:	0c660613          	addi	a2,a2,198 # ffffffffc0205848 <commands+0x738>
ffffffffc020278a:	17900593          	li	a1,377
ffffffffc020278e:	00003517          	auipc	a0,0x3
ffffffffc0202792:	5ba50513          	addi	a0,a0,1466 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc0202796:	cb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc020279a:	00004697          	auipc	a3,0x4
ffffffffc020279e:	9f668693          	addi	a3,a3,-1546 # ffffffffc0206190 <default_pmm_manager+0x598>
ffffffffc02027a2:	00003617          	auipc	a2,0x3
ffffffffc02027a6:	0a660613          	addi	a2,a2,166 # ffffffffc0205848 <commands+0x738>
ffffffffc02027aa:	1a700593          	li	a1,423
ffffffffc02027ae:	00003517          	auipc	a0,0x3
ffffffffc02027b2:	59a50513          	addi	a0,a0,1434 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc02027b6:	c91fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02027ba:	00003697          	auipc	a3,0x3
ffffffffc02027be:	7ee68693          	addi	a3,a3,2030 # ffffffffc0205fa8 <default_pmm_manager+0x3b0>
ffffffffc02027c2:	00003617          	auipc	a2,0x3
ffffffffc02027c6:	08660613          	addi	a2,a2,134 # ffffffffc0205848 <commands+0x738>
ffffffffc02027ca:	17600593          	li	a1,374
ffffffffc02027ce:	00003517          	auipc	a0,0x3
ffffffffc02027d2:	57a50513          	addi	a0,a0,1402 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc02027d6:	c71fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_W);
ffffffffc02027da:	00003697          	auipc	a3,0x3
ffffffffc02027de:	7be68693          	addi	a3,a3,1982 # ffffffffc0205f98 <default_pmm_manager+0x3a0>
ffffffffc02027e2:	00003617          	auipc	a2,0x3
ffffffffc02027e6:	06660613          	addi	a2,a2,102 # ffffffffc0205848 <commands+0x738>
ffffffffc02027ea:	17500593          	li	a1,373
ffffffffc02027ee:	00003517          	auipc	a0,0x3
ffffffffc02027f2:	55a50513          	addi	a0,a0,1370 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc02027f6:	c51fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02027fa:	00004697          	auipc	a3,0x4
ffffffffc02027fe:	89668693          	addi	a3,a3,-1898 # ffffffffc0206090 <default_pmm_manager+0x498>
ffffffffc0202802:	00003617          	auipc	a2,0x3
ffffffffc0202806:	04660613          	addi	a2,a2,70 # ffffffffc0205848 <commands+0x738>
ffffffffc020280a:	1b800593          	li	a1,440
ffffffffc020280e:	00003517          	auipc	a0,0x3
ffffffffc0202812:	53a50513          	addi	a0,a0,1338 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc0202816:	c31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020281a:	00003697          	auipc	a3,0x3
ffffffffc020281e:	76e68693          	addi	a3,a3,1902 # ffffffffc0205f88 <default_pmm_manager+0x390>
ffffffffc0202822:	00003617          	auipc	a2,0x3
ffffffffc0202826:	02660613          	addi	a2,a2,38 # ffffffffc0205848 <commands+0x738>
ffffffffc020282a:	17400593          	li	a1,372
ffffffffc020282e:	00003517          	auipc	a0,0x3
ffffffffc0202832:	51a50513          	addi	a0,a0,1306 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc0202836:	c11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020283a:	00003697          	auipc	a3,0x3
ffffffffc020283e:	6a668693          	addi	a3,a3,1702 # ffffffffc0205ee0 <default_pmm_manager+0x2e8>
ffffffffc0202842:	00003617          	auipc	a2,0x3
ffffffffc0202846:	00660613          	addi	a2,a2,6 # ffffffffc0205848 <commands+0x738>
ffffffffc020284a:	18100593          	li	a1,385
ffffffffc020284e:	00003517          	auipc	a0,0x3
ffffffffc0202852:	4fa50513          	addi	a0,a0,1274 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc0202856:	bf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020285a:	00003697          	auipc	a3,0x3
ffffffffc020285e:	7de68693          	addi	a3,a3,2014 # ffffffffc0206038 <default_pmm_manager+0x440>
ffffffffc0202862:	00003617          	auipc	a2,0x3
ffffffffc0202866:	fe660613          	addi	a2,a2,-26 # ffffffffc0205848 <commands+0x738>
ffffffffc020286a:	17e00593          	li	a1,382
ffffffffc020286e:	00003517          	auipc	a0,0x3
ffffffffc0202872:	4da50513          	addi	a0,a0,1242 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc0202876:	bd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020287a:	00003697          	auipc	a3,0x3
ffffffffc020287e:	64e68693          	addi	a3,a3,1614 # ffffffffc0205ec8 <default_pmm_manager+0x2d0>
ffffffffc0202882:	00003617          	auipc	a2,0x3
ffffffffc0202886:	fc660613          	addi	a2,a2,-58 # ffffffffc0205848 <commands+0x738>
ffffffffc020288a:	17d00593          	li	a1,381
ffffffffc020288e:	00003517          	auipc	a0,0x3
ffffffffc0202892:	4ba50513          	addi	a0,a0,1210 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc0202896:	bb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc020289a:	00003617          	auipc	a2,0x3
ffffffffc020289e:	39660613          	addi	a2,a2,918 # ffffffffc0205c30 <default_pmm_manager+0x38>
ffffffffc02028a2:	06900593          	li	a1,105
ffffffffc02028a6:	00003517          	auipc	a0,0x3
ffffffffc02028aa:	3b250513          	addi	a0,a0,946 # ffffffffc0205c58 <default_pmm_manager+0x60>
ffffffffc02028ae:	b99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02028b2:	00003697          	auipc	a3,0x3
ffffffffc02028b6:	7b668693          	addi	a3,a3,1974 # ffffffffc0206068 <default_pmm_manager+0x470>
ffffffffc02028ba:	00003617          	auipc	a2,0x3
ffffffffc02028be:	f8e60613          	addi	a2,a2,-114 # ffffffffc0205848 <commands+0x738>
ffffffffc02028c2:	18800593          	li	a1,392
ffffffffc02028c6:	00003517          	auipc	a0,0x3
ffffffffc02028ca:	48250513          	addi	a0,a0,1154 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc02028ce:	b79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02028d2:	00003697          	auipc	a3,0x3
ffffffffc02028d6:	74e68693          	addi	a3,a3,1870 # ffffffffc0206020 <default_pmm_manager+0x428>
ffffffffc02028da:	00003617          	auipc	a2,0x3
ffffffffc02028de:	f6e60613          	addi	a2,a2,-146 # ffffffffc0205848 <commands+0x738>
ffffffffc02028e2:	18600593          	li	a1,390
ffffffffc02028e6:	00003517          	auipc	a0,0x3
ffffffffc02028ea:	46250513          	addi	a0,a0,1122 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc02028ee:	b59fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc02028f2:	00003697          	auipc	a3,0x3
ffffffffc02028f6:	75e68693          	addi	a3,a3,1886 # ffffffffc0206050 <default_pmm_manager+0x458>
ffffffffc02028fa:	00003617          	auipc	a2,0x3
ffffffffc02028fe:	f4e60613          	addi	a2,a2,-178 # ffffffffc0205848 <commands+0x738>
ffffffffc0202902:	18500593          	li	a1,389
ffffffffc0202906:	00003517          	auipc	a0,0x3
ffffffffc020290a:	44250513          	addi	a0,a0,1090 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc020290e:	b39fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202912:	00003697          	auipc	a3,0x3
ffffffffc0202916:	70e68693          	addi	a3,a3,1806 # ffffffffc0206020 <default_pmm_manager+0x428>
ffffffffc020291a:	00003617          	auipc	a2,0x3
ffffffffc020291e:	f2e60613          	addi	a2,a2,-210 # ffffffffc0205848 <commands+0x738>
ffffffffc0202922:	18200593          	li	a1,386
ffffffffc0202926:	00003517          	auipc	a0,0x3
ffffffffc020292a:	42250513          	addi	a0,a0,1058 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc020292e:	b19fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202932:	00004697          	auipc	a3,0x4
ffffffffc0202936:	84668693          	addi	a3,a3,-1978 # ffffffffc0206178 <default_pmm_manager+0x580>
ffffffffc020293a:	00003617          	auipc	a2,0x3
ffffffffc020293e:	f0e60613          	addi	a2,a2,-242 # ffffffffc0205848 <commands+0x738>
ffffffffc0202942:	1a600593          	li	a1,422
ffffffffc0202946:	00003517          	auipc	a0,0x3
ffffffffc020294a:	40250513          	addi	a0,a0,1026 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc020294e:	af9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202952:	00003697          	auipc	a3,0x3
ffffffffc0202956:	7ee68693          	addi	a3,a3,2030 # ffffffffc0206140 <default_pmm_manager+0x548>
ffffffffc020295a:	00003617          	auipc	a2,0x3
ffffffffc020295e:	eee60613          	addi	a2,a2,-274 # ffffffffc0205848 <commands+0x738>
ffffffffc0202962:	1a500593          	li	a1,421
ffffffffc0202966:	00003517          	auipc	a0,0x3
ffffffffc020296a:	3e250513          	addi	a0,a0,994 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc020296e:	ad9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202972:	00003697          	auipc	a3,0x3
ffffffffc0202976:	7b668693          	addi	a3,a3,1974 # ffffffffc0206128 <default_pmm_manager+0x530>
ffffffffc020297a:	00003617          	auipc	a2,0x3
ffffffffc020297e:	ece60613          	addi	a2,a2,-306 # ffffffffc0205848 <commands+0x738>
ffffffffc0202982:	1a100593          	li	a1,417
ffffffffc0202986:	00003517          	auipc	a0,0x3
ffffffffc020298a:	3c250513          	addi	a0,a0,962 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc020298e:	ab9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202992:	00003697          	auipc	a3,0x3
ffffffffc0202996:	6fe68693          	addi	a3,a3,1790 # ffffffffc0206090 <default_pmm_manager+0x498>
ffffffffc020299a:	00003617          	auipc	a2,0x3
ffffffffc020299e:	eae60613          	addi	a2,a2,-338 # ffffffffc0205848 <commands+0x738>
ffffffffc02029a2:	19000593          	li	a1,400
ffffffffc02029a6:	00003517          	auipc	a0,0x3
ffffffffc02029aa:	3a250513          	addi	a0,a0,930 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc02029ae:	a99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02029b2:	00003697          	auipc	a3,0x3
ffffffffc02029b6:	51668693          	addi	a3,a3,1302 # ffffffffc0205ec8 <default_pmm_manager+0x2d0>
ffffffffc02029ba:	00003617          	auipc	a2,0x3
ffffffffc02029be:	e8e60613          	addi	a2,a2,-370 # ffffffffc0205848 <commands+0x738>
ffffffffc02029c2:	16a00593          	li	a1,362
ffffffffc02029c6:	00003517          	auipc	a0,0x3
ffffffffc02029ca:	38250513          	addi	a0,a0,898 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc02029ce:	a79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc02029d2:	00003617          	auipc	a2,0x3
ffffffffc02029d6:	25e60613          	addi	a2,a2,606 # ffffffffc0205c30 <default_pmm_manager+0x38>
ffffffffc02029da:	16d00593          	li	a1,365
ffffffffc02029de:	00003517          	auipc	a0,0x3
ffffffffc02029e2:	36a50513          	addi	a0,a0,874 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc02029e6:	a61fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02029ea:	00003697          	auipc	a3,0x3
ffffffffc02029ee:	4f668693          	addi	a3,a3,1270 # ffffffffc0205ee0 <default_pmm_manager+0x2e8>
ffffffffc02029f2:	00003617          	auipc	a2,0x3
ffffffffc02029f6:	e5660613          	addi	a2,a2,-426 # ffffffffc0205848 <commands+0x738>
ffffffffc02029fa:	16b00593          	li	a1,363
ffffffffc02029fe:	00003517          	auipc	a0,0x3
ffffffffc0202a02:	34a50513          	addi	a0,a0,842 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc0202a06:	a41fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202a0a:	00003697          	auipc	a3,0x3
ffffffffc0202a0e:	54e68693          	addi	a3,a3,1358 # ffffffffc0205f58 <default_pmm_manager+0x360>
ffffffffc0202a12:	00003617          	auipc	a2,0x3
ffffffffc0202a16:	e3660613          	addi	a2,a2,-458 # ffffffffc0205848 <commands+0x738>
ffffffffc0202a1a:	17300593          	li	a1,371
ffffffffc0202a1e:	00003517          	auipc	a0,0x3
ffffffffc0202a22:	32a50513          	addi	a0,a0,810 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc0202a26:	a21fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a2a:	00004697          	auipc	a3,0x4
ffffffffc0202a2e:	80e68693          	addi	a3,a3,-2034 # ffffffffc0206238 <default_pmm_manager+0x640>
ffffffffc0202a32:	00003617          	auipc	a2,0x3
ffffffffc0202a36:	e1660613          	addi	a2,a2,-490 # ffffffffc0205848 <commands+0x738>
ffffffffc0202a3a:	1af00593          	li	a1,431
ffffffffc0202a3e:	00003517          	auipc	a0,0x3
ffffffffc0202a42:	30a50513          	addi	a0,a0,778 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc0202a46:	a01fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202a4a:	00003697          	auipc	a3,0x3
ffffffffc0202a4e:	7b668693          	addi	a3,a3,1974 # ffffffffc0206200 <default_pmm_manager+0x608>
ffffffffc0202a52:	00003617          	auipc	a2,0x3
ffffffffc0202a56:	df660613          	addi	a2,a2,-522 # ffffffffc0205848 <commands+0x738>
ffffffffc0202a5a:	1ac00593          	li	a1,428
ffffffffc0202a5e:	00003517          	auipc	a0,0x3
ffffffffc0202a62:	2ea50513          	addi	a0,a0,746 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc0202a66:	9e1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202a6a:	00003697          	auipc	a3,0x3
ffffffffc0202a6e:	76668693          	addi	a3,a3,1894 # ffffffffc02061d0 <default_pmm_manager+0x5d8>
ffffffffc0202a72:	00003617          	auipc	a2,0x3
ffffffffc0202a76:	dd660613          	addi	a2,a2,-554 # ffffffffc0205848 <commands+0x738>
ffffffffc0202a7a:	1a800593          	li	a1,424
ffffffffc0202a7e:	00003517          	auipc	a0,0x3
ffffffffc0202a82:	2ca50513          	addi	a0,a0,714 # ffffffffc0205d48 <default_pmm_manager+0x150>
...
ffffffffc0202af4:	79068693          	addi	a3,a3,1936 # ffffffffc0206280 <default_pmm_manager+0x688>
ffffffffc0202af8:	00003617          	auipc	a2,0x3
ffffffffc0202afc:	d5060613          	addi	a2,a2,-688 # ffffffffc0205848 <commands+0x738>
ffffffffc0202b00:	14800593          	li	a1,328
ffffffffc0202b04:	00003517          	auipc	a0,0x3
ffffffffc0202b08:	24450513          	addi	a0,a0,580 # ffffffffc0205d48 <default_pmm_manager+0x150>
...
ffffffffc0202b4e:	1b660613          	addi	a2,a2,438 # ffffffffc0205d00 <default_pmm_manager+0x108>
ffffffffc0202b52:	06200593          	li	a1,98
ffffffffc0202b56:	00003517          	auipc	a0,0x3
ffffffffc0202b5a:	10250513          	addi	a0,a0,258 # ffffffffc0205c58 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0202bde:	6ee50513          	addi	a0,a0,1774 # ffffffffc02062c8 <default_pmm_manager+0x6d0>
    return listelm->next;
...
ffffffffc0202c30:	6b450513          	addi	a0,a0,1716 # ffffffffc02062e0 <default_pmm_manager+0x6e8>
...
ffffffffc0202c84:	6d050513          	addi	a0,a0,1744 # ffffffffc0206350 <default_pmm_manager+0x758>
...
ffffffffc0202ca0:	70450513          	addi	a0,a0,1796 # ffffffffc02063a0 <default_pmm_manager+0x7a8>
...
ffffffffc0202d14:	71850513          	addi	a0,a0,1816 # ffffffffc0206428 <default_pmm_manager+0x830>
...
ffffffffc0202e58:	67c50513          	addi	a0,a0,1660 # ffffffffc02064d0 <default_pmm_manager+0x8d8>
...
ffffffffc0202f2c:	5f850513          	addi	a0,a0,1528 # ffffffffc0206520 <default_pmm_manager+0x928>
...
ffffffffc0202f3e:	8fe68693          	addi	a3,a3,-1794 # ffffffffc0205838 <commands+0x728>
ffffffffc0202f42:	00003617          	auipc	a2,0x3
ffffffffc0202f46:	90660613          	addi	a2,a2,-1786 # ffffffffc0205848 <commands+0x738>
ffffffffc0202f4a:	0bd00593          	li	a1,189
ffffffffc0202f4e:	00003517          	auipc	a0,0x3
ffffffffc0202f52:	36a50513          	addi	a0,a0,874 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
...
ffffffffc0202f62:	da260613          	addi	a2,a2,-606 # ffffffffc0205d00 <default_pmm_manager+0x108>
ffffffffc0202f66:	06200593          	li	a1,98
ffffffffc0202f6a:	00003517          	auipc	a0,0x3
ffffffffc0202f6e:	cee50513          	addi	a0,a0,-786 # ffffffffc0205c58 <default_pmm_manager+0x60>
ffffffffc0202f72:	cd4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202f76:	00003697          	auipc	a3,0x3
ffffffffc0202f7a:	53268693          	addi	a3,a3,1330 # ffffffffc02064a8 <default_pmm_manager+0x8b0>
ffffffffc0202f7e:	00003617          	auipc	a2,0x3
ffffffffc0202f82:	8ca60613          	addi	a2,a2,-1846 # ffffffffc0205848 <commands+0x738>
ffffffffc0202f86:	0fd00593          	li	a1,253
ffffffffc0202f8a:	00003517          	auipc	a0,0x3
ffffffffc0202f8e:	32e50513          	addi	a0,a0,814 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc0202f92:	cb4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202f96:	00003697          	auipc	a3,0x3
ffffffffc0202f9a:	43268693          	addi	a3,a3,1074 # ffffffffc02063c8 <default_pmm_manager+0x7d0>
ffffffffc0202f9e:	00003617          	auipc	a2,0x3
ffffffffc0202fa2:	8aa60613          	addi	a2,a2,-1878 # ffffffffc0205848 <commands+0x738>
ffffffffc0202fa6:	0dd00593          	li	a1,221
ffffffffc0202faa:	00003517          	auipc	a0,0x3
ffffffffc0202fae:	30e50513          	addi	a0,a0,782 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc0202fb2:	c94fd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202fb6:	00003617          	auipc	a2,0x3
ffffffffc0202fba:	2e260613          	addi	a2,a2,738 # ffffffffc0206298 <default_pmm_manager+0x6a0>
ffffffffc0202fbe:	02a00593          	li	a1,42
ffffffffc0202fc2:	00003517          	auipc	a0,0x3
ffffffffc0202fc6:	2f650513          	addi	a0,a0,758 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc0202fca:	c7cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202fce:	00003697          	auipc	a3,0x3
ffffffffc0202fd2:	4c268693          	addi	a3,a3,1218 # ffffffffc0206490 <default_pmm_manager+0x898>
ffffffffc0202fd6:	00003617          	auipc	a2,0x3
ffffffffc0202fda:	87260613          	addi	a2,a2,-1934 # ffffffffc0205848 <commands+0x738>
ffffffffc0202fde:	0fc00593          	li	a1,252
ffffffffc0202fe2:	00003517          	auipc	a0,0x3
ffffffffc0202fe6:	2d650513          	addi	a0,a0,726 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc0202fea:	c5cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202fee:	00003617          	auipc	a2,0x3
ffffffffc0202ff2:	d3260613          	addi	a2,a2,-718 # ffffffffc0205d20 <default_pmm_manager+0x128>
ffffffffc0202ff6:	07400593          	li	a1,116
ffffffffc0202ffa:	00003517          	auipc	a0,0x3
ffffffffc0202ffe:	c5e50513          	addi	a0,a0,-930 # ffffffffc0205c58 <default_pmm_manager+0x60>
ffffffffc0203002:	c44fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0203006:	00003697          	auipc	a3,0x3
ffffffffc020300a:	3da68693          	addi	a3,a3,986 # ffffffffc02063e0 <default_pmm_manager+0x7e8>
ffffffffc020300e:	00003617          	auipc	a2,0x3
ffffffffc0203012:	83a60613          	addi	a2,a2,-1990 # ffffffffc0205848 <commands+0x738>
ffffffffc0203016:	0de00593          	li	a1,222
ffffffffc020301a:	00003517          	auipc	a0,0x3
ffffffffc020301e:	29e50513          	addi	a0,a0,670 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc0203022:	c24fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203026:	00003697          	auipc	a3,0x3
ffffffffc020302a:	2f268693          	addi	a3,a3,754 # ffffffffc0206318 <default_pmm_manager+0x720>
ffffffffc020302e:	00003617          	auipc	a2,0x3
ffffffffc0203032:	81a60613          	addi	a2,a2,-2022 # ffffffffc0205848 <commands+0x738>
ffffffffc0203036:	0c800593          	li	a1,200
ffffffffc020303a:	00003517          	auipc	a0,0x3
ffffffffc020303e:	27e50513          	addi	a0,a0,638 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc0203042:	c04fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total == nr_free_pages());
ffffffffc0203046:	00003697          	auipc	a3,0x3
ffffffffc020304a:	83268693          	addi	a3,a3,-1998 # ffffffffc0205878 <commands+0x768>
ffffffffc020304e:	00002617          	auipc	a2,0x2
ffffffffc0203052:	7fa60613          	addi	a2,a2,2042 # ffffffffc0205848 <commands+0x738>
ffffffffc0203056:	0c000593          	li	a1,192
ffffffffc020305a:	00003517          	auipc	a0,0x3
ffffffffc020305e:	25e50513          	addi	a0,a0,606 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc0203062:	be4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert( nr_free == 0);         
ffffffffc0203066:	00003697          	auipc	a3,0x3
ffffffffc020306a:	9ba68693          	addi	a3,a3,-1606 # ffffffffc0205a20 <commands+0x910>
ffffffffc020306e:	00002617          	auipc	a2,0x2
ffffffffc0203072:	7da60613          	addi	a2,a2,2010 # ffffffffc0205848 <commands+0x738>
ffffffffc0203076:	0f400593          	li	a1,244
ffffffffc020307a:	00003517          	auipc	a0,0x3
ffffffffc020307e:	23e50513          	addi	a0,a0,574 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc0203082:	bc4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203086:	00003697          	auipc	a3,0x3
ffffffffc020308a:	2aa68693          	addi	a3,a3,682 # ffffffffc0206330 <default_pmm_manager+0x738>
ffffffffc020308e:	00002617          	auipc	a2,0x2
ffffffffc0203092:	7ba60613          	addi	a2,a2,1978 # ffffffffc0205848 <commands+0x738>
ffffffffc0203096:	0cd00593          	li	a1,205
ffffffffc020309a:	00003517          	auipc	a0,0x3
ffffffffc020309e:	21e50513          	addi	a0,a0,542 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc02030a2:	ba4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(mm != NULL);
ffffffffc02030a6:	00003697          	auipc	a3,0x3
ffffffffc02030aa:	26268693          	addi	a3,a3,610 # ffffffffc0206308 <default_pmm_manager+0x710>
ffffffffc02030ae:	00002617          	auipc	a2,0x2
ffffffffc02030b2:	79a60613          	addi	a2,a2,1946 # ffffffffc0205848 <commands+0x738>
ffffffffc02030b6:	0c500593          	li	a1,197
ffffffffc02030ba:	00003517          	auipc	a0,0x3
ffffffffc02030be:	1fe50513          	addi	a0,a0,510 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc02030c2:	b84fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total==0);
ffffffffc02030c6:	00003697          	auipc	a3,0x3
ffffffffc02030ca:	44a68693          	addi	a3,a3,1098 # ffffffffc0206510 <default_pmm_manager+0x918>
ffffffffc02030ce:	00002617          	auipc	a2,0x2
ffffffffc02030d2:	77a60613          	addi	a2,a2,1914 # ffffffffc0205848 <commands+0x738>
ffffffffc02030d6:	11d00593          	li	a1,285
ffffffffc02030da:	00003517          	auipc	a0,0x3
ffffffffc02030de:	1de50513          	addi	a0,a0,478 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc02030e2:	b64fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc02030e6:	00003617          	auipc	a2,0x3
ffffffffc02030ea:	b4a60613          	addi	a2,a2,-1206 # ffffffffc0205c30 <default_pmm_manager+0x38>
ffffffffc02030ee:	06900593          	li	a1,105
ffffffffc02030f2:	00003517          	auipc	a0,0x3
ffffffffc02030f6:	b6650513          	addi	a0,a0,-1178 # ffffffffc0205c58 <default_pmm_manager+0x60>
ffffffffc02030fa:	b4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(count==0);
ffffffffc02030fe:	00003697          	auipc	a3,0x3
ffffffffc0203102:	40268693          	addi	a3,a3,1026 # ffffffffc0206500 <default_pmm_manager+0x908>
ffffffffc0203106:	00002617          	auipc	a2,0x2
ffffffffc020310a:	74260613          	addi	a2,a2,1858 # ffffffffc0205848 <commands+0x738>
ffffffffc020310e:	11c00593          	li	a1,284
ffffffffc0203112:	00003517          	auipc	a0,0x3
ffffffffc0203116:	1a650513          	addi	a0,a0,422 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc020311a:	b2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020311e:	00003697          	auipc	a3,0x3
ffffffffc0203122:	33268693          	addi	a3,a3,818 # ffffffffc0206450 <default_pmm_manager+0x858>
ffffffffc0203126:	00002617          	auipc	a2,0x2
ffffffffc020312a:	72260613          	addi	a2,a2,1826 # ffffffffc0205848 <commands+0x738>
ffffffffc020312e:	09600593          	li	a1,150
ffffffffc0203132:	00003517          	auipc	a0,0x3
ffffffffc0203136:	18650513          	addi	a0,a0,390 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc020313a:	b0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc020313e:	00003697          	auipc	a3,0x3
ffffffffc0203142:	2c268693          	addi	a3,a3,706 # ffffffffc0206400 <default_pmm_manager+0x808>
ffffffffc0203146:	00002617          	auipc	a2,0x2
ffffffffc020314a:	70260613          	addi	a2,a2,1794 # ffffffffc0205848 <commands+0x738>
ffffffffc020314e:	0eb00593          	li	a1,235
ffffffffc0203152:	00003517          	auipc	a0,0x3
ffffffffc0203156:	16650513          	addi	a0,a0,358 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc020315a:	aecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc020315e:	00003697          	auipc	a3,0x3
ffffffffc0203162:	22a68693          	addi	a3,a3,554 # ffffffffc0206388 <default_pmm_manager+0x790>
ffffffffc0203166:	00002617          	auipc	a2,0x2
ffffffffc020316a:	6e260613          	addi	a2,a2,1762 # ffffffffc0205848 <commands+0x738>
ffffffffc020316e:	0d800593          	li	a1,216
ffffffffc0203172:	00003517          	auipc	a0,0x3
ffffffffc0203176:	14650513          	addi	a0,a0,326 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc020317a:	accfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(ret==0);
ffffffffc020317e:	00003697          	auipc	a3,0x3
ffffffffc0203182:	37a68693          	addi	a3,a3,890 # ffffffffc02064f8 <default_pmm_manager+0x900>
ffffffffc0203186:	00002617          	auipc	a2,0x2
ffffffffc020318a:	6c260613          	addi	a2,a2,1730 # ffffffffc0205848 <commands+0x738>
ffffffffc020318e:	10300593          	li	a1,259
ffffffffc0203192:	00003517          	auipc	a0,0x3
ffffffffc0203196:	12650513          	addi	a0,a0,294 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc020319a:	aacfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(vma != NULL);
ffffffffc020319e:	00003697          	auipc	a3,0x3
ffffffffc02031a2:	1a268693          	addi	a3,a3,418 # ffffffffc0206340 <default_pmm_manager+0x748>
ffffffffc02031a6:	00002617          	auipc	a2,0x2
ffffffffc02031aa:	6a260613          	addi	a2,a2,1698 # ffffffffc0205848 <commands+0x738>
ffffffffc02031ae:	0d000593          	li	a1,208
ffffffffc02031b2:	00003517          	auipc	a0,0x3
ffffffffc02031b6:	10650513          	addi	a0,a0,262 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc02031ba:	a8cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031be:	00003697          	auipc	a3,0x3
ffffffffc02031c2:	2c268693          	addi	a3,a3,706 # ffffffffc0206480 <default_pmm_manager+0x888>
ffffffffc02031c6:	00002617          	auipc	a2,0x2
ffffffffc02031ca:	68260613          	addi	a2,a2,1666 # ffffffffc0205848 <commands+0x738>
ffffffffc02031ce:	0a000593          	li	a1,160
ffffffffc02031d2:	00003517          	auipc	a0,0x3
ffffffffc02031d6:	0e650513          	addi	a0,a0,230 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc02031da:	a6cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031de:	00003697          	auipc	a3,0x3
ffffffffc02031e2:	2a268693          	addi	a3,a3,674 # ffffffffc0206480 <default_pmm_manager+0x888>
ffffffffc02031e6:	00002617          	auipc	a2,0x2
ffffffffc02031ea:	66260613          	addi	a2,a2,1634 # ffffffffc0205848 <commands+0x738>
ffffffffc02031ee:	0a200593          	li	a1,162
ffffffffc02031f2:	00003517          	auipc	a0,0x3
ffffffffc02031f6:	0c650513          	addi	a0,a0,198 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc02031fa:	a4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc02031fe:	00003697          	auipc	a3,0x3
ffffffffc0203202:	26268693          	addi	a3,a3,610 # ffffffffc0206460 <default_pmm_manager+0x868>
ffffffffc0203206:	00002617          	auipc	a2,0x2
ffffffffc020320a:	64260613          	addi	a2,a2,1602 # ffffffffc0205848 <commands+0x738>
ffffffffc020320e:	09800593          	li	a1,152
ffffffffc0203212:	00003517          	auipc	a0,0x3
ffffffffc0203216:	0a650513          	addi	a0,a0,166 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc020321a:	a2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc020321e:	00003697          	auipc	a3,0x3
ffffffffc0203222:	24268693          	addi	a3,a3,578 # ffffffffc0206460 <default_pmm_manager+0x868>
ffffffffc0203226:	00002617          	auipc	a2,0x2
ffffffffc020322a:	62260613          	addi	a2,a2,1570 # ffffffffc0205848 <commands+0x738>
ffffffffc020322e:	09a00593          	li	a1,154
ffffffffc0203232:	00003517          	auipc	a0,0x3
ffffffffc0203236:	08650513          	addi	a0,a0,134 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc020323a:	a0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020323e:	00003697          	auipc	a3,0x3
ffffffffc0203242:	23268693          	addi	a3,a3,562 # ffffffffc0206470 <default_pmm_manager+0x878>
ffffffffc0203246:	00002617          	auipc	a2,0x2
ffffffffc020324a:	60260613          	addi	a2,a2,1538 # ffffffffc0205848 <commands+0x738>
ffffffffc020324e:	09c00593          	li	a1,156
ffffffffc0203252:	00003517          	auipc	a0,0x3
ffffffffc0203256:	06650513          	addi	a0,a0,102 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc020325a:	9ecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020325e:	00003697          	auipc	a3,0x3
ffffffffc0203262:	21268693          	addi	a3,a3,530 # ffffffffc0206470 <default_pmm_manager+0x878>
ffffffffc0203266:	00002617          	auipc	a2,0x2
ffffffffc020326a:	5e260613          	addi	a2,a2,1506 # ffffffffc0205848 <commands+0x738>
ffffffffc020326e:	09e00593          	li	a1,158
ffffffffc0203272:	00003517          	auipc	a0,0x3
ffffffffc0203276:	04650513          	addi	a0,a0,70 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
ffffffffc020327a:	9ccfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020327e:	00003697          	auipc	a3,0x3
ffffffffc0203282:	1d268693          	addi	a3,a3,466 # ffffffffc0206450 <default_pmm_manager+0x858>
ffffffffc0203286:	00002617          	auipc	a2,0x2
ffffffffc020328a:	5c260613          	addi	a2,a2,1474 # ffffffffc0205848 <commands+0x738>
ffffffffc020328e:	09400593          	li	a1,148
ffffffffc0203292:	00003517          	auipc	a0,0x3
ffffffffc0203296:	02650513          	addi	a0,a0,38 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
...
ffffffffc02032e2:	2c2b0b13          	addi	s6,s6,706 # ffffffffc02065a0 <default_pmm_manager+0x9a8>
                    cprintf("SWAP: failed to save\n");
ffffffffc02032e6:	00003b97          	auipc	s7,0x3
ffffffffc02032ea:	2a2b8b93          	addi	s7,s7,674 # ffffffffc0206588 <default_pmm_manager+0x990>
...
ffffffffc020339c:	1a850513          	addi	a0,a0,424 # ffffffffc0206540 <default_pmm_manager+0x948>
...
ffffffffc02033ae:	1c668693          	addi	a3,a3,454 # ffffffffc0206570 <default_pmm_manager+0x978>
ffffffffc02033b2:	00002617          	auipc	a2,0x2
ffffffffc02033b6:	49660613          	addi	a2,a2,1174 # ffffffffc0205848 <commands+0x738>
ffffffffc02033ba:	06900593          	li	a1,105
ffffffffc02033be:	00003517          	auipc	a0,0x3
ffffffffc02033c2:	efa50513          	addi	a0,a0,-262 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
...
ffffffffc0203406:	1ee50513          	addi	a0,a0,494 # ffffffffc02065f0 <default_pmm_manager+0x9f8>
...
ffffffffc0203428:	1bc68693          	addi	a3,a3,444 # ffffffffc02065e0 <default_pmm_manager+0x9e8>
ffffffffc020342c:	00002617          	auipc	a2,0x2
ffffffffc0203430:	41c60613          	addi	a2,a2,1052 # ffffffffc0205848 <commands+0x738>
ffffffffc0203434:	07f00593          	li	a1,127
ffffffffc0203438:	00003517          	auipc	a0,0x3
ffffffffc020343c:	e8050513          	addi	a0,a0,-384 # ffffffffc02062b8 <default_pmm_manager+0x6c0>
...
ffffffffc020346c:	1c850513          	addi	a0,a0,456 # ffffffffc0206630 <default_pmm_manager+0xa38>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc02034a2:	1d250513          	addi	a0,a0,466 # ffffffffc0206670 <default_pmm_manager+0xa78>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02034c6:	1d650513          	addi	a0,a0,470 # ffffffffc0206698 <default_pmm_manager+0xaa0>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc02034e4:	1e050513          	addi	a0,a0,480 # ffffffffc02066c0 <default_pmm_manager+0xac8>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203500:	1ec50513          	addi	a0,a0,492 # ffffffffc02066e8 <default_pmm_manager+0xaf0>
...
ffffffffc020351e:	1a650513          	addi	a0,a0,422 # ffffffffc02066c0 <default_pmm_manager+0xac8>
...
ffffffffc0203536:	13e50513          	addi	a0,a0,318 # ffffffffc0206670 <default_pmm_manager+0xa78>
...
ffffffffc0203550:	17450513          	addi	a0,a0,372 # ffffffffc02066c0 <default_pmm_manager+0xac8>
...
ffffffffc020356a:	0ca50513          	addi	a0,a0,202 # ffffffffc0206630 <default_pmm_manager+0xa38>
...
ffffffffc0203584:	11850513          	addi	a0,a0,280 # ffffffffc0206698 <default_pmm_manager+0xaa0>
...
ffffffffc020359e:	14e50513          	addi	a0,a0,334 # ffffffffc02066e8 <default_pmm_manager+0xaf0>
...
ffffffffc02035bc:	0b850513          	addi	a0,a0,184 # ffffffffc0206670 <default_pmm_manager+0xa78>
...
ffffffffc02035fa:	e8a68693          	addi	a3,a3,-374 # ffffffffc0206480 <default_pmm_manager+0x888>
ffffffffc02035fe:	00002617          	auipc	a2,0x2
ffffffffc0203602:	24a60613          	addi	a2,a2,586 # ffffffffc0205848 <commands+0x738>
ffffffffc0203606:	05100593          	li	a1,81
ffffffffc020360a:	00003517          	auipc	a0,0x3
ffffffffc020360e:	04e50513          	addi	a0,a0,78 # ffffffffc0206658 <default_pmm_manager+0xa60>
ffffffffc0203612:	e35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==11);
ffffffffc0203616:	00003697          	auipc	a3,0x3
ffffffffc020361a:	18268693          	addi	a3,a3,386 # ffffffffc0206798 <default_pmm_manager+0xba0>
ffffffffc020361e:	00002617          	auipc	a2,0x2
ffffffffc0203622:	22a60613          	addi	a2,a2,554 # ffffffffc0205848 <commands+0x738>
ffffffffc0203626:	07300593          	li	a1,115
ffffffffc020362a:	00003517          	auipc	a0,0x3
ffffffffc020362e:	02e50513          	addi	a0,a0,46 # ffffffffc0206658 <default_pmm_manager+0xa60>
ffffffffc0203632:	e15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203636:	00003697          	auipc	a3,0x3
ffffffffc020363a:	13a68693          	addi	a3,a3,314 # ffffffffc0206770 <default_pmm_manager+0xb78>
ffffffffc020363e:	00002617          	auipc	a2,0x2
ffffffffc0203642:	20a60613          	addi	a2,a2,522 # ffffffffc0205848 <commands+0x738>
ffffffffc0203646:	07100593          	li	a1,113
ffffffffc020364a:	00003517          	auipc	a0,0x3
ffffffffc020364e:	00e50513          	addi	a0,a0,14 # ffffffffc0206658 <default_pmm_manager+0xa60>
ffffffffc0203652:	df5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==10);
ffffffffc0203656:	00003697          	auipc	a3,0x3
ffffffffc020365a:	10a68693          	addi	a3,a3,266 # ffffffffc0206760 <default_pmm_manager+0xb68>
ffffffffc020365e:	00002617          	auipc	a2,0x2
ffffffffc0203662:	1ea60613          	addi	a2,a2,490 # ffffffffc0205848 <commands+0x738>
ffffffffc0203666:	06f00593          	li	a1,111
ffffffffc020366a:	00003517          	auipc	a0,0x3
ffffffffc020366e:	fee50513          	addi	a0,a0,-18 # ffffffffc0206658 <default_pmm_manager+0xa60>
ffffffffc0203672:	dd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==9);
ffffffffc0203676:	00003697          	auipc	a3,0x3
ffffffffc020367a:	0da68693          	addi	a3,a3,218 # ffffffffc0206750 <default_pmm_manager+0xb58>
ffffffffc020367e:	00002617          	auipc	a2,0x2
ffffffffc0203682:	1ca60613          	addi	a2,a2,458 # ffffffffc0205848 <commands+0x738>
ffffffffc0203686:	06c00593          	li	a1,108
ffffffffc020368a:	00003517          	auipc	a0,0x3
ffffffffc020368e:	fce50513          	addi	a0,a0,-50 # ffffffffc0206658 <default_pmm_manager+0xa60>
ffffffffc0203692:	db5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==8);
ffffffffc0203696:	00003697          	auipc	a3,0x3
ffffffffc020369a:	0aa68693          	addi	a3,a3,170 # ffffffffc0206740 <default_pmm_manager+0xb48>
ffffffffc020369e:	00002617          	auipc	a2,0x2
ffffffffc02036a2:	1aa60613          	addi	a2,a2,426 # ffffffffc0205848 <commands+0x738>
ffffffffc02036a6:	06900593          	li	a1,105
ffffffffc02036aa:	00003517          	auipc	a0,0x3
ffffffffc02036ae:	fae50513          	addi	a0,a0,-82 # ffffffffc0206658 <default_pmm_manager+0xa60>
ffffffffc02036b2:	d95fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==7);
ffffffffc02036b6:	00003697          	auipc	a3,0x3
ffffffffc02036ba:	07a68693          	addi	a3,a3,122 # ffffffffc0206730 <default_pmm_manager+0xb38>
ffffffffc02036be:	00002617          	auipc	a2,0x2
ffffffffc02036c2:	18a60613          	addi	a2,a2,394 # ffffffffc0205848 <commands+0x738>
ffffffffc02036c6:	06600593          	li	a1,102
ffffffffc02036ca:	00003517          	auipc	a0,0x3
ffffffffc02036ce:	f8e50513          	addi	a0,a0,-114 # ffffffffc0206658 <default_pmm_manager+0xa60>
ffffffffc02036d2:	d75fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==6);
ffffffffc02036d6:	00003697          	auipc	a3,0x3
ffffffffc02036da:	04a68693          	addi	a3,a3,74 # ffffffffc0206720 <default_pmm_manager+0xb28>
ffffffffc02036de:	00002617          	auipc	a2,0x2
ffffffffc02036e2:	16a60613          	addi	a2,a2,362 # ffffffffc0205848 <commands+0x738>
ffffffffc02036e6:	06300593          	li	a1,99
ffffffffc02036ea:	00003517          	auipc	a0,0x3
ffffffffc02036ee:	f6e50513          	addi	a0,a0,-146 # ffffffffc0206658 <default_pmm_manager+0xa60>
ffffffffc02036f2:	d55fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc02036f6:	00003697          	auipc	a3,0x3
ffffffffc02036fa:	01a68693          	addi	a3,a3,26 # ffffffffc0206710 <default_pmm_manager+0xb18>
ffffffffc02036fe:	00002617          	auipc	a2,0x2
ffffffffc0203702:	14a60613          	addi	a2,a2,330 # ffffffffc0205848 <commands+0x738>
ffffffffc0203706:	06000593          	li	a1,96
ffffffffc020370a:	00003517          	auipc	a0,0x3
ffffffffc020370e:	f4e50513          	addi	a0,a0,-178 # ffffffffc0206658 <default_pmm_manager+0xa60>
ffffffffc0203712:	d35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc0203716:	00003697          	auipc	a3,0x3
ffffffffc020371a:	ffa68693          	addi	a3,a3,-6 # ffffffffc0206710 <default_pmm_manager+0xb18>
ffffffffc020371e:	00002617          	auipc	a2,0x2
ffffffffc0203722:	12a60613          	addi	a2,a2,298 # ffffffffc0205848 <commands+0x738>
ffffffffc0203726:	05d00593          	li	a1,93
ffffffffc020372a:	00003517          	auipc	a0,0x3
ffffffffc020372e:	f2e50513          	addi	a0,a0,-210 # ffffffffc0206658 <default_pmm_manager+0xa60>
ffffffffc0203732:	d15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203736:	00003697          	auipc	a3,0x3
ffffffffc020373a:	d4a68693          	addi	a3,a3,-694 # ffffffffc0206480 <default_pmm_manager+0x888>
ffffffffc020373e:	00002617          	auipc	a2,0x2
ffffffffc0203742:	10a60613          	addi	a2,a2,266 # ffffffffc0205848 <commands+0x738>
ffffffffc0203746:	05a00593          	li	a1,90
ffffffffc020374a:	00003517          	auipc	a0,0x3
ffffffffc020374e:	f0e50513          	addi	a0,a0,-242 # ffffffffc0206658 <default_pmm_manager+0xa60>
ffffffffc0203752:	cf5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203756:	00003697          	auipc	a3,0x3
ffffffffc020375a:	d2a68693          	addi	a3,a3,-726 # ffffffffc0206480 <default_pmm_manager+0x888>
ffffffffc020375e:	00002617          	auipc	a2,0x2
ffffffffc0203762:	0ea60613          	addi	a2,a2,234 # ffffffffc0205848 <commands+0x738>
ffffffffc0203766:	05700593          	li	a1,87
ffffffffc020376a:	00003517          	auipc	a0,0x3
ffffffffc020376e:	eee50513          	addi	a0,a0,-274 # ffffffffc0206658 <default_pmm_manager+0xa60>
ffffffffc0203772:	cd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203776:	00003697          	auipc	a3,0x3
ffffffffc020377a:	d0a68693          	addi	a3,a3,-758 # ffffffffc0206480 <default_pmm_manager+0x888>
ffffffffc020377e:	00002617          	auipc	a2,0x2
ffffffffc0203782:	0ca60613          	addi	a2,a2,202 # ffffffffc0205848 <commands+0x738>
ffffffffc0203786:	05400593          	li	a1,84
ffffffffc020378a:	00003517          	auipc	a0,0x3
ffffffffc020378e:	ece50513          	addi	a0,a0,-306 # ffffffffc0206658 <default_pmm_manager+0xa60>
...
ffffffffc02037bc:	ff068693          	addi	a3,a3,-16 # ffffffffc02067a8 <default_pmm_manager+0xbb0>
ffffffffc02037c0:	00002617          	auipc	a2,0x2
ffffffffc02037c4:	08860613          	addi	a2,a2,136 # ffffffffc0205848 <commands+0x738>
ffffffffc02037c8:	04100593          	li	a1,65
ffffffffc02037cc:	00003517          	auipc	a0,0x3
ffffffffc02037d0:	e8c50513          	addi	a0,a0,-372 # ffffffffc0206658 <default_pmm_manager+0xa60>
ffffffffc02037d4:	c73fc0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(in_tick==0);
ffffffffc02037d8:	00003697          	auipc	a3,0x3
ffffffffc02037dc:	fe068693          	addi	a3,a3,-32 # ffffffffc02067b8 <default_pmm_manager+0xbc0>
ffffffffc02037e0:	00002617          	auipc	a2,0x2
ffffffffc02037e4:	06860613          	addi	a2,a2,104 # ffffffffc0205848 <commands+0x738>
ffffffffc02037e8:	04200593          	li	a1,66
ffffffffc02037ec:	00003517          	auipc	a0,0x3
ffffffffc02037f0:	e6c50513          	addi	a0,a0,-404 # ffffffffc0206658 <default_pmm_manager+0xa60>
...
ffffffffc0203814:	fb868693          	addi	a3,a3,-72 # ffffffffc02067c8 <default_pmm_manager+0xbd0>
ffffffffc0203818:	00002617          	auipc	a2,0x2
ffffffffc020381c:	03060613          	addi	a2,a2,48 # ffffffffc0205848 <commands+0x738>
ffffffffc0203820:	03200593          	li	a1,50
ffffffffc0203824:	00003517          	auipc	a0,0x3
ffffffffc0203828:	e3450513          	addi	a0,a0,-460 # ffffffffc0206658 <default_pmm_manager+0xa60>
{
...
ffffffffc0203838:	fcc68693          	addi	a3,a3,-52 # ffffffffc0206800 <default_pmm_manager+0xc08>
ffffffffc020383c:	00002617          	auipc	a2,0x2
ffffffffc0203840:	00c60613          	addi	a2,a2,12 # ffffffffc0205848 <commands+0x738>
ffffffffc0203844:	07e00593          	li	a1,126
ffffffffc0203848:	00003517          	auipc	a0,0x3
ffffffffc020384c:	fd850513          	addi	a0,a0,-40 # ffffffffc0206820 <default_pmm_manager+0xc28>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0203980:	eb468693          	addi	a3,a3,-332 # ffffffffc0206830 <default_pmm_manager+0xc38>
ffffffffc0203984:	00002617          	auipc	a2,0x2
ffffffffc0203988:	ec460613          	addi	a2,a2,-316 # ffffffffc0205848 <commands+0x738>
ffffffffc020398c:	08500593          	li	a1,133
ffffffffc0203990:	00003517          	auipc	a0,0x3
ffffffffc0203994:	e9050513          	addi	a0,a0,-368 # ffffffffc0206820 <default_pmm_manager+0xc28>
ffffffffc0203998:	aaffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020399c:	00003697          	auipc	a3,0x3
ffffffffc02039a0:	ed468693          	addi	a3,a3,-300 # ffffffffc0206870 <default_pmm_manager+0xc78>
ffffffffc02039a4:	00002617          	auipc	a2,0x2
ffffffffc02039a8:	ea460613          	addi	a2,a2,-348 # ffffffffc0205848 <commands+0x738>
ffffffffc02039ac:	07d00593          	li	a1,125
ffffffffc02039b0:	00003517          	auipc	a0,0x3
ffffffffc02039b4:	e7050513          	addi	a0,a0,-400 # ffffffffc0206820 <default_pmm_manager+0xc28>
ffffffffc02039b8:	a8ffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02039bc:	00003697          	auipc	a3,0x3
ffffffffc02039c0:	e9468693          	addi	a3,a3,-364 # ffffffffc0206850 <default_pmm_manager+0xc58>
ffffffffc02039c4:	00002617          	auipc	a2,0x2
ffffffffc02039c8:	e8460613          	addi	a2,a2,-380 # ffffffffc0205848 <commands+0x738>
ffffffffc02039cc:	07c00593          	li	a1,124
ffffffffc02039d0:	00003517          	auipc	a0,0x3
ffffffffc02039d4:	e5050513          	addi	a0,a0,-432 # ffffffffc0206820 <default_pmm_manager+0xc28>
...
ffffffffc0203a72:	8d268693          	addi	a3,a3,-1838 # ffffffffc0206340 <default_pmm_manager+0x748>
ffffffffc0203a76:	00002617          	auipc	a2,0x2
ffffffffc0203a7a:	dd260613          	addi	a2,a2,-558 # ffffffffc0205848 <commands+0x738>
ffffffffc0203a7e:	0c900593          	li	a1,201
ffffffffc0203a82:	00003517          	auipc	a0,0x3
ffffffffc0203a86:	d9e50513          	addi	a0,a0,-610 # ffffffffc0206820 <default_pmm_manager+0xc28>
...
ffffffffc0203ac6:	87e68693          	addi	a3,a3,-1922 # ffffffffc0206340 <default_pmm_manager+0x748>
ffffffffc0203aca:	00002617          	auipc	a2,0x2
ffffffffc0203ace:	d7e60613          	addi	a2,a2,-642 # ffffffffc0205848 <commands+0x738>
ffffffffc0203ad2:	0cf00593          	li	a1,207
ffffffffc0203ad6:	00003517          	auipc	a0,0x3
ffffffffc0203ada:	d4a50513          	addi	a0,a0,-694 # ffffffffc0206820 <default_pmm_manager+0xc28>
...
ffffffffc0203b9a:	dfa50513          	addi	a0,a0,-518 # ffffffffc0206990 <default_pmm_manager+0xd98>
ffffffffc0203b9e:	de2fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203ba2:	00003697          	auipc	a3,0x3
ffffffffc0203ba6:	e1668693          	addi	a3,a3,-490 # ffffffffc02069b8 <default_pmm_manager+0xdc0>
ffffffffc0203baa:	00002617          	auipc	a2,0x2
ffffffffc0203bae:	c9e60613          	addi	a2,a2,-866 # ffffffffc0205848 <commands+0x738>
ffffffffc0203bb2:	0f100593          	li	a1,241
ffffffffc0203bb6:	00003517          	auipc	a0,0x3
ffffffffc0203bba:	c6a50513          	addi	a0,a0,-918 # ffffffffc0206820 <default_pmm_manager+0xc28>
...
ffffffffc0203be8:	dec50513          	addi	a0,a0,-532 # ffffffffc02069d0 <default_pmm_manager+0xdd8>
...
ffffffffc0203d7c:	cd050513          	addi	a0,a0,-816 # ffffffffc0206a48 <default_pmm_manager+0xe50>
...
ffffffffc0203d96:	cd650513          	addi	a0,a0,-810 # ffffffffc0206a68 <default_pmm_manager+0xe70>
}
...
ffffffffc0203daa:	b0268693          	addi	a3,a3,-1278 # ffffffffc02068a8 <default_pmm_manager+0xcb0>
ffffffffc0203dae:	00002617          	auipc	a2,0x2
ffffffffc0203db2:	a9a60613          	addi	a2,a2,-1382 # ffffffffc0205848 <commands+0x738>
ffffffffc0203db6:	0d800593          	li	a1,216
ffffffffc0203dba:	00003517          	auipc	a0,0x3
ffffffffc0203dbe:	a6650513          	addi	a0,a0,-1434 # ffffffffc0206820 <default_pmm_manager+0xc28>
ffffffffc0203dc2:	e84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203dc6:	00003697          	auipc	a3,0x3
ffffffffc0203dca:	b6a68693          	addi	a3,a3,-1174 # ffffffffc0206930 <default_pmm_manager+0xd38>
ffffffffc0203dce:	00002617          	auipc	a2,0x2
ffffffffc0203dd2:	a7a60613          	addi	a2,a2,-1414 # ffffffffc0205848 <commands+0x738>
ffffffffc0203dd6:	0e800593          	li	a1,232
ffffffffc0203dda:	00003517          	auipc	a0,0x3
ffffffffc0203dde:	a4650513          	addi	a0,a0,-1466 # ffffffffc0206820 <default_pmm_manager+0xc28>
ffffffffc0203de2:	e64fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203de6:	00003697          	auipc	a3,0x3
ffffffffc0203dea:	b7a68693          	addi	a3,a3,-1158 # ffffffffc0206960 <default_pmm_manager+0xd68>
ffffffffc0203dee:	00002617          	auipc	a2,0x2
ffffffffc0203df2:	a5a60613          	addi	a2,a2,-1446 # ffffffffc0205848 <commands+0x738>
ffffffffc0203df6:	0e900593          	li	a1,233
ffffffffc0203dfa:	00003517          	auipc	a0,0x3
ffffffffc0203dfe:	a2650513          	addi	a0,a0,-1498 # ffffffffc0206820 <default_pmm_manager+0xc28>
ffffffffc0203e02:	e44fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203e06:	00003697          	auipc	a3,0x3
ffffffffc0203e0a:	a8a68693          	addi	a3,a3,-1398 # ffffffffc0206890 <default_pmm_manager+0xc98>
ffffffffc0203e0e:	00002617          	auipc	a2,0x2
ffffffffc0203e12:	a3a60613          	addi	a2,a2,-1478 # ffffffffc0205848 <commands+0x738>
ffffffffc0203e16:	0d600593          	li	a1,214
ffffffffc0203e1a:	00003517          	auipc	a0,0x3
ffffffffc0203e1e:	a0650513          	addi	a0,a0,-1530 # ffffffffc0206820 <default_pmm_manager+0xc28>
ffffffffc0203e22:	e24fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma4 == NULL);
ffffffffc0203e26:	00003697          	auipc	a3,0x3
ffffffffc0203e2a:	aea68693          	addi	a3,a3,-1302 # ffffffffc0206910 <default_pmm_manager+0xd18>
ffffffffc0203e2e:	00002617          	auipc	a2,0x2
ffffffffc0203e32:	a1a60613          	addi	a2,a2,-1510 # ffffffffc0205848 <commands+0x738>
ffffffffc0203e36:	0e400593          	li	a1,228
ffffffffc0203e3a:	00003517          	auipc	a0,0x3
ffffffffc0203e3e:	9e650513          	addi	a0,a0,-1562 # ffffffffc0206820 <default_pmm_manager+0xc28>
ffffffffc0203e42:	e04fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma5 == NULL);
ffffffffc0203e46:	00003697          	auipc	a3,0x3
ffffffffc0203e4a:	ada68693          	addi	a3,a3,-1318 # ffffffffc0206920 <default_pmm_manager+0xd28>
ffffffffc0203e4e:	00002617          	auipc	a2,0x2
ffffffffc0203e52:	9fa60613          	addi	a2,a2,-1542 # ffffffffc0205848 <commands+0x738>
ffffffffc0203e56:	0e600593          	li	a1,230
ffffffffc0203e5a:	00003517          	auipc	a0,0x3
ffffffffc0203e5e:	9c650513          	addi	a0,a0,-1594 # ffffffffc0206820 <default_pmm_manager+0xc28>
ffffffffc0203e62:	de4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1 != NULL);
ffffffffc0203e66:	00003697          	auipc	a3,0x3
ffffffffc0203e6a:	a7a68693          	addi	a3,a3,-1414 # ffffffffc02068e0 <default_pmm_manager+0xce8>
ffffffffc0203e6e:	00002617          	auipc	a2,0x2
ffffffffc0203e72:	9da60613          	addi	a2,a2,-1574 # ffffffffc0205848 <commands+0x738>
ffffffffc0203e76:	0de00593          	li	a1,222
ffffffffc0203e7a:	00003517          	auipc	a0,0x3
ffffffffc0203e7e:	9a650513          	addi	a0,a0,-1626 # ffffffffc0206820 <default_pmm_manager+0xc28>
ffffffffc0203e82:	dc4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2 != NULL);
ffffffffc0203e86:	00003697          	auipc	a3,0x3
ffffffffc0203e8a:	a6a68693          	addi	a3,a3,-1430 # ffffffffc02068f0 <default_pmm_manager+0xcf8>
ffffffffc0203e8e:	00002617          	auipc	a2,0x2
ffffffffc0203e92:	9ba60613          	addi	a2,a2,-1606 # ffffffffc0205848 <commands+0x738>
ffffffffc0203e96:	0e000593          	li	a1,224
ffffffffc0203e9a:	00003517          	auipc	a0,0x3
ffffffffc0203e9e:	98650513          	addi	a0,a0,-1658 # ffffffffc0206820 <default_pmm_manager+0xc28>
ffffffffc0203ea2:	da4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma3 == NULL);
ffffffffc0203ea6:	00003697          	auipc	a3,0x3
ffffffffc0203eaa:	a5a68693          	addi	a3,a3,-1446 # ffffffffc0206900 <default_pmm_manager+0xd08>
ffffffffc0203eae:	00002617          	auipc	a2,0x2
ffffffffc0203eb2:	99a60613          	addi	a2,a2,-1638 # ffffffffc0205848 <commands+0x738>
ffffffffc0203eb6:	0e200593          	li	a1,226
ffffffffc0203eba:	00003517          	auipc	a0,0x3
ffffffffc0203ebe:	96650513          	addi	a0,a0,-1690 # ffffffffc0206820 <default_pmm_manager+0xc28>
ffffffffc0203ec2:	d84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203ec6:	00003697          	auipc	a3,0x3
ffffffffc0203eca:	bba68693          	addi	a3,a3,-1094 # ffffffffc0206a80 <default_pmm_manager+0xe88>
ffffffffc0203ece:	00002617          	auipc	a2,0x2
ffffffffc0203ed2:	97a60613          	addi	a2,a2,-1670 # ffffffffc0205848 <commands+0x738>
ffffffffc0203ed6:	10100593          	li	a1,257
ffffffffc0203eda:	00003517          	auipc	a0,0x3
ffffffffc0203ede:	94650513          	addi	a0,a0,-1722 # ffffffffc0206820 <default_pmm_manager+0xc28>
    check_mm_struct = mm_create();
...
ffffffffc0203ef2:	45268693          	addi	a3,a3,1106 # ffffffffc0206340 <default_pmm_manager+0x748>
ffffffffc0203ef6:	00002617          	auipc	a2,0x2
ffffffffc0203efa:	95260613          	addi	a2,a2,-1710 # ffffffffc0205848 <commands+0x738>
ffffffffc0203efe:	10800593          	li	a1,264
ffffffffc0203f02:	00003517          	auipc	a0,0x3
ffffffffc0203f06:	91e50513          	addi	a0,a0,-1762 # ffffffffc0206820 <default_pmm_manager+0xc28>
ffffffffc0203f0a:	d3cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203f0e:	00003697          	auipc	a3,0x3
ffffffffc0203f12:	ae268693          	addi	a3,a3,-1310 # ffffffffc02069f0 <default_pmm_manager+0xdf8>
ffffffffc0203f16:	00002617          	auipc	a2,0x2
ffffffffc0203f1a:	93260613          	addi	a2,a2,-1742 # ffffffffc0205848 <commands+0x738>
ffffffffc0203f1e:	10d00593          	li	a1,269
ffffffffc0203f22:	00003517          	auipc	a0,0x3
ffffffffc0203f26:	8fe50513          	addi	a0,a0,-1794 # ffffffffc0206820 <default_pmm_manager+0xc28>
ffffffffc0203f2a:	d1cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(sum == 0);
ffffffffc0203f2e:	00003697          	auipc	a3,0x3
ffffffffc0203f32:	ae268693          	addi	a3,a3,-1310 # ffffffffc0206a10 <default_pmm_manager+0xe18>
ffffffffc0203f36:	00002617          	auipc	a2,0x2
ffffffffc0203f3a:	91260613          	addi	a2,a2,-1774 # ffffffffc0205848 <commands+0x738>
ffffffffc0203f3e:	11700593          	li	a1,279
ffffffffc0203f42:	00003517          	auipc	a0,0x3
ffffffffc0203f46:	8de50513          	addi	a0,a0,-1826 # ffffffffc0206820 <default_pmm_manager+0xc28>
ffffffffc0203f4a:	cfcfc0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203f4e:	00002617          	auipc	a2,0x2
ffffffffc0203f52:	db260613          	addi	a2,a2,-590 # ffffffffc0205d00 <default_pmm_manager+0x108>
ffffffffc0203f56:	06200593          	li	a1,98
ffffffffc0203f5a:	00002517          	auipc	a0,0x2
ffffffffc0203f5e:	cfe50513          	addi	a0,a0,-770 # ffffffffc0205c58 <default_pmm_manager+0x60>
ffffffffc0203f62:	ce4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203f66:	00002617          	auipc	a2,0x2
ffffffffc0203f6a:	cca60613          	addi	a2,a2,-822 # ffffffffc0205c30 <default_pmm_manager+0x38>
ffffffffc0203f6e:	06900593          	li	a1,105
ffffffffc0203f72:	00002517          	auipc	a0,0x2
ffffffffc0203f76:	ce650513          	addi	a0,a0,-794 # ffffffffc0205c58 <default_pmm_manager+0x60>
ffffffffc0203f7a:	cccfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203f7e:	00003697          	auipc	a3,0x3
ffffffffc0203f82:	aa268693          	addi	a3,a3,-1374 # ffffffffc0206a20 <default_pmm_manager+0xe28>
ffffffffc0203f86:	00002617          	auipc	a2,0x2
ffffffffc0203f8a:	8c260613          	addi	a2,a2,-1854 # ffffffffc0205848 <commands+0x738>
ffffffffc0203f8e:	12400593          	li	a1,292
ffffffffc0203f92:	00003517          	auipc	a0,0x3
ffffffffc0203f96:	88e50513          	addi	a0,a0,-1906 # ffffffffc0206820 <default_pmm_manager+0xc28>
ffffffffc0203f9a:	cacfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203f9e:	00002697          	auipc	a3,0x2
ffffffffc0203fa2:	39268693          	addi	a3,a3,914 # ffffffffc0206330 <default_pmm_manager+0x738>
ffffffffc0203fa6:	00002617          	auipc	a2,0x2
ffffffffc0203faa:	8a260613          	addi	a2,a2,-1886 # ffffffffc0205848 <commands+0x738>
ffffffffc0203fae:	10500593          	li	a1,261
ffffffffc0203fb2:	00003517          	auipc	a0,0x3
ffffffffc0203fb6:	86e50513          	addi	a0,a0,-1938 # ffffffffc0206820 <default_pmm_manager+0xc28>
ffffffffc0203fba:	c8cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(mm != NULL);
ffffffffc0203fbe:	00002697          	auipc	a3,0x2
ffffffffc0203fc2:	34a68693          	addi	a3,a3,842 # ffffffffc0206308 <default_pmm_manager+0x710>
ffffffffc0203fc6:	00002617          	auipc	a2,0x2
ffffffffc0203fca:	88260613          	addi	a2,a2,-1918 # ffffffffc0205848 <commands+0x738>
ffffffffc0203fce:	0c200593          	li	a1,194
ffffffffc0203fd2:	00003517          	auipc	a0,0x3
ffffffffc0203fd6:	84e50513          	addi	a0,a0,-1970 # ffffffffc0206820 <default_pmm_manager+0xc28>
...
ffffffffc0204084:	a6850513          	addi	a0,a0,-1432 # ffffffffc0206ae8 <default_pmm_manager+0xef0>
...
ffffffffc0204096:	a0650513          	addi	a0,a0,-1530 # ffffffffc0206a98 <default_pmm_manager+0xea0>
...
ffffffffc02040a6:	a9650513          	addi	a0,a0,-1386 # ffffffffc0206b38 <default_pmm_manager+0xf40>
...
ffffffffc02040b6:	a5e50513          	addi	a0,a0,-1442 # ffffffffc0206b10 <default_pmm_manager+0xf18>
...
ffffffffc02040c6:	a5e50513          	addi	a0,a0,-1442 # ffffffffc0206b20 <default_pmm_manager+0xf28>
...
ffffffffc02040d6:	9f650513          	addi	a0,a0,-1546 # ffffffffc0206ac8 <default_pmm_manager+0xed0>
...
ffffffffc02040f8:	00011797          	auipc	a5,0x11
ffffffffc02040fc:	48a7b823          	sd	a0,1168(a5) # ffffffffc0215588 <max_swap_offset>
}
ffffffffc0204100:	0141                	addi	sp,sp,16
ffffffffc0204102:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0204104:	00003617          	auipc	a2,0x3
ffffffffc0204108:	a5c60613          	addi	a2,a2,-1444 # ffffffffc0206b60 <default_pmm_manager+0xf68>
ffffffffc020410c:	45b5                	li	a1,13
ffffffffc020410e:	00003517          	auipc	a0,0x3
ffffffffc0204112:	a7250513          	addi	a0,a0,-1422 # ffffffffc0206b80 <default_pmm_manager+0xf88>
...
ffffffffc0204128:	46473703          	ld	a4,1124(a4) # ffffffffc0215588 <max_swap_offset>
ffffffffc020412c:	04e7f563          	bgeu	a5,a4,ffffffffc0204176 <swapfs_read+0x5c>
    return page - pages + nbase;
ffffffffc0204130:	00011617          	auipc	a2,0x11
ffffffffc0204134:	44063603          	ld	a2,1088(a2) # ffffffffc0215570 <pages>
ffffffffc0204138:	8d91                	sub	a1,a1,a2
ffffffffc020413a:	4065d613          	srai	a2,a1,0x6
ffffffffc020413e:	00003717          	auipc	a4,0x3
ffffffffc0204142:	e7273703          	ld	a4,-398(a4) # ffffffffc0206fb0 <nbase>
ffffffffc0204146:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc0204148:	00c61713          	slli	a4,a2,0xc
ffffffffc020414c:	8331                	srli	a4,a4,0xc
ffffffffc020414e:	00011697          	auipc	a3,0x11
ffffffffc0204152:	41a6b683          	ld	a3,1050(a3) # ffffffffc0215568 <npage>
...
ffffffffc0204160:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204162:	00011797          	auipc	a5,0x11
ffffffffc0204166:	41e7b783          	ld	a5,1054(a5) # ffffffffc0215580 <va_pa_offset>
...
ffffffffc020417c:	a2060613          	addi	a2,a2,-1504 # ffffffffc0206b98 <default_pmm_manager+0xfa0>
ffffffffc0204180:	45d1                	li	a1,20
ffffffffc0204182:	00003517          	auipc	a0,0x3
ffffffffc0204186:	9fe50513          	addi	a0,a0,-1538 # ffffffffc0206b80 <default_pmm_manager+0xf88>
...
ffffffffc0204198:	a9c60613          	addi	a2,a2,-1380 # ffffffffc0205c30 <default_pmm_manager+0x38>
ffffffffc020419c:	00002517          	auipc	a0,0x2
ffffffffc02041a0:	abc50513          	addi	a0,a0,-1348 # ffffffffc0205c58 <default_pmm_manager+0x60>
...
ffffffffc02041b2:	00011717          	auipc	a4,0x11
ffffffffc02041b6:	3d673703          	ld	a4,982(a4) # ffffffffc0215588 <max_swap_offset>
ffffffffc02041ba:	04e7f563          	bgeu	a5,a4,ffffffffc0204204 <swapfs_write+0x5c>
    return page - pages + nbase;
ffffffffc02041be:	00011617          	auipc	a2,0x11
ffffffffc02041c2:	3b263603          	ld	a2,946(a2) # ffffffffc0215570 <pages>
ffffffffc02041c6:	8d91                	sub	a1,a1,a2
ffffffffc02041c8:	4065d613          	srai	a2,a1,0x6
ffffffffc02041cc:	00003717          	auipc	a4,0x3
ffffffffc02041d0:	de473703          	ld	a4,-540(a4) # ffffffffc0206fb0 <nbase>
ffffffffc02041d4:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc02041d6:	00c61713          	slli	a4,a2,0xc
ffffffffc02041da:	8331                	srli	a4,a4,0xc
ffffffffc02041dc:	00011697          	auipc	a3,0x11
ffffffffc02041e0:	38c6b683          	ld	a3,908(a3) # ffffffffc0215568 <npage>
...
ffffffffc02041f4:	3907b783          	ld	a5,912(a5) # ffffffffc0215580 <va_pa_offset>
...
ffffffffc020420a:	99260613          	addi	a2,a2,-1646 # ffffffffc0206b98 <default_pmm_manager+0xfa0>
ffffffffc020420e:	45e5                	li	a1,25
ffffffffc0204210:	00003517          	auipc	a0,0x3
ffffffffc0204214:	97050513          	addi	a0,a0,-1680 # ffffffffc0206b80 <default_pmm_manager+0xf88>
...
ffffffffc0204226:	a0e60613          	addi	a2,a2,-1522 # ffffffffc0205c30 <default_pmm_manager+0x38>
ffffffffc020422a:	00002517          	auipc	a0,0x2
ffffffffc020422e:	a2e50513          	addi	a0,a0,-1490 # ffffffffc0205c58 <default_pmm_manager+0x60>
...
ffffffffc0204238:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc020423a:	3e4000ef          	jal	ra,ffffffffc020461e <do_exit>

ffffffffc020423e <alloc_proc>:
// 在 alloc_proc 之前声明 get_pid 函数
static int get_pid(void);  // static 限制其作用域仅在本文件
...
ffffffffc0204274:	3e1000ef          	jal	ra,ffffffffc0204e54 <memset>
        proc->tf = NULL;                         // Trap frame初始化为NULL
        proc->cr3 = boot_cr3;                           // 页目录基地址初始化为0
ffffffffc0204278:	00011797          	auipc	a5,0x11
ffffffffc020427c:	2e07b783          	ld	a5,736(a5) # ffffffffc0215558 <boot_cr3>
        proc->tf = NULL;                         // Trap frame初始化为NULL
...
ffffffffc0204292:	3c3000ef          	jal	ra,ffffffffc0204e54 <memset>
...
ffffffffc02042a4:	3107b783          	ld	a5,784(a5) # ffffffffc02155b0 <current>
...
ffffffffc02042b2:	00011497          	auipc	s1,0x11
ffffffffc02042b6:	26648493          	addi	s1,s1,614 # ffffffffc0215518 <name.2>
init_main(void *arg) {
ffffffffc02042ba:	f022                	sd	s0,32(sp)
ffffffffc02042bc:	e84a                	sd	s2,16(sp)
ffffffffc02042be:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042c0:	00011917          	auipc	s2,0x11
ffffffffc02042c4:	2f093903          	ld	s2,752(s2) # ffffffffc02155b0 <current>
    memset(name, 0, sizeof(name));
...
ffffffffc02042fc:	8e850513          	addi	a0,a0,-1816 # ffffffffc0206be0 <default_pmm_manager+0xfe8>
ffffffffc0204300:	e81fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc0204304:	00003517          	auipc	a0,0x3
ffffffffc0204308:	8ec50513          	addi	a0,a0,-1812 # ffffffffc0206bf0 <default_pmm_manager+0xff8>
...
ffffffffc0204322:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc0204324:	00011917          	auipc	s2,0x11
ffffffffc0204328:	28c90913          	addi	s2,s2,652 # ffffffffc02155b0 <current>
proc_run(struct proc_struct *proc) {
ffffffffc020432c:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc020432e:	00093483          	ld	s1,0(s2)
proc_run(struct proc_struct *proc) {
ffffffffc0204332:	f406                	sd	ra,40(sp)
ffffffffc0204334:	e84e                	sd	s3,16(sp)
    if (proc != current) {
ffffffffc0204336:	02a48963          	beq	s1,a0,ffffffffc0204368 <proc_run+0x48>
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc0204340:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204342:	e3a1                	bnez	a5,ffffffffc0204382 <proc_run+0x62>
        lcr3(proc->cr3);
...
ffffffffc0204346:	80000737          	lui	a4,0x80000
        current = proc;
ffffffffc020434a:	00a93023          	sd	a0,0(s2)
ffffffffc020434e:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc0204352:	8fd9                	or	a5,a5,a4
ffffffffc0204354:	18079073          	csrw	satp,a5
        switch_to(&prev->context, &next->context);
ffffffffc0204358:	03050593          	addi	a1,a0,48
ffffffffc020435c:	03048513          	addi	a0,s1,48
ffffffffc0204360:	544000ef          	jal	ra,ffffffffc02048a4 <switch_to>
    if (flag) {
ffffffffc0204364:	00099863          	bnez	s3,ffffffffc0204374 <proc_run+0x54>
}
ffffffffc0204368:	70a2                	ld	ra,40(sp)
ffffffffc020436a:	7482                	ld	s1,32(sp)
ffffffffc020436c:	6962                	ld	s2,24(sp)
ffffffffc020436e:	69c2                	ld	s3,16(sp)
...
ffffffffc020437c:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc020437e:	a3efc06f          	j	ffffffffc02005bc <intr_enable>
ffffffffc0204382:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0204384:	a3efc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204388:	6522                	ld	a0,8(sp)
ffffffffc020438a:	4985                	li	s3,1
ffffffffc020438c:	bf65                	j	ffffffffc0204344 <proc_run+0x24>

ffffffffc020438e <do_fork>:
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc020438e:	7179                	addi	sp,sp,-48
ffffffffc0204390:	ec26                	sd	s1,24(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204392:	00011497          	auipc	s1,0x11
ffffffffc0204396:	23648493          	addi	s1,s1,566 # ffffffffc02155c8 <nr_process>
ffffffffc020439a:	4098                	lw	a4,0(s1)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc020439c:	f406                	sd	ra,40(sp)
ffffffffc020439e:	f022                	sd	s0,32(sp)
ffffffffc02043a0:	e84a                	sd	s2,16(sp)
ffffffffc02043a2:	e44e                	sd	s3,8(sp)
ffffffffc02043a4:	e052                	sd	s4,0(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc02043a6:	6785                	lui	a5,0x1
ffffffffc02043a8:	1ef75263          	bge	a4,a5,ffffffffc020458c <do_fork+0x1fe>
ffffffffc02043ac:	892e                	mv	s2,a1
ffffffffc02043ae:	8432                	mv	s0,a2
    proc = alloc_proc();
ffffffffc02043b0:	e8fff0ef          	jal	ra,ffffffffc020423e <alloc_proc>
ffffffffc02043b4:	89aa                	mv	s3,a0
    if (proc == NULL) {
ffffffffc02043b6:	1c050663          	beqz	a0,ffffffffc0204582 <do_fork+0x1f4>
    proc->parent = current;
ffffffffc02043ba:	00011a17          	auipc	s4,0x11
ffffffffc02043be:	1f6a0a13          	addi	s4,s4,502 # ffffffffc02155b0 <current>
ffffffffc02043c2:	000a3783          	ld	a5,0(s4)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043c6:	4509                	li	a0,2
    proc->parent = current;
ffffffffc02043c8:	02f9b023          	sd	a5,32(s3)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043cc:	e60fd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc02043d0:	1a050963          	beqz	a0,ffffffffc0204582 <do_fork+0x1f4>
    return page - pages + nbase;
ffffffffc02043d4:	00011697          	auipc	a3,0x11
ffffffffc02043d8:	19c6b683          	ld	a3,412(a3) # ffffffffc0215570 <pages>
ffffffffc02043dc:	40d506b3          	sub	a3,a0,a3
ffffffffc02043e0:	8699                	srai	a3,a3,0x6
ffffffffc02043e2:	00003517          	auipc	a0,0x3
ffffffffc02043e6:	bce53503          	ld	a0,-1074(a0) # ffffffffc0206fb0 <nbase>
ffffffffc02043ea:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc02043ec:	00c69793          	slli	a5,a3,0xc
ffffffffc02043f0:	83b1                	srli	a5,a5,0xc
ffffffffc02043f2:	00011717          	auipc	a4,0x11
ffffffffc02043f6:	17673703          	ld	a4,374(a4) # ffffffffc0215568 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc02043fa:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043fc:	18e7fd63          	bgeu	a5,a4,ffffffffc0204596 <do_fork+0x208>
    assert(current->mm == NULL);
ffffffffc0204400:	000a3783          	ld	a5,0(s4)
ffffffffc0204404:	00011717          	auipc	a4,0x11
ffffffffc0204408:	17c73703          	ld	a4,380(a4) # ffffffffc0215580 <va_pa_offset>
ffffffffc020440c:	96ba                	add	a3,a3,a4
ffffffffc020440e:	779c                	ld	a5,40(a5)
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc0204410:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc0204414:	18079d63          	bnez	a5,ffffffffc02045ae <do_fork+0x220>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204418:	6789                	lui	a5,0x2
ffffffffc020441a:	ee078793          	addi	a5,a5,-288 # 1ee0 <kern_entry-0xffffffffc01fe120>
ffffffffc020441e:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc0204420:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204422:	0ad9b023          	sd	a3,160(s3)
    *(proc->tf) = *tf;
ffffffffc0204426:	87b6                	mv	a5,a3
ffffffffc0204428:	12040893          	addi	a7,s0,288
...
ffffffffc0204448:	ff1612e3          	bne	a2,a7,ffffffffc020442c <do_fork+0x9e>
    proc->tf->gpr.a0 = 0;
ffffffffc020444c:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204450:	10090d63          	beqz	s2,ffffffffc020456a <do_fork+0x1dc>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204454:	00006817          	auipc	a6,0x6
ffffffffc0204458:	c0480813          	addi	a6,a6,-1020 # ffffffffc020a058 <last_pid.1>
ffffffffc020445c:	00082783          	lw	a5,0(a6)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204460:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204464:	00000717          	auipc	a4,0x0
ffffffffc0204468:	e3c70713          	addi	a4,a4,-452 # ffffffffc02042a0 <forkret>
    if (++ last_pid >= MAX_PID) {
ffffffffc020446c:	0017851b          	addiw	a0,a5,1
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204470:	02e9b823          	sd	a4,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204474:	02d9bc23          	sd	a3,56(s3)
    if (++ last_pid >= MAX_PID) {
ffffffffc0204478:	00a82023          	sw	a0,0(a6)
ffffffffc020447c:	6789                	lui	a5,0x2
ffffffffc020447e:	06f55f63          	bge	a0,a5,ffffffffc02044fc <do_fork+0x16e>
    if (last_pid >= next_safe) {
ffffffffc0204482:	00006317          	auipc	t1,0x6
ffffffffc0204486:	bda30313          	addi	t1,t1,-1062 # ffffffffc020a05c <next_safe.0>
ffffffffc020448a:	00032783          	lw	a5,0(t1)
ffffffffc020448e:	00011417          	auipc	s0,0x11
ffffffffc0204492:	09a40413          	addi	s0,s0,154 # ffffffffc0215528 <proc_list>
ffffffffc0204496:	06f55b63          	bge	a0,a5,ffffffffc020450c <do_fork+0x17e>
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020449a:	45a9                	li	a1,10
    proc->pid = get_pid();
ffffffffc020449c:	00a9a223          	sw	a0,4(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc02044a0:	2501                	sext.w	a0,a0
ffffffffc02044a2:	532000ef          	jal	ra,ffffffffc02049d4 <hash32>
ffffffffc02044a6:	02051793          	slli	a5,a0,0x20
ffffffffc02044aa:	01c7d513          	srli	a0,a5,0x1c
ffffffffc02044ae:	0000d797          	auipc	a5,0xd
ffffffffc02044b2:	06a78793          	addi	a5,a5,106 # ffffffffc0211518 <hash_list>
ffffffffc02044b6:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc02044b8:	6518                	ld	a4,8(a0)
ffffffffc02044ba:	0d898793          	addi	a5,s3,216
ffffffffc02044be:	6414                	ld	a3,8(s0)
    prev->next = next->prev = elm;
ffffffffc02044c0:	e31c                	sd	a5,0(a4)
ffffffffc02044c2:	e51c                	sd	a5,8(a0)
    nr_process++;
ffffffffc02044c4:	409c                	lw	a5,0(s1)
    elm->next = next;
ffffffffc02044c6:	0ee9b023          	sd	a4,224(s3)
    elm->prev = prev;
ffffffffc02044ca:	0ca9bc23          	sd	a0,216(s3)
    list_add(&proc_list, &proc->list_link);
ffffffffc02044ce:	0c898713          	addi	a4,s3,200
    prev->next = next->prev = elm;
ffffffffc02044d2:	e298                	sd	a4,0(a3)
    nr_process++;
ffffffffc02044d4:	2785                	addiw	a5,a5,1
    wakeup_proc(proc);
...
ffffffffc02044dc:	0c89b423          	sd	s0,200(s3)
    prev->next = next->prev = elm;
ffffffffc02044e0:	e418                	sd	a4,8(s0)
    nr_process++;
ffffffffc02044e2:	c09c                	sw	a5,0(s1)
    wakeup_proc(proc);
ffffffffc02044e4:	42a000ef          	jal	ra,ffffffffc020490e <wakeup_proc>
    ret = proc->pid;
ffffffffc02044e8:	0049a503          	lw	a0,4(s3)
}
ffffffffc02044ec:	70a2                	ld	ra,40(sp)
ffffffffc02044ee:	7402                	ld	s0,32(sp)
ffffffffc02044f0:	64e2                	ld	s1,24(sp)
ffffffffc02044f2:	6942                	ld	s2,16(sp)
ffffffffc02044f4:	69a2                	ld	s3,8(sp)
ffffffffc02044f6:	6a02                	ld	s4,0(sp)
ffffffffc02044f8:	6145                	addi	sp,sp,48
ffffffffc02044fa:	8082                	ret
        last_pid = 1;
ffffffffc02044fc:	4785                	li	a5,1
ffffffffc02044fe:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc0204502:	4505                	li	a0,1
ffffffffc0204504:	00006317          	auipc	t1,0x6
ffffffffc0204508:	b5830313          	addi	t1,t1,-1192 # ffffffffc020a05c <next_safe.0>
    return listelm->next;
ffffffffc020450c:	00011417          	auipc	s0,0x11
ffffffffc0204510:	01c40413          	addi	s0,s0,28 # ffffffffc0215528 <proc_list>
ffffffffc0204514:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc0204518:	6789                	lui	a5,0x2
ffffffffc020451a:	00f32023          	sw	a5,0(t1)
ffffffffc020451e:	86aa                	mv	a3,a0
ffffffffc0204520:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc0204522:	6e89                	lui	t4,0x2
ffffffffc0204524:	048e0a63          	beq	t3,s0,ffffffffc0204578 <do_fork+0x1ea>
ffffffffc0204528:	88ae                	mv	a7,a1
ffffffffc020452a:	87f2                	mv	a5,t3
ffffffffc020452c:	6609                	lui	a2,0x2
ffffffffc020452e:	a811                	j	ffffffffc0204542 <do_fork+0x1b4>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc0204530:	00e6d663          	bge	a3,a4,ffffffffc020453c <do_fork+0x1ae>
ffffffffc0204534:	00c75463          	bge	a4,a2,ffffffffc020453c <do_fork+0x1ae>
ffffffffc0204538:	863a                	mv	a2,a4
ffffffffc020453a:	4885                	li	a7,1
ffffffffc020453c:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020453e:	00878d63          	beq	a5,s0,ffffffffc0204558 <do_fork+0x1ca>
            if (proc->pid == last_pid) {
ffffffffc0204542:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc0204546:	fed715e3          	bne	a4,a3,ffffffffc0204530 <do_fork+0x1a2>
                if (++ last_pid >= next_safe) {
ffffffffc020454a:	2685                	addiw	a3,a3,1
ffffffffc020454c:	02c6d163          	bge	a3,a2,ffffffffc020456e <do_fork+0x1e0>
ffffffffc0204550:	679c                	ld	a5,8(a5)
ffffffffc0204552:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc0204554:	fe8797e3          	bne	a5,s0,ffffffffc0204542 <do_fork+0x1b4>
ffffffffc0204558:	c581                	beqz	a1,ffffffffc0204560 <do_fork+0x1d2>
ffffffffc020455a:	00d82023          	sw	a3,0(a6)
ffffffffc020455e:	8536                	mv	a0,a3
ffffffffc0204560:	f2088de3          	beqz	a7,ffffffffc020449a <do_fork+0x10c>
ffffffffc0204564:	00c32023          	sw	a2,0(t1)
ffffffffc0204568:	bf0d                	j	ffffffffc020449a <do_fork+0x10c>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020456a:	8936                	mv	s2,a3
ffffffffc020456c:	b5e5                	j	ffffffffc0204454 <do_fork+0xc6>
                    if (last_pid >= MAX_PID) {
ffffffffc020456e:	01d6c363          	blt	a3,t4,ffffffffc0204574 <do_fork+0x1e6>
                        last_pid = 1;
ffffffffc0204572:	4685                	li	a3,1
                    goto repeat;
ffffffffc0204574:	4585                	li	a1,1
ffffffffc0204576:	b77d                	j	ffffffffc0204524 <do_fork+0x196>
ffffffffc0204578:	cd81                	beqz	a1,ffffffffc0204590 <do_fork+0x202>
ffffffffc020457a:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc020457e:	8536                	mv	a0,a3
ffffffffc0204580:	bf29                	j	ffffffffc020449a <do_fork+0x10c>
    kfree(proc);
ffffffffc0204582:	854e                	mv	a0,s3
ffffffffc0204584:	b7afd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc0204588:	5571                	li	a0,-4
    return ret;
ffffffffc020458a:	b78d                	j	ffffffffc02044ec <do_fork+0x15e>
    int ret = -E_NO_FREE_PROC;
ffffffffc020458c:	556d                	li	a0,-5
ffffffffc020458e:	bfb9                	j	ffffffffc02044ec <do_fork+0x15e>
    return last_pid;
ffffffffc0204590:	00082503          	lw	a0,0(a6)
ffffffffc0204594:	b719                	j	ffffffffc020449a <do_fork+0x10c>
ffffffffc0204596:	00001617          	auipc	a2,0x1
ffffffffc020459a:	69a60613          	addi	a2,a2,1690 # ffffffffc0205c30 <default_pmm_manager+0x38>
ffffffffc020459e:	06900593          	li	a1,105
ffffffffc02045a2:	00001517          	auipc	a0,0x1
ffffffffc02045a6:	6b650513          	addi	a0,a0,1718 # ffffffffc0205c58 <default_pmm_manager+0x60>
ffffffffc02045aa:	e9dfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(current->mm == NULL);
ffffffffc02045ae:	00002697          	auipc	a3,0x2
ffffffffc02045b2:	66268693          	addi	a3,a3,1634 # ffffffffc0206c10 <default_pmm_manager+0x1018>
ffffffffc02045b6:	00001617          	auipc	a2,0x1
ffffffffc02045ba:	29260613          	addi	a2,a2,658 # ffffffffc0205848 <commands+0x738>
ffffffffc02045be:	10c00593          	li	a1,268
ffffffffc02045c2:	00002517          	auipc	a0,0x2
ffffffffc02045c6:	66650513          	addi	a0,a0,1638 # ffffffffc0206c28 <default_pmm_manager+0x1030>
...
ffffffffc02045e4:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02045e6:	06f000ef          	jal	ra,ffffffffc0204e54 <memset>
...
ffffffffc0204606:	c3478793          	addi	a5,a5,-972 # ffffffffc0204236 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020460a:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc020460c:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020460e:	d81ff0ef          	jal	ra,ffffffffc020438e <do_fork>
}
...
ffffffffc0204624:	62060613          	addi	a2,a2,1568 # ffffffffc0206c40 <default_pmm_manager+0x1048>
ffffffffc0204628:	17900593          	li	a1,377
ffffffffc020462c:	00002517          	auipc	a0,0x2
ffffffffc0204630:	5fc50513          	addi	a0,a0,1532 # ffffffffc0206c28 <default_pmm_manager+0x1030>
do_exit(int error_code) {
...
void
proc_init(void) {
ffffffffc020463a:	7179                	addi	sp,sp,-48
ffffffffc020463c:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc020463e:	00011797          	auipc	a5,0x11
ffffffffc0204642:	eea78793          	addi	a5,a5,-278 # ffffffffc0215528 <proc_list>
ffffffffc0204646:	f406                	sd	ra,40(sp)
ffffffffc0204648:	f022                	sd	s0,32(sp)
ffffffffc020464a:	e84a                	sd	s2,16(sp)
ffffffffc020464c:	e44e                	sd	s3,8(sp)
ffffffffc020464e:	0000d497          	auipc	s1,0xd
ffffffffc0204652:	eca48493          	addi	s1,s1,-310 # ffffffffc0211518 <hash_list>
...
ffffffffc020465a:	00011717          	auipc	a4,0x11
ffffffffc020465e:	ebe70713          	addi	a4,a4,-322 # ffffffffc0215518 <name.2>
ffffffffc0204662:	87a6                	mv	a5,s1
ffffffffc0204664:	e79c                	sd	a5,8(a5)
ffffffffc0204666:	e39c                	sd	a5,0(a5)
ffffffffc0204668:	07c1                	addi	a5,a5,16
ffffffffc020466a:	fef71de3          	bne	a4,a5,ffffffffc0204664 <proc_init+0x2a>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc020466e:	bd1ff0ef          	jal	ra,ffffffffc020423e <alloc_proc>
ffffffffc0204672:	00011917          	auipc	s2,0x11
ffffffffc0204676:	f4690913          	addi	s2,s2,-186 # ffffffffc02155b8 <idleproc>
ffffffffc020467a:	00a93023          	sd	a0,0(s2)
ffffffffc020467e:	18050d63          	beqz	a0,ffffffffc0204818 <proc_init+0x1de>
        panic("cannot alloc idleproc.\n");
    }

    // check the proc structure
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc0204682:	07000513          	li	a0,112
ffffffffc0204686:	9c8fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc020468a:	07000613          	li	a2,112
ffffffffc020468e:	4581                	li	a1,0
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc0204690:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc0204692:	7c2000ef          	jal	ra,ffffffffc0204e54 <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc0204696:	00093503          	ld	a0,0(s2)
ffffffffc020469a:	85a2                	mv	a1,s0
ffffffffc020469c:	07000613          	li	a2,112
ffffffffc02046a0:	03050513          	addi	a0,a0,48
ffffffffc02046a4:	7da000ef          	jal	ra,ffffffffc0204e7e <memcmp>
ffffffffc02046a8:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc02046aa:	453d                	li	a0,15
...
ffffffffc02046b4:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02046b6:	79e000ef          	jal	ra,ffffffffc0204e54 <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc02046ba:	00093503          	ld	a0,0(s2)
ffffffffc02046be:	463d                	li	a2,15
ffffffffc02046c0:	85a2                	mv	a1,s0
ffffffffc02046c2:	0b450513          	addi	a0,a0,180
ffffffffc02046c6:	7b8000ef          	jal	ra,ffffffffc0204e7e <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc02046ca:	00093783          	ld	a5,0(s2)
ffffffffc02046ce:	00011717          	auipc	a4,0x11
ffffffffc02046d2:	e8a73703          	ld	a4,-374(a4) # ffffffffc0215558 <boot_cr3>
ffffffffc02046d6:	77d4                	ld	a3,168(a5)
ffffffffc02046d8:	0ee68463          	beq	a3,a4,ffffffffc02047c0 <proc_init+0x186>
...
ffffffffc02046dc:	4709                	li	a4,2
ffffffffc02046de:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc02046e0:	00003717          	auipc	a4,0x3
ffffffffc02046e4:	92070713          	addi	a4,a4,-1760 # ffffffffc0207000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02046e8:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc02046ec:	eb98                	sd	a4,16(a5)
    idleproc->need_resched = 1;
ffffffffc02046ee:	4705                	li	a4,1
ffffffffc02046f0:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02046f2:	4641                	li	a2,16
ffffffffc02046f4:	4581                	li	a1,0
ffffffffc02046f6:	8522                	mv	a0,s0
ffffffffc02046f8:	75c000ef          	jal	ra,ffffffffc0204e54 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02046fc:	463d                	li	a2,15
ffffffffc02046fe:	00002597          	auipc	a1,0x2
ffffffffc0204702:	58a58593          	addi	a1,a1,1418 # ffffffffc0206c88 <default_pmm_manager+0x1090>
ffffffffc0204706:	8522                	mv	a0,s0
ffffffffc0204708:	75e000ef          	jal	ra,ffffffffc0204e66 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc020470c:	00011717          	auipc	a4,0x11
ffffffffc0204710:	ebc70713          	addi	a4,a4,-324 # ffffffffc02155c8 <nr_process>
ffffffffc0204714:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc0204716:	00093683          	ld	a3,0(s2)
...
ffffffffc0204722:	57258593          	addi	a1,a1,1394 # ffffffffc0206c90 <default_pmm_manager+0x1098>
ffffffffc0204726:	00000517          	auipc	a0,0x0
ffffffffc020472a:	b8850513          	addi	a0,a0,-1144 # ffffffffc02042ae <init_main>
    nr_process ++;
ffffffffc020472e:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0204730:	00011797          	auipc	a5,0x11
ffffffffc0204734:	e8d7b023          	sd	a3,-384(a5) # ffffffffc02155b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204738:	e97ff0ef          	jal	ra,ffffffffc02045ce <kernel_thread>
ffffffffc020473c:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc020473e:	0ea05963          	blez	a0,ffffffffc0204830 <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0204742:	6789                	lui	a5,0x2
ffffffffc0204744:	fff5071b          	addiw	a4,a0,-1
ffffffffc0204748:	17f9                	addi	a5,a5,-2
ffffffffc020474a:	2501                	sext.w	a0,a0
ffffffffc020474c:	02e7e363          	bltu	a5,a4,ffffffffc0204772 <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204750:	45a9                	li	a1,10
ffffffffc0204752:	282000ef          	jal	ra,ffffffffc02049d4 <hash32>
ffffffffc0204756:	02051793          	slli	a5,a0,0x20
ffffffffc020475a:	01c7d693          	srli	a3,a5,0x1c
ffffffffc020475e:	96a6                	add	a3,a3,s1
ffffffffc0204760:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc0204762:	a029                	j	ffffffffc020476c <proc_init+0x132>
            if (proc->pid == pid) {
ffffffffc0204764:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc0204768:	0a870563          	beq	a4,s0,ffffffffc0204812 <proc_init+0x1d8>
    return listelm->next;
ffffffffc020476c:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020476e:	fef69be3          	bne	a3,a5,ffffffffc0204764 <proc_init+0x12a>
    return NULL;
ffffffffc0204772:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204774:	0b478493          	addi	s1,a5,180
...
ffffffffc0204780:	e4440413          	addi	s0,s0,-444 # ffffffffc02155c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204784:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0204786:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204788:	6cc000ef          	jal	ra,ffffffffc0204e54 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020478c:	463d                	li	a2,15
ffffffffc020478e:	00002597          	auipc	a1,0x2
ffffffffc0204792:	53258593          	addi	a1,a1,1330 # ffffffffc0206cc0 <default_pmm_manager+0x10c8>
ffffffffc0204796:	8526                	mv	a0,s1
ffffffffc0204798:	6ce000ef          	jal	ra,ffffffffc0204e66 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020479c:	00093783          	ld	a5,0(s2)
ffffffffc02047a0:	c7e1                	beqz	a5,ffffffffc0204868 <proc_init+0x22e>
ffffffffc02047a2:	43dc                	lw	a5,4(a5)
ffffffffc02047a4:	e3f1                	bnez	a5,ffffffffc0204868 <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02047a6:	601c                	ld	a5,0(s0)
ffffffffc02047a8:	c3c5                	beqz	a5,ffffffffc0204848 <proc_init+0x20e>
ffffffffc02047aa:	43d8                	lw	a4,4(a5)
ffffffffc02047ac:	4785                	li	a5,1
ffffffffc02047ae:	08f71d63          	bne	a4,a5,ffffffffc0204848 <proc_init+0x20e>
}
...
ffffffffc02047be:	8082                	ret
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc02047c0:	73d8                	ld	a4,160(a5)
ffffffffc02047c2:	ff09                	bnez	a4,ffffffffc02046dc <proc_init+0xa2>
ffffffffc02047c4:	f0099ce3          	bnez	s3,ffffffffc02046dc <proc_init+0xa2>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc02047c8:	6394                	ld	a3,0(a5)
ffffffffc02047ca:	577d                	li	a4,-1
ffffffffc02047cc:	1702                	slli	a4,a4,0x20
ffffffffc02047ce:	f0e697e3          	bne	a3,a4,ffffffffc02046dc <proc_init+0xa2>
ffffffffc02047d2:	4798                	lw	a4,8(a5)
ffffffffc02047d4:	f00714e3          	bnez	a4,ffffffffc02046dc <proc_init+0xa2>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc02047d8:	6b98                	ld	a4,16(a5)
ffffffffc02047da:	f00711e3          	bnez	a4,ffffffffc02046dc <proc_init+0xa2>
ffffffffc02047de:	4f98                	lw	a4,24(a5)
ffffffffc02047e0:	2701                	sext.w	a4,a4
ffffffffc02047e2:	ee071de3          	bnez	a4,ffffffffc02046dc <proc_init+0xa2>
ffffffffc02047e6:	7398                	ld	a4,32(a5)
ffffffffc02047e8:	ee071ae3          	bnez	a4,ffffffffc02046dc <proc_init+0xa2>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc02047ec:	7798                	ld	a4,40(a5)
ffffffffc02047ee:	ee0717e3          	bnez	a4,ffffffffc02046dc <proc_init+0xa2>
ffffffffc02047f2:	0b07a703          	lw	a4,176(a5)
ffffffffc02047f6:	8d59                	or	a0,a0,a4
ffffffffc02047f8:	0005071b          	sext.w	a4,a0
ffffffffc02047fc:	ee0710e3          	bnez	a4,ffffffffc02046dc <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc0204800:	00002517          	auipc	a0,0x2
ffffffffc0204804:	47050513          	addi	a0,a0,1136 # ffffffffc0206c70 <default_pmm_manager+0x1078>
ffffffffc0204808:	979fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    idleproc->pid = 0;
ffffffffc020480c:	00093783          	ld	a5,0(s2)
ffffffffc0204810:	b5f1                	j	ffffffffc02046dc <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0204812:	f2878793          	addi	a5,a5,-216
ffffffffc0204816:	bfb9                	j	ffffffffc0204774 <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc0204818:	00002617          	auipc	a2,0x2
ffffffffc020481c:	44060613          	addi	a2,a2,1088 # ffffffffc0206c58 <default_pmm_manager+0x1060>
ffffffffc0204820:	19100593          	li	a1,401
ffffffffc0204824:	00002517          	auipc	a0,0x2
ffffffffc0204828:	40450513          	addi	a0,a0,1028 # ffffffffc0206c28 <default_pmm_manager+0x1030>
ffffffffc020482c:	c1bfb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc0204830:	00002617          	auipc	a2,0x2
ffffffffc0204834:	47060613          	addi	a2,a2,1136 # ffffffffc0206ca0 <default_pmm_manager+0x10a8>
ffffffffc0204838:	1b100593          	li	a1,433
ffffffffc020483c:	00002517          	auipc	a0,0x2
ffffffffc0204840:	3ec50513          	addi	a0,a0,1004 # ffffffffc0206c28 <default_pmm_manager+0x1030>
ffffffffc0204844:	c03fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204848:	00002697          	auipc	a3,0x2
ffffffffc020484c:	4a868693          	addi	a3,a3,1192 # ffffffffc0206cf0 <default_pmm_manager+0x10f8>
ffffffffc0204850:	00001617          	auipc	a2,0x1
ffffffffc0204854:	ff860613          	addi	a2,a2,-8 # ffffffffc0205848 <commands+0x738>
ffffffffc0204858:	1b800593          	li	a1,440
ffffffffc020485c:	00002517          	auipc	a0,0x2
ffffffffc0204860:	3cc50513          	addi	a0,a0,972 # ffffffffc0206c28 <default_pmm_manager+0x1030>
ffffffffc0204864:	be3fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204868:	00002697          	auipc	a3,0x2
ffffffffc020486c:	46068693          	addi	a3,a3,1120 # ffffffffc0206cc8 <default_pmm_manager+0x10d0>
ffffffffc0204870:	00001617          	auipc	a2,0x1
ffffffffc0204874:	fd860613          	addi	a2,a2,-40 # ffffffffc0205848 <commands+0x738>
ffffffffc0204878:	1b700593          	li	a1,439
ffffffffc020487c:	00002517          	auipc	a0,0x2
ffffffffc0204880:	3ac50513          	addi	a0,a0,940 # ffffffffc0206c28 <default_pmm_manager+0x1030>
ffffffffc0204884:	bc3fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204888 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0204888:	1141                	addi	sp,sp,-16
ffffffffc020488a:	e022                	sd	s0,0(sp)
ffffffffc020488c:	e406                	sd	ra,8(sp)
ffffffffc020488e:	00011417          	auipc	s0,0x11
ffffffffc0204892:	d2240413          	addi	s0,s0,-734 # ffffffffc02155b0 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0204896:	6018                	ld	a4,0(s0)
ffffffffc0204898:	4f1c                	lw	a5,24(a4)
ffffffffc020489a:	2781                	sext.w	a5,a5
ffffffffc020489c:	dff5                	beqz	a5,ffffffffc0204898 <cpu_idle+0x10>
            schedule();
ffffffffc020489e:	0a2000ef          	jal	ra,ffffffffc0204940 <schedule>
ffffffffc02048a2:	bfd5                	j	ffffffffc0204896 <cpu_idle+0xe>

ffffffffc02048a4 <switch_to>:
.text
...
ffffffffc02048a4:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc02048a8:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc02048ac:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc02048ae:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc02048b0:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc02048b4:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc02048b8:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc02048bc:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc02048c0:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc02048c4:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc02048c8:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc02048cc:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc02048d0:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc02048d4:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc02048d8:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc02048dc:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc02048e0:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc02048e2:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc02048e4:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc02048e8:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc02048ec:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc02048f0:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc02048f4:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc02048f8:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc02048fc:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0204900:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0204904:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0204908:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc020490c:	8082                	ret

ffffffffc020490e <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc020490e:	411c                	lw	a5,0(a0)
ffffffffc0204910:	4705                	li	a4,1
ffffffffc0204912:	37f9                	addiw	a5,a5,-2
ffffffffc0204914:	00f77563          	bgeu	a4,a5,ffffffffc020491e <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc0204918:	4789                	li	a5,2
ffffffffc020491a:	c11c                	sw	a5,0(a0)
ffffffffc020491c:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc020491e:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc0204920:	00002697          	auipc	a3,0x2
ffffffffc0204924:	3f868693          	addi	a3,a3,1016 # ffffffffc0206d18 <default_pmm_manager+0x1120>
ffffffffc0204928:	00001617          	auipc	a2,0x1
ffffffffc020492c:	f2060613          	addi	a2,a2,-224 # ffffffffc0205848 <commands+0x738>
ffffffffc0204930:	45a5                	li	a1,9
ffffffffc0204932:	00002517          	auipc	a0,0x2
ffffffffc0204936:	42650513          	addi	a0,a0,1062 # ffffffffc0206d58 <default_pmm_manager+0x1160>
wakeup_proc(struct proc_struct *proc) {
ffffffffc020493a:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc020493c:	b0bfb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204940 <schedule>:
}
...
ffffffffc0204944:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204946:	100027f3          	csrr	a5,sstatus
ffffffffc020494a:	8b89                	andi	a5,a5,2
ffffffffc020494c:	4401                	li	s0,0
ffffffffc020494e:	efbd                	bnez	a5,ffffffffc02049cc <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0204950:	00011897          	auipc	a7,0x11
ffffffffc0204954:	c608b883          	ld	a7,-928(a7) # ffffffffc02155b0 <current>
ffffffffc0204958:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc020495c:	00011517          	auipc	a0,0x11
ffffffffc0204960:	c5c53503          	ld	a0,-932(a0) # ffffffffc02155b8 <idleproc>
ffffffffc0204964:	04a88e63          	beq	a7,a0,ffffffffc02049c0 <schedule+0x80>
ffffffffc0204968:	0c888693          	addi	a3,a7,200
ffffffffc020496c:	00011617          	auipc	a2,0x11
ffffffffc0204970:	bbc60613          	addi	a2,a2,-1092 # ffffffffc0215528 <proc_list>
        le = last;
ffffffffc0204974:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc0204978:	4809                	li	a6,2
ffffffffc020497a:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc020497c:	00c78863          	beq	a5,a2,ffffffffc020498c <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204980:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0204984:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204988:	03070163          	beq	a4,a6,ffffffffc02049aa <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc020498c:	fef697e3          	bne	a3,a5,ffffffffc020497a <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204990:	ed89                	bnez	a1,ffffffffc02049aa <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
...
ffffffffc0204996:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0204998:	00a88463          	beq	a7,a0,ffffffffc02049a0 <schedule+0x60>
            proc_run(next);
ffffffffc020499c:	985ff0ef          	jal	ra,ffffffffc0204320 <proc_run>
    if (flag) {
ffffffffc02049a0:	e819                	bnez	s0,ffffffffc02049b6 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc02049ae:	fef712e3          	bne	a4,a5,ffffffffc0204992 <schedule+0x52>
ffffffffc02049b2:	852e                	mv	a0,a1
ffffffffc02049b4:	bff9                	j	ffffffffc0204992 <schedule+0x52>
}
ffffffffc02049b6:	6402                	ld	s0,0(sp)
ffffffffc02049b8:	60a2                	ld	ra,8(sp)
ffffffffc02049ba:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc02049bc:	c01fb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049c0:	00011617          	auipc	a2,0x11
ffffffffc02049c4:	b6860613          	addi	a2,a2,-1176 # ffffffffc0215528 <proc_list>
ffffffffc02049c8:	86b2                	mv	a3,a2
ffffffffc02049ca:	b76d                	j	ffffffffc0204974 <schedule+0x34>
        intr_disable();
ffffffffc02049cc:	bf7fb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc02049d0:	4405                	li	s0,1
ffffffffc02049d2:	bfbd                	j	ffffffffc0204950 <schedule+0x10>

ffffffffc02049d4 <hash32>:
 *
...
ffffffffc02049d4:	9e3707b7          	lui	a5,0x9e370
ffffffffc02049d8:	2785                	addiw	a5,a5,1
ffffffffc02049da:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc02049de:	02000793          	li	a5,32
ffffffffc02049e2:	9f8d                	subw	a5,a5,a1
}
ffffffffc02049e4:	00f5553b          	srlw	a0,a0,a5
ffffffffc02049e8:	8082                	ret

ffffffffc02049ea <printnum>:
 * */
static void
...
ffffffffc02049ea:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049ee:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc02049f0:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049f4:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc02049f6:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049fa:	f022                	sd	s0,32(sp)
ffffffffc02049fc:	ec26                	sd	s1,24(sp)
ffffffffc02049fe:	e84a                	sd	s2,16(sp)
ffffffffc0204a00:	f406                	sd	ra,40(sp)
ffffffffc0204a02:	e44e                	sd	s3,8(sp)
ffffffffc0204a04:	84aa                	mv	s1,a0
ffffffffc0204a06:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0204a08:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204a0c:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204a0e:	03067e63          	bgeu	a2,a6,ffffffffc0204a4a <printnum+0x60>
ffffffffc0204a12:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0204a14:	00805763          	blez	s0,ffffffffc0204a22 <printnum+0x38>
ffffffffc0204a18:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204a1a:	85ca                	mv	a1,s2
ffffffffc0204a1c:	854e                	mv	a0,s3
ffffffffc0204a1e:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204a20:	fc65                	bnez	s0,ffffffffc0204a18 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a22:	1a02                	slli	s4,s4,0x20
ffffffffc0204a24:	00002797          	auipc	a5,0x2
ffffffffc0204a28:	34c78793          	addi	a5,a5,844 # ffffffffc0206d70 <default_pmm_manager+0x1178>
ffffffffc0204a2c:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204a30:	9a3e                	add	s4,s4,a5
}
ffffffffc0204a32:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a34:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204a38:	70a2                	ld	ra,40(sp)
ffffffffc0204a3a:	69a2                	ld	s3,8(sp)
ffffffffc0204a3c:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a3e:	85ca                	mv	a1,s2
ffffffffc0204a40:	87a6                	mv	a5,s1
}
ffffffffc0204a42:	6942                	ld	s2,16(sp)
ffffffffc0204a44:	64e2                	ld	s1,24(sp)
ffffffffc0204a46:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a48:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204a4a:	03065633          	divu	a2,a2,a6
ffffffffc0204a4e:	8722                	mv	a4,s0
ffffffffc0204a50:	f9bff0ef          	jal	ra,ffffffffc02049ea <printnum>
ffffffffc0204a54:	b7f9                	j	ffffffffc0204a22 <printnum+0x38>

ffffffffc0204a56 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204a56:	7119                	addi	sp,sp,-128
ffffffffc0204a58:	f4a6                	sd	s1,104(sp)
ffffffffc0204a5a:	f0ca                	sd	s2,96(sp)
ffffffffc0204a5c:	ecce                	sd	s3,88(sp)
ffffffffc0204a5e:	e8d2                	sd	s4,80(sp)
ffffffffc0204a60:	e4d6                	sd	s5,72(sp)
ffffffffc0204a62:	e0da                	sd	s6,64(sp)
ffffffffc0204a64:	fc5e                	sd	s7,56(sp)
ffffffffc0204a66:	f06a                	sd	s10,32(sp)
ffffffffc0204a68:	fc86                	sd	ra,120(sp)
ffffffffc0204a6a:	f8a2                	sd	s0,112(sp)
ffffffffc0204a6c:	f862                	sd	s8,48(sp)
ffffffffc0204a6e:	f466                	sd	s9,40(sp)
ffffffffc0204a70:	ec6e                	sd	s11,24(sp)
ffffffffc0204a72:	892a                	mv	s2,a0
ffffffffc0204a74:	84ae                	mv	s1,a1
ffffffffc0204a76:	8d32                	mv	s10,a2
ffffffffc0204a78:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204a7a:	02500993          	li	s3,37
            putch(ch, putdat);
        }
...
ffffffffc0204a80:	00002a97          	auipc	s5,0x2
ffffffffc0204a84:	31ca8a93          	addi	s5,s5,796 # ffffffffc0206d9c <default_pmm_manager+0x11a4>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204a88:	00002b97          	auipc	s7,0x2
ffffffffc0204a8c:	4f0b8b93          	addi	s7,s7,1264 # ffffffffc0206f78 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a90:	000d4503          	lbu	a0,0(s10)
ffffffffc0204a94:	001d0413          	addi	s0,s10,1
ffffffffc0204a98:	01350a63          	beq	a0,s3,ffffffffc0204aac <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204a9c:	c121                	beqz	a0,ffffffffc0204adc <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0204a9e:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204aa0:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0204aa2:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204aa4:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204aa8:	ff351ae3          	bne	a0,s3,ffffffffc0204a9c <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204aac:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204ab0:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204ab4:	4c81                	li	s9,0
ffffffffc0204ab6:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204ab8:	5c7d                	li	s8,-1
ffffffffc0204aba:	5dfd                	li	s11,-1
ffffffffc0204abc:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204ac0:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ac2:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204ac6:	0ff5f593          	zext.b	a1,a1
ffffffffc0204aca:	00140d13          	addi	s10,s0,1
ffffffffc0204ace:	04b56263          	bltu	a0,a1,ffffffffc0204b12 <vprintfmt+0xbc>
ffffffffc0204ad2:	058a                	slli	a1,a1,0x2
ffffffffc0204ad4:	95d6                	add	a1,a1,s5
ffffffffc0204ad6:	4194                	lw	a3,0(a1)
ffffffffc0204ad8:	96d6                	add	a3,a3,s5
ffffffffc0204ada:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204adc:	70e6                	ld	ra,120(sp)
ffffffffc0204ade:	7446                	ld	s0,112(sp)
ffffffffc0204ae0:	74a6                	ld	s1,104(sp)
ffffffffc0204ae2:	7906                	ld	s2,96(sp)
ffffffffc0204ae4:	69e6                	ld	s3,88(sp)
ffffffffc0204ae6:	6a46                	ld	s4,80(sp)
ffffffffc0204ae8:	6aa6                	ld	s5,72(sp)
ffffffffc0204aea:	6b06                	ld	s6,64(sp)
ffffffffc0204aec:	7be2                	ld	s7,56(sp)
ffffffffc0204aee:	7c42                	ld	s8,48(sp)
ffffffffc0204af0:	7ca2                	ld	s9,40(sp)
ffffffffc0204af2:	7d02                	ld	s10,32(sp)
ffffffffc0204af4:	6de2                	ld	s11,24(sp)
ffffffffc0204af6:	6109                	addi	sp,sp,128
ffffffffc0204af8:	8082                	ret
            padc = '0';
ffffffffc0204afa:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204afc:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b00:	846a                	mv	s0,s10
ffffffffc0204b02:	00140d13          	addi	s10,s0,1
ffffffffc0204b06:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b0a:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b0e:	fcb572e3          	bgeu	a0,a1,ffffffffc0204ad2 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204b12:	85a6                	mv	a1,s1
ffffffffc0204b14:	02500513          	li	a0,37
ffffffffc0204b18:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204b1a:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204b1e:	8d22                	mv	s10,s0
ffffffffc0204b20:	f73788e3          	beq	a5,s3,ffffffffc0204a90 <vprintfmt+0x3a>
ffffffffc0204b24:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204b28:	1d7d                	addi	s10,s10,-1
ffffffffc0204b2a:	ff379de3          	bne	a5,s3,ffffffffc0204b24 <vprintfmt+0xce>
ffffffffc0204b2e:	b78d                	j	ffffffffc0204a90 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204b30:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204b34:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b38:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204b3a:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204b3e:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b42:	02d86463          	bltu	a6,a3,ffffffffc0204b6a <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204b46:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204b4a:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204b4e:	0186873b          	addw	a4,a3,s8
ffffffffc0204b52:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204b56:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204b58:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204b5c:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204b5e:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204b62:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b66:	fed870e3          	bgeu	a6,a3,ffffffffc0204b46 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204b6a:	f40ddce3          	bgez	s11,ffffffffc0204ac2 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204b6e:	8de2                	mv	s11,s8
ffffffffc0204b70:	5c7d                	li	s8,-1
ffffffffc0204b72:	bf81                	j	ffffffffc0204ac2 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204b74:	fffdc693          	not	a3,s11
ffffffffc0204b78:	96fd                	srai	a3,a3,0x3f
ffffffffc0204b7a:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b7e:	00144603          	lbu	a2,1(s0)
ffffffffc0204b82:	2d81                	sext.w	s11,s11
ffffffffc0204b84:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204b86:	bf35                	j	ffffffffc0204ac2 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204b88:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc0204b94:	bfd9                	j	ffffffffc0204b6a <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204b96:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204b98:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204b9c:	01174463          	blt	a4,a7,ffffffffc0204ba4 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204ba0:	1a088e63          	beqz	a7,ffffffffc0204d5c <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204ba4:	000a3603          	ld	a2,0(s4)
ffffffffc0204ba8:	46c1                	li	a3,16
ffffffffc0204baa:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204bac:	2781                	sext.w	a5,a5
ffffffffc0204bae:	876e                	mv	a4,s11
ffffffffc0204bb0:	85a6                	mv	a1,s1
ffffffffc0204bb2:	854a                	mv	a0,s2
ffffffffc0204bb4:	e37ff0ef          	jal	ra,ffffffffc02049ea <printnum>
            break;
ffffffffc0204bb8:	bde1                	j	ffffffffc0204a90 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204bba:	000a2503          	lw	a0,0(s4)
ffffffffc0204bbe:	85a6                	mv	a1,s1
ffffffffc0204bc0:	0a21                	addi	s4,s4,8
ffffffffc0204bc2:	9902                	jalr	s2
            break;
ffffffffc0204bc4:	b5f1                	j	ffffffffc0204a90 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204bc6:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204bc8:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204bcc:	01174463          	blt	a4,a7,ffffffffc0204bd4 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204bd0:	18088163          	beqz	a7,ffffffffc0204d52 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204bd4:	000a3603          	ld	a2,0(s4)
ffffffffc0204bd8:	46a9                	li	a3,10
ffffffffc0204bda:	8a2e                	mv	s4,a1
ffffffffc0204bdc:	bfc1                	j	ffffffffc0204bac <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bde:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204be2:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204be4:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204be6:	bdf1                	j	ffffffffc0204ac2 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204be8:	85a6                	mv	a1,s1
ffffffffc0204bea:	02500513          	li	a0,37
ffffffffc0204bee:	9902                	jalr	s2
            break;
ffffffffc0204bf0:	b545                	j	ffffffffc0204a90 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bf2:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204bf6:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bf8:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204bfa:	b5e1                	j	ffffffffc0204ac2 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204bfc:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204bfe:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c02:	01174463          	blt	a4,a7,ffffffffc0204c0a <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204c06:	14088163          	beqz	a7,ffffffffc0204d48 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204c0a:	000a3603          	ld	a2,0(s4)
ffffffffc0204c0e:	46a1                	li	a3,8
ffffffffc0204c10:	8a2e                	mv	s4,a1
ffffffffc0204c12:	bf69                	j	ffffffffc0204bac <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204c14:	03000513          	li	a0,48
ffffffffc0204c18:	85a6                	mv	a1,s1
ffffffffc0204c1a:	e03e                	sd	a5,0(sp)
ffffffffc0204c1c:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204c1e:	85a6                	mv	a1,s1
ffffffffc0204c20:	07800513          	li	a0,120
ffffffffc0204c24:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c26:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204c28:	6782                	ld	a5,0(sp)
ffffffffc0204c2a:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c2c:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204c30:	bfb5                	j	ffffffffc0204bac <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c32:	000a3403          	ld	s0,0(s4)
ffffffffc0204c36:	008a0713          	addi	a4,s4,8
ffffffffc0204c3a:	e03a                	sd	a4,0(sp)
ffffffffc0204c3c:	14040263          	beqz	s0,ffffffffc0204d80 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204c40:	0fb05763          	blez	s11,ffffffffc0204d2e <vprintfmt+0x2d8>
ffffffffc0204c44:	02d00693          	li	a3,45
ffffffffc0204c48:	0cd79163          	bne	a5,a3,ffffffffc0204d0a <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c4c:	00044783          	lbu	a5,0(s0)
ffffffffc0204c50:	0007851b          	sext.w	a0,a5
ffffffffc0204c54:	cf85                	beqz	a5,ffffffffc0204c8c <vprintfmt+0x236>
ffffffffc0204c56:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c5a:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c5e:	000c4563          	bltz	s8,ffffffffc0204c68 <vprintfmt+0x212>
ffffffffc0204c62:	3c7d                	addiw	s8,s8,-1
ffffffffc0204c64:	036c0263          	beq	s8,s6,ffffffffc0204c88 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204c68:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c6a:	0e0c8e63          	beqz	s9,ffffffffc0204d66 <vprintfmt+0x310>
ffffffffc0204c6e:	3781                	addiw	a5,a5,-32
ffffffffc0204c70:	0ef47b63          	bgeu	s0,a5,ffffffffc0204d66 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204c74:	03f00513          	li	a0,63
ffffffffc0204c78:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c7a:	000a4783          	lbu	a5,0(s4)
ffffffffc0204c7e:	3dfd                	addiw	s11,s11,-1
ffffffffc0204c80:	0a05                	addi	s4,s4,1
ffffffffc0204c82:	0007851b          	sext.w	a0,a5
ffffffffc0204c86:	ffe1                	bnez	a5,ffffffffc0204c5e <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204c88:	01b05963          	blez	s11,ffffffffc0204c9a <vprintfmt+0x244>
ffffffffc0204c8c:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204c8e:	85a6                	mv	a1,s1
ffffffffc0204c90:	02000513          	li	a0,32
ffffffffc0204c94:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204c96:	fe0d9be3          	bnez	s11,ffffffffc0204c8c <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c9a:	6a02                	ld	s4,0(sp)
ffffffffc0204c9c:	bbd5                	j	ffffffffc0204a90 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c9e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204ca0:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204ca4:	01174463          	blt	a4,a7,ffffffffc0204cac <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204ca8:	08088d63          	beqz	a7,ffffffffc0204d42 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204cac:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204cb0:	0a044d63          	bltz	s0,ffffffffc0204d6a <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204cb4:	8622                	mv	a2,s0
ffffffffc0204cb6:	8a66                	mv	s4,s9
ffffffffc0204cb8:	46a9                	li	a3,10
ffffffffc0204cba:	bdcd                	j	ffffffffc0204bac <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204cbc:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204cc0:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204cc2:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204cc4:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204cc8:	8fb5                	xor	a5,a5,a3
ffffffffc0204cca:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204cce:	02d74163          	blt	a4,a3,ffffffffc0204cf0 <vprintfmt+0x29a>
ffffffffc0204cd2:	00369793          	slli	a5,a3,0x3
ffffffffc0204cd6:	97de                	add	a5,a5,s7
ffffffffc0204cd8:	639c                	ld	a5,0(a5)
ffffffffc0204cda:	cb99                	beqz	a5,ffffffffc0204cf0 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204cdc:	86be                	mv	a3,a5
ffffffffc0204cde:	00000617          	auipc	a2,0x0
ffffffffc0204ce2:	1f260613          	addi	a2,a2,498 # ffffffffc0204ed0 <etext+0x2e>
ffffffffc0204ce6:	85a6                	mv	a1,s1
ffffffffc0204ce8:	854a                	mv	a0,s2
ffffffffc0204cea:	0ce000ef          	jal	ra,ffffffffc0204db8 <printfmt>
ffffffffc0204cee:	b34d                	j	ffffffffc0204a90 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204cf0:	00002617          	auipc	a2,0x2
ffffffffc0204cf4:	0a060613          	addi	a2,a2,160 # ffffffffc0206d90 <default_pmm_manager+0x1198>
ffffffffc0204cf8:	85a6                	mv	a1,s1
ffffffffc0204cfa:	854a                	mv	a0,s2
ffffffffc0204cfc:	0bc000ef          	jal	ra,ffffffffc0204db8 <printfmt>
ffffffffc0204d00:	bb41                	j	ffffffffc0204a90 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d02:	00002417          	auipc	s0,0x2
ffffffffc0204d06:	08640413          	addi	s0,s0,134 # ffffffffc0206d88 <default_pmm_manager+0x1190>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d0a:	85e2                	mv	a1,s8
ffffffffc0204d0c:	8522                	mv	a0,s0
ffffffffc0204d0e:	e43e                	sd	a5,8(sp)
ffffffffc0204d10:	0e2000ef          	jal	ra,ffffffffc0204df2 <strnlen>
ffffffffc0204d14:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204d18:	01b05b63          	blez	s11,ffffffffc0204d2e <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204d1c:	67a2                	ld	a5,8(sp)
ffffffffc0204d1e:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d22:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204d24:	85a6                	mv	a1,s1
ffffffffc0204d26:	8552                	mv	a0,s4
ffffffffc0204d28:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d2a:	fe0d9ce3          	bnez	s11,ffffffffc0204d22 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d2e:	00044783          	lbu	a5,0(s0)
ffffffffc0204d32:	00140a13          	addi	s4,s0,1
ffffffffc0204d36:	0007851b          	sext.w	a0,a5
ffffffffc0204d3a:	d3a5                	beqz	a5,ffffffffc0204c9a <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d3c:	05e00413          	li	s0,94
ffffffffc0204d40:	bf39                	j	ffffffffc0204c5e <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204d42:	000a2403          	lw	s0,0(s4)
ffffffffc0204d46:	b7ad                	j	ffffffffc0204cb0 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204d48:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d4c:	46a1                	li	a3,8
ffffffffc0204d4e:	8a2e                	mv	s4,a1
ffffffffc0204d50:	bdb1                	j	ffffffffc0204bac <vprintfmt+0x156>
ffffffffc0204d52:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d56:	46a9                	li	a3,10
ffffffffc0204d58:	8a2e                	mv	s4,a1
ffffffffc0204d5a:	bd89                	j	ffffffffc0204bac <vprintfmt+0x156>
ffffffffc0204d5c:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d60:	46c1                	li	a3,16
ffffffffc0204d62:	8a2e                	mv	s4,a1
ffffffffc0204d64:	b5a1                	j	ffffffffc0204bac <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204d66:	9902                	jalr	s2
ffffffffc0204d68:	bf09                	j	ffffffffc0204c7a <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204d6a:	85a6                	mv	a1,s1
ffffffffc0204d6c:	02d00513          	li	a0,45
ffffffffc0204d70:	e03e                	sd	a5,0(sp)
ffffffffc0204d72:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204d74:	6782                	ld	a5,0(sp)
ffffffffc0204d76:	8a66                	mv	s4,s9
ffffffffc0204d78:	40800633          	neg	a2,s0
ffffffffc0204d7c:	46a9                	li	a3,10
ffffffffc0204d7e:	b53d                	j	ffffffffc0204bac <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204d80:	03b05163          	blez	s11,ffffffffc0204da2 <vprintfmt+0x34c>
ffffffffc0204d84:	02d00693          	li	a3,45
ffffffffc0204d88:	f6d79de3          	bne	a5,a3,ffffffffc0204d02 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204d8c:	00002417          	auipc	s0,0x2
ffffffffc0204d90:	ffc40413          	addi	s0,s0,-4 # ffffffffc0206d88 <default_pmm_manager+0x1190>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d94:	02800793          	li	a5,40
ffffffffc0204d98:	02800513          	li	a0,40
ffffffffc0204d9c:	00140a13          	addi	s4,s0,1
ffffffffc0204da0:	bd6d                	j	ffffffffc0204c5a <vprintfmt+0x204>
ffffffffc0204da2:	00002a17          	auipc	s4,0x2
ffffffffc0204da6:	fe7a0a13          	addi	s4,s4,-25 # ffffffffc0206d89 <default_pmm_manager+0x1191>
ffffffffc0204daa:	02800513          	li	a0,40
ffffffffc0204dae:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204db2:	05e00413          	li	s0,94
ffffffffc0204db6:	b565                	j	ffffffffc0204c5e <vprintfmt+0x208>

ffffffffc0204db8 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204db8:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204dba:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204dbe:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204dc0:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204dc2:	ec06                	sd	ra,24(sp)
ffffffffc0204dc4:	f83a                	sd	a4,48(sp)
ffffffffc0204dc6:	fc3e                	sd	a5,56(sp)
ffffffffc0204dc8:	e0c2                	sd	a6,64(sp)
ffffffffc0204dca:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204dcc:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204dce:	c89ff0ef          	jal	ra,ffffffffc0204a56 <vprintfmt>
}
ffffffffc0204dd2:	60e2                	ld	ra,24(sp)
ffffffffc0204dd4:	6161                	addi	sp,sp,80
ffffffffc0204dd6:	8082                	ret

ffffffffc0204dd8 <strlen>:
...
strlen(const char *s) {
ffffffffc0204ddc:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204dde:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204de0:	cb81                	beqz	a5,ffffffffc0204df0 <strlen+0x18>
        cnt ++;
ffffffffc0204de2:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204de4:	00a707b3          	add	a5,a4,a0
ffffffffc0204de8:	0007c783          	lbu	a5,0(a5)
ffffffffc0204dec:	fbfd                	bnez	a5,ffffffffc0204de2 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204df2:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204df4:	e589                	bnez	a1,ffffffffc0204dfe <strnlen+0xc>
ffffffffc0204df6:	a811                	j	ffffffffc0204e0a <strnlen+0x18>
        cnt ++;
ffffffffc0204df8:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204dfa:	00f58863          	beq	a1,a5,ffffffffc0204e0a <strnlen+0x18>
ffffffffc0204dfe:	00f50733          	add	a4,a0,a5
ffffffffc0204e02:	00074703          	lbu	a4,0(a4)
ffffffffc0204e06:	fb6d                	bnez	a4,ffffffffc0204df8 <strnlen+0x6>
ffffffffc0204e08:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204e0a:	852e                	mv	a0,a1
...
ffffffffc0204e24:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e28:	cb89                	beqz	a5,ffffffffc0204e3a <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204e2a:	0505                	addi	a0,a0,1
ffffffffc0204e2c:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e2e:	fee789e3          	beq	a5,a4,ffffffffc0204e20 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e32:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204e36:	9d19                	subw	a0,a0,a4
ffffffffc0204e38:	8082                	ret
ffffffffc0204e3a:	4501                	li	a0,0
ffffffffc0204e3c:	bfed                	j	ffffffffc0204e36 <strcmp+0x16>

ffffffffc0204e3e <strchr>:
...
ffffffffc0204e42:	c799                	beqz	a5,ffffffffc0204e50 <strchr+0x12>
        if (*s == c) {
ffffffffc0204e44:	00f58763          	beq	a1,a5,ffffffffc0204e52 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204e48:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204e4c:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204e4e:	fbfd                	bnez	a5,ffffffffc0204e44 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204e54:	ca01                	beqz	a2,ffffffffc0204e64 <memset+0x10>
ffffffffc0204e56:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204e58:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204e5a:	0785                	addi	a5,a5,1
ffffffffc0204e5c:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204e60:	fec79de3          	bne	a5,a2,ffffffffc0204e5a <memset+0x6>
    }
    return s;
...
ffffffffc0204e66 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204e66:	ca19                	beqz	a2,ffffffffc0204e7c <memcpy+0x16>
ffffffffc0204e68:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204e6a:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204e6c:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e70:	0585                	addi	a1,a1,1
ffffffffc0204e72:	0785                	addi	a5,a5,1
ffffffffc0204e74:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204e78:	fec59ae3          	bne	a1,a2,ffffffffc0204e6c <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204e7e:	c205                	beqz	a2,ffffffffc0204e9e <memcmp+0x20>
ffffffffc0204e80:	962e                	add	a2,a2,a1
ffffffffc0204e82:	a019                	j	ffffffffc0204e88 <memcmp+0xa>
ffffffffc0204e84:	00c58d63          	beq	a1,a2,ffffffffc0204e9e <memcmp+0x20>
        if (*s1 != *s2) {
ffffffffc0204e88:	00054783          	lbu	a5,0(a0)
...
ffffffffc0204e92:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204e94:	fee788e3          	beq	a5,a4,ffffffffc0204e84 <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e98:	40e7853b          	subw	a0,a5,a4
